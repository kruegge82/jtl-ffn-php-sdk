...
class WarehousesApi
{
    ...
    /**
     * Operation warehousesDelete
     *
     * Delete
     *
     * @param  string $warehouse_id Warehouse identifier (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['warehousesDelete'] to see the possible values for this operation
     *
     * @throws \kruegge82\jtlffn\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function warehousesDelete($warehouse_id, string $contentType = self::contentTypes['warehousesDelete'][0])
    {
        $this->warehousesDeleteWithHttpInfo($warehouse_id, $contentType);
    }

    /**
     * Operation warehousesDeleteWithHttpInfo
     *
     * Delete
     *
     * @param  string $warehouse_id Warehouse identifier (required)
     ...
     */
    public function warehousesDeleteWithHttpInfo($warehouse_id, string $contentType = self::contentTypes['warehousesDelete'][0])
    {
        $request = $this->warehousesDeleteRequest($warehouse_id, $contentType);
    ...
    /**
     * Operation warehousesDeleteAsync
     *
     * Delete
     *
     * @param  string $warehouse_id Warehouse identifier (required)
     ...
     */
    public function warehousesDeleteAsync($warehouse_id, string $contentType = self::contentTypes['warehousesDelete'][0])
    {
        return $this->warehousesDeleteAsyncWithHttpInfo($warehouse_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation warehousesDeleteAsyncWithHttpInfo
     *
     * Delete
     *
     * @param  string $warehouse_id Warehouse identifier (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function warehousesDeleteAsyncWithHttpInfo($warehouse_id, string $contentType = self::contentTypes['warehousesDelete'][0])
    {
        $returnType = '';
        $request = $this->warehousesDeleteRequest($warehouse_id, $contentType);
    ...
    /**
     * Create request for operation 'warehousesDelete'
     *
     * @param  string $warehouse_id Warehouse identifier (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['warehousesDelete'] to see the possible values for this operation
     *
     ...
     */
    public function warehousesDeleteRequest($warehouse_id, string $contentType = self::contentTypes['warehousesDelete'][0])
    {

        // verify the required parameter 'warehouse_id' is set
        if ($warehouse_id === null || (is_array($warehouse_id) && count($warehouse_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $warehouse_id when calling warehousesDelete'
            );
        }


        $resourcePath = '/api/v1/fulfiller/warehouses/{warehouseId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \kruegge82\jtlffn\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return |\kruegge82\jtlffn\Model\ErrorResponse|\kruegge82\jtlffn\Model\Warehouse
     */
    public function warehousesGet($warehouse_id, string $contentType = self::contentTypes['warehousesGet'][0])
    {
        list($response) = $this->warehousesGetWithHttpInfo($warehouse_id, $contentType);
        return $response;
    }
     ...
     * @throws \kruegge82\jtlffn\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of |\kruegge82\jtlffn\Model\ErrorResponse|\kruegge82\jtlffn\Model\Warehouse, HTTP status code, HTTP response headers (array of strings)
     */
    public function warehousesGetWithHttpInfo($warehouse_id, string $contentType = self::contentTypes['warehousesGet'][0])
    {
        $request = $this->warehousesGetRequest($warehouse_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\kruegge82\jtlffn\Model\Warehouse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\jtlffn\Model\Warehouse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\jtlffn\Model\Warehouse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\kruegge82\jtlffn\Model\Warehouse';
            ...
            switch ($e->getCode()) {
                ...
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kruegge82\jtlffn\Model\Warehouse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function warehousesGetAsync($warehouse_id, string $contentType = self::contentTypes['warehousesGet'][0])
    {
        return $this->warehousesGetAsyncWithHttpInfo($warehouse_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function warehousesGetAsyncWithHttpInfo($warehouse_id, string $contentType = self::contentTypes['warehousesGet'][0])
    {
        $returnType = '\kruegge82\jtlffn\Model\Warehouse';
        $request = $this->warehousesGetRequest($warehouse_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function warehousesGetRequest($warehouse_id, string $contentType = self::contentTypes['warehousesGet'][0])
    {

        // verify the required parameter 'warehouse_id' is set
        if ($warehouse_id === null || (is_array($warehouse_id) && count($warehouse_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $warehouse_id when calling warehousesGet'
            );
        }
    ...
    /**
     * Operation warehousesGetAll
     *
     * Get All
     *
     * @param  int|null $top number of elements returned by the request (optional, default to 50)
     * @param  int|null $skip offset (optional)
     * @param  string|null $filter &lt;h5&gt;allowed fields&lt;/h5&gt;                               &#39;warehouseId&#39;, &#39;fulfillerId&#39;, &#39;name&#39;, &#39;address/lastname&#39;, &#39;address/company&#39;, &#39;address/city&#39;, &#39;address/email&#39;&lt;/br&gt; (optional)
     * @param  string|null $select select fields (optional)
     * @param  string|null $order_by order result by field (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['warehousesGetAll'] to see the possible values for this operation
     *
     * @throws \kruegge82\jtlffn\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return |\kruegge82\jtlffn\Model\PagedWarehouseResponse
     */
    public function warehousesGetAll($top = 50, $skip = null, $filter = null, $select = null, $order_by = null, string $contentType = self::contentTypes['warehousesGetAll'][0])
    {
        list($response) = $this->warehousesGetAllWithHttpInfo($top, $skip, $filter, $select, $order_by, $contentType);
        return $response;
    }

    /**
     * Operation warehousesGetAllWithHttpInfo
     *
     * Get All
     *
     * @param  int|null $top number of elements returned by the request (optional, default to 50)
     ...
     * @throws \kruegge82\jtlffn\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of |\kruegge82\jtlffn\Model\PagedWarehouseResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function warehousesGetAllWithHttpInfo($top = 50, $skip = null, $filter = null, $select = null, $order_by = null, string $contentType = self::contentTypes['warehousesGetAll'][0])
    {
        $request = $this->warehousesGetAllRequest($top, $skip, $filter, $select, $order_by, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\jtlffn\Model\PagedWarehouseResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\jtlffn\Model\PagedWarehouseResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\jtlffn\Model\PagedWarehouseResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\kruegge82\jtlffn\Model\PagedWarehouseResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kruegge82\jtlffn\Model\PagedWarehouseResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation warehousesGetAllAsync
     *
     * Get All
     *
     * @param  int|null $top number of elements returned by the request (optional, default to 50)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function warehousesGetAllAsync($top = 50, $skip = null, $filter = null, $select = null, $order_by = null, string $contentType = self::contentTypes['warehousesGetAll'][0])
    {
        return $this->warehousesGetAllAsyncWithHttpInfo($top, $skip, $filter, $select, $order_by, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation warehousesGetAllAsyncWithHttpInfo
     *
     * Get All
     *
     * @param  int|null $top number of elements returned by the request (optional, default to 50)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function warehousesGetAllAsyncWithHttpInfo($top = 50, $skip = null, $filter = null, $select = null, $order_by = null, string $contentType = self::contentTypes['warehousesGetAll'][0])
    {
        $returnType = '\kruegge82\jtlffn\Model\PagedWarehouseResponse';
        $request = $this->warehousesGetAllRequest($top, $skip, $filter, $select, $order_by, $contentType);
    ...
    /**
     * Create request for operation 'warehousesGetAll'
     *
     * @param  int|null $top number of elements returned by the request (optional, default to 50)
     * @param  int|null $skip offset (optional)
     * @param  string|null $filter &lt;h5&gt;allowed fields&lt;/h5&gt;                               &#39;warehouseId&#39;, &#39;fulfillerId&#39;, &#39;name&#39;, &#39;address/lastname&#39;, &#39;address/company&#39;, &#39;address/city&#39;, &#39;address/email&#39;&lt;/br&gt; (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function warehousesGetAllRequest($top = 50, $skip = null, $filter = null, $select = null, $order_by = null, string $contentType = self::contentTypes['warehousesGetAll'][0])
    {
        ...
        $resourcePath = '/api/v1/fulfiller/warehouses';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation warehousesGetUpdates
     *
     * Get Updates
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['warehousesGetUpdates'] to see the possible values for this operation
     *
     * @throws \kruegge82\jtlffn\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\jtlffn\Model\RecentWarehouseList
     */
    public function warehousesGetUpdates($from_date = null, $to_date = null, $page = 1, $ignore_own_application_id = false, $ignore_own_user_id = false, string $contentType = self::contentTypes['warehousesGetUpdates'][0])
    {
        list($response) = $this->warehousesGetUpdatesWithHttpInfo($from_date, $to_date, $page, $ignore_own_application_id, $ignore_own_user_id, $contentType);
        return $response;
    }

    /**
     * Operation warehousesGetUpdatesWithHttpInfo
     *
     * Get Updates
     *
     * @param  string|null $from_date The start date of the timeframe. (optional)
     ...
     * @throws \kruegge82\jtlffn\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \kruegge82\jtlffn\Model\RecentWarehouseList, HTTP status code, HTTP response headers (array of strings)
     */
    public function warehousesGetUpdatesWithHttpInfo($from_date = null, $to_date = null, $page = 1, $ignore_own_application_id = false, $ignore_own_user_id = false, string $contentType = self::contentTypes['warehousesGetUpdates'][0])
    {
        $request = $this->warehousesGetUpdatesRequest($from_date, $to_date, $page, $ignore_own_application_id, $ignore_own_user_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\jtlffn\Model\RecentWarehouseList' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\jtlffn\Model\RecentWarehouseList' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\jtlffn\Model\RecentWarehouseList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\kruegge82\jtlffn\Model\RecentWarehouseList';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kruegge82\jtlffn\Model\RecentWarehouseList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation warehousesGetUpdatesAsync
     *
     * Get Updates
     *
     * @param  string|null $from_date The start date of the timeframe. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function warehousesGetUpdatesAsync($from_date = null, $to_date = null, $page = 1, $ignore_own_application_id = false, $ignore_own_user_id = false, string $contentType = self::contentTypes['warehousesGetUpdates'][0])
    {
        return $this->warehousesGetUpdatesAsyncWithHttpInfo($from_date, $to_date, $page, $ignore_own_application_id, $ignore_own_user_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation warehousesGetUpdatesAsyncWithHttpInfo
     *
     * Get Updates
     *
     * @param  string|null $from_date The start date of the timeframe. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function warehousesGetUpdatesAsyncWithHttpInfo($from_date = null, $to_date = null, $page = 1, $ignore_own_application_id = false, $ignore_own_user_id = false, string $contentType = self::contentTypes['warehousesGetUpdates'][0])
    {
        $returnType = '\kruegge82\jtlffn\Model\RecentWarehouseList';
        $request = $this->warehousesGetUpdatesRequest($from_date, $to_date, $page, $ignore_own_application_id, $ignore_own_user_id, $contentType);
    ...
    /**
     * Create request for operation 'warehousesGetUpdates'
     *
     * @param  string|null $from_date The start date of the timeframe. (optional)
     * @param  string|null $to_date The end date of the timeframe. (optional)
     * @param  int|null $page Page number. (optional, default to 1)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function warehousesGetUpdatesRequest($from_date = null, $to_date = null, $page = 1, $ignore_own_application_id = false, $ignore_own_user_id = false, string $contentType = self::contentTypes['warehousesGetUpdates'][0])
    {
        ...
        $resourcePath = '/api/v1/fulfiller/warehouses/updates';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation warehousesPost
     *
     * Post
     *
     * @param  \kruegge82\jtlffn\Model\CreateWarehouseRequest|null $create_warehouse_request Details of the warehouse you want to create (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['warehousesPost'] to see the possible values for this operation
     *
     * @throws \kruegge82\jtlffn\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return |\kruegge82\jtlffn\Model\Warehouse
     */
    public function warehousesPost($create_warehouse_request = null, string $contentType = self::contentTypes['warehousesPost'][0])
    {
        list($response) = $this->warehousesPostWithHttpInfo($create_warehouse_request, $contentType);
        return $response;
    }

    /**
     * Operation warehousesPostWithHttpInfo
     *
     * Post
     *
     * @param  \kruegge82\jtlffn\Model\CreateWarehouseRequest|null $create_warehouse_request Details of the warehouse you want to create (optional)
     ...
     * @throws \kruegge82\jtlffn\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of |\kruegge82\jtlffn\Model\Warehouse, HTTP status code, HTTP response headers (array of strings)
     */
    public function warehousesPostWithHttpInfo($create_warehouse_request = null, string $contentType = self::contentTypes['warehousesPost'][0])
    {
        $request = $this->warehousesPostRequest($create_warehouse_request, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function warehousesPostAsync($create_warehouse_request = null, string $contentType = self::contentTypes['warehousesPost'][0])
    {
        return $this->warehousesPostAsyncWithHttpInfo($create_warehouse_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation warehousesPostAsyncWithHttpInfo
     *
     * Post
     *
     * @param  \kruegge82\jtlffn\Model\CreateWarehouseRequest|null $create_warehouse_request Details of the warehouse you want to create (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function warehousesPostAsyncWithHttpInfo($create_warehouse_request = null, string $contentType = self::contentTypes['warehousesPost'][0])
    {
        $returnType = '\kruegge82\jtlffn\Model\Warehouse';
        $request = $this->warehousesPostRequest($create_warehouse_request, $contentType);
    ...
    /**
     * Create request for operation 'warehousesPost'
     *
     * @param  \kruegge82\jtlffn\Model\CreateWarehouseRequest|null $create_warehouse_request Details of the warehouse you want to create (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['warehousesPost'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function warehousesPostRequest($create_warehouse_request = null, string $contentType = self::contentTypes['warehousesPost'][0])
    {
        ...
        // for model (json/xml)
        if (isset($create_warehouse_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($create_warehouse_request));
            } else {
                $httpBody = $create_warehouse_request;
            }
    ...
    /**
     * Operation warehousesUpdate
     *
     * Update
     *
     * @param  string $warehouse_id Warehouse identifier (required)
     * @param  \kruegge82\jtlffn\Model\UpdateWarehouseRequest|null $update_warehouse_request Your warehouse will be updated with that details (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['warehousesUpdate'] to see the possible values for this operation
     *
     * @throws \kruegge82\jtlffn\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function warehousesUpdate($warehouse_id, $update_warehouse_request = null, string $contentType = self::contentTypes['warehousesUpdate'][0])
    {
        $this->warehousesUpdateWithHttpInfo($warehouse_id, $update_warehouse_request, $contentType);
    }

    /**
     * Operation warehousesUpdateWithHttpInfo
     *
     * Update
     *
     * @param  string $warehouse_id Warehouse identifier (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function warehousesUpdateWithHttpInfo($warehouse_id, $update_warehouse_request = null, string $contentType = self::contentTypes['warehousesUpdate'][0])
    {
        $request = $this->warehousesUpdateRequest($warehouse_id, $update_warehouse_request, $contentType);
    ...
    /**
     * Operation warehousesUpdateAsync
     *
     * Update
     *
     * @param  string $warehouse_id Warehouse identifier (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function warehousesUpdateAsync($warehouse_id, $update_warehouse_request = null, string $contentType = self::contentTypes['warehousesUpdate'][0])
    {
        return $this->warehousesUpdateAsyncWithHttpInfo($warehouse_id, $update_warehouse_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation warehousesUpdateAsyncWithHttpInfo
     *
     * Update
     *
     * @param  string $warehouse_id Warehouse identifier (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function warehousesUpdateAsyncWithHttpInfo($warehouse_id, $update_warehouse_request = null, string $contentType = self::contentTypes['warehousesUpdate'][0])
    {
        $returnType = '';
        $request = $this->warehousesUpdateRequest($warehouse_id, $update_warehouse_request, $contentType);
    ...
    /**
     * Create request for operation 'warehousesUpdate'
     *
     * @param  string $warehouse_id Warehouse identifier (required)
     * @param  \kruegge82\jtlffn\Model\UpdateWarehouseRequest|null $update_warehouse_request Your warehouse will be updated with that details (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['warehousesUpdate'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function warehousesUpdateRequest($warehouse_id, $update_warehouse_request = null, string $contentType = self::contentTypes['warehousesUpdate'][0])
    {

        // verify the required parameter 'warehouse_id' is set
        if ($warehouse_id === null || (is_array($warehouse_id) && count($warehouse_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $warehouse_id when calling warehousesUpdate'
            );
        }
        ...
        // for model (json/xml)
        if (isset($update_warehouse_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($update_warehouse_request));
            } else {
                $httpBody = $update_warehouse_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
