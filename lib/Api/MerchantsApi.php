...
class MerchantsApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['merchantsGet'] to see the possible values for this operation
     *
     * @throws \kruegge82\jtlffn\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return |\kruegge82\jtlffn\Model\ErrorResponse|\kruegge82\jtlffn\Model\Merchant
     */
    public function merchantsGet($merchant_id, string $contentType = self::contentTypes['merchantsGet'][0])
    {
        list($response) = $this->merchantsGetWithHttpInfo($merchant_id, $contentType);
        return $response;
    }
     ...
     * @throws \kruegge82\jtlffn\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of |\kruegge82\jtlffn\Model\ErrorResponse|\kruegge82\jtlffn\Model\Merchant, HTTP status code, HTTP response headers (array of strings)
     */
    public function merchantsGetWithHttpInfo($merchant_id, string $contentType = self::contentTypes['merchantsGet'][0])
    {
        $request = $this->merchantsGetRequest($merchant_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\kruegge82\jtlffn\Model\Merchant' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\jtlffn\Model\Merchant' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\jtlffn\Model\Merchant', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\kruegge82\jtlffn\Model\Merchant';
            ...
            switch ($e->getCode()) {
                ...
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kruegge82\jtlffn\Model\Merchant',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     */
    public function merchantsGetAsync($merchant_id, string $contentType = self::contentTypes['merchantsGet'][0])
    {
        return $this->merchantsGetAsyncWithHttpInfo($merchant_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function merchantsGetAsyncWithHttpInfo($merchant_id, string $contentType = self::contentTypes['merchantsGet'][0])
    {
        $returnType = '\kruegge82\jtlffn\Model\Merchant';
        $request = $this->merchantsGetRequest($merchant_id, $contentType);
     ...
     */
    public function merchantsGetRequest($merchant_id, string $contentType = self::contentTypes['merchantsGet'][0])
    {

        // verify the required parameter 'merchant_id' is set
        if ($merchant_id === null || (is_array($merchant_id) && count($merchant_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $merchant_id when calling merchantsGet'
            );
        }


        $resourcePath = '/api/v1/fulfiller/merchants/{merchantId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation merchantsGetAll
     *
     * Get All
     *
     * @param  int|null $top number of elements returned by the request (optional, default to 50)
     * @param  int|null $skip offset (optional)
     * @param  string|null $filter &lt;h5&gt;allowed fields&lt;/h5&gt;                               &#39;userId&#39;, &#39;address/lastname&#39;, &#39;address/company&#39;, &#39;address/city&#39;, &#39;address/email&#39;&lt;/br&gt; (optional)
     * @param  string|null $select select fields (optional)
     * @param  string|null $order_by order result by field (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['merchantsGetAll'] to see the possible values for this operation
     *
     * @throws \kruegge82\jtlffn\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return |\kruegge82\jtlffn\Model\PagedMerchantResponse
     */
    public function merchantsGetAll($top = 50, $skip = null, $filter = null, $select = null, $order_by = null, string $contentType = self::contentTypes['merchantsGetAll'][0])
    {
        list($response) = $this->merchantsGetAllWithHttpInfo($top, $skip, $filter, $select, $order_by, $contentType);
        return $response;
    }

    /**
     * Operation merchantsGetAllWithHttpInfo
     *
     * Get All
     *
     * @param  int|null $top number of elements returned by the request (optional, default to 50)
     ...
     * @throws \kruegge82\jtlffn\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of |\kruegge82\jtlffn\Model\PagedMerchantResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function merchantsGetAllWithHttpInfo($top = 50, $skip = null, $filter = null, $select = null, $order_by = null, string $contentType = self::contentTypes['merchantsGetAll'][0])
    {
        $request = $this->merchantsGetAllRequest($top, $skip, $filter, $select, $order_by, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\jtlffn\Model\PagedMerchantResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\jtlffn\Model\PagedMerchantResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\jtlffn\Model\PagedMerchantResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\kruegge82\jtlffn\Model\PagedMerchantResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kruegge82\jtlffn\Model\PagedMerchantResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation merchantsGetAllAsync
     *
     * Get All
     *
     * @param  int|null $top number of elements returned by the request (optional, default to 50)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function merchantsGetAllAsync($top = 50, $skip = null, $filter = null, $select = null, $order_by = null, string $contentType = self::contentTypes['merchantsGetAll'][0])
    {
        return $this->merchantsGetAllAsyncWithHttpInfo($top, $skip, $filter, $select, $order_by, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation merchantsGetAllAsyncWithHttpInfo
     *
     * Get All
     *
     * @param  int|null $top number of elements returned by the request (optional, default to 50)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function merchantsGetAllAsyncWithHttpInfo($top = 50, $skip = null, $filter = null, $select = null, $order_by = null, string $contentType = self::contentTypes['merchantsGetAll'][0])
    {
        $returnType = '\kruegge82\jtlffn\Model\PagedMerchantResponse';
        $request = $this->merchantsGetAllRequest($top, $skip, $filter, $select, $order_by, $contentType);
    ...
    /**
     * Create request for operation 'merchantsGetAll'
     *
     * @param  int|null $top number of elements returned by the request (optional, default to 50)
     * @param  int|null $skip offset (optional)
     * @param  string|null $filter &lt;h5&gt;allowed fields&lt;/h5&gt;                               &#39;userId&#39;, &#39;address/lastname&#39;, &#39;address/company&#39;, &#39;address/city&#39;, &#39;address/email&#39;&lt;/br&gt; (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function merchantsGetAllRequest($top = 50, $skip = null, $filter = null, $select = null, $order_by = null, string $contentType = self::contentTypes['merchantsGetAll'][0])
    {
        ...
        $resourcePath = '/api/v1/fulfiller/merchants';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['merchantsGetUpdates'] to see the possible values for this operation
     *
     * @throws \kruegge82\jtlffn\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\jtlffn\Model\RecentMerchantList
     */
    public function merchantsGetUpdates($from_date = null, $to_date = null, $page = 1, $ignore_own_application_id = false, $ignore_own_user_id = false, string $contentType = self::contentTypes['merchantsGetUpdates'][0])
    {
        list($response) = $this->merchantsGetUpdatesWithHttpInfo($from_date, $to_date, $page, $ignore_own_application_id, $ignore_own_user_id, $contentType);
        return $response;
    }

    /**
     * Operation merchantsGetUpdatesWithHttpInfo
     *
     * Get Updates
     *
     * @param  string|null $from_date The start date of the timeframe. (optional)
     ...
     * @throws \kruegge82\jtlffn\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \kruegge82\jtlffn\Model\RecentMerchantList, HTTP status code, HTTP response headers (array of strings)
     */
    public function merchantsGetUpdatesWithHttpInfo($from_date = null, $to_date = null, $page = 1, $ignore_own_application_id = false, $ignore_own_user_id = false, string $contentType = self::contentTypes['merchantsGetUpdates'][0])
    {
        $request = $this->merchantsGetUpdatesRequest($from_date, $to_date, $page, $ignore_own_application_id, $ignore_own_user_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\jtlffn\Model\RecentMerchantList' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\jtlffn\Model\RecentMerchantList' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\jtlffn\Model\RecentMerchantList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\kruegge82\jtlffn\Model\RecentMerchantList';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kruegge82\jtlffn\Model\RecentMerchantList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation merchantsGetUpdatesAsync
     *
     * Get Updates
     *
     * @param  string|null $from_date The start date of the timeframe. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function merchantsGetUpdatesAsync($from_date = null, $to_date = null, $page = 1, $ignore_own_application_id = false, $ignore_own_user_id = false, string $contentType = self::contentTypes['merchantsGetUpdates'][0])
    {
        return $this->merchantsGetUpdatesAsyncWithHttpInfo($from_date, $to_date, $page, $ignore_own_application_id, $ignore_own_user_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation merchantsGetUpdatesAsyncWithHttpInfo
     *
     * Get Updates
     *
     * @param  string|null $from_date The start date of the timeframe. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function merchantsGetUpdatesAsyncWithHttpInfo($from_date = null, $to_date = null, $page = 1, $ignore_own_application_id = false, $ignore_own_user_id = false, string $contentType = self::contentTypes['merchantsGetUpdates'][0])
    {
        $returnType = '\kruegge82\jtlffn\Model\RecentMerchantList';
        $request = $this->merchantsGetUpdatesRequest($from_date, $to_date, $page, $ignore_own_application_id, $ignore_own_user_id, $contentType);
    ...
    /**
     * Create request for operation 'merchantsGetUpdates'
     *
     * @param  string|null $from_date The start date of the timeframe. (optional)
     * @param  string|null $to_date The end date of the timeframe. (optional)
     * @param  int|null $page Page number. (optional, default to 1)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function merchantsGetUpdatesRequest($from_date = null, $to_date = null, $page = 1, $ignore_own_application_id = false, $ignore_own_user_id = false, string $contentType = self::contentTypes['merchantsGetUpdates'][0])
    {
        ...
        $resourcePath = '/api/v1/fulfiller/merchants/updates';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
