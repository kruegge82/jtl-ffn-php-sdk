...
class ShippingMethodsApi
{
    ...
    /**
     * Operation shippingMethodsDelete
     *
     * Delete
     *
     * @param  string $shipping_method_id Shipping method identifier (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['shippingMethodsDelete'] to see the possible values for this operation
     *
     * @throws \kruegge82\jtlffn\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function shippingMethodsDelete($shipping_method_id, string $contentType = self::contentTypes['shippingMethodsDelete'][0])
    {
        $this->shippingMethodsDeleteWithHttpInfo($shipping_method_id, $contentType);
    }

    /**
     * Operation shippingMethodsDeleteWithHttpInfo
     *
     * Delete
     *
     * @param  string $shipping_method_id Shipping method identifier (required)
     ...
     */
    public function shippingMethodsDeleteWithHttpInfo($shipping_method_id, string $contentType = self::contentTypes['shippingMethodsDelete'][0])
    {
        $request = $this->shippingMethodsDeleteRequest($shipping_method_id, $contentType);
    ...
    /**
     * Operation shippingMethodsDeleteAsync
     *
     * Delete
     *
     * @param  string $shipping_method_id Shipping method identifier (required)
     ...
     */
    public function shippingMethodsDeleteAsync($shipping_method_id, string $contentType = self::contentTypes['shippingMethodsDelete'][0])
    {
        return $this->shippingMethodsDeleteAsyncWithHttpInfo($shipping_method_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation shippingMethodsDeleteAsyncWithHttpInfo
     *
     * Delete
     *
     * @param  string $shipping_method_id Shipping method identifier (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function shippingMethodsDeleteAsyncWithHttpInfo($shipping_method_id, string $contentType = self::contentTypes['shippingMethodsDelete'][0])
    {
        $returnType = '';
        $request = $this->shippingMethodsDeleteRequest($shipping_method_id, $contentType);
    ...
    /**
     * Create request for operation 'shippingMethodsDelete'
     *
     * @param  string $shipping_method_id Shipping method identifier (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['shippingMethodsDelete'] to see the possible values for this operation
     *
     ...
     */
    public function shippingMethodsDeleteRequest($shipping_method_id, string $contentType = self::contentTypes['shippingMethodsDelete'][0])
    {
        ...
        if ($shipping_method_id === null || (is_array($shipping_method_id) && count($shipping_method_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $shipping_method_id when calling shippingMethodsDelete'
            );
        }


        $resourcePath = '/api/v1/fulfiller/shippingmethods/{shippingMethodId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $shipping_method_id Shipping method identifier (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['shippingMethodsGet'] to see the possible values for this operation
     *
     * @throws \kruegge82\jtlffn\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return |\kruegge82\jtlffn\Model\ErrorResponse|\kruegge82\jtlffn\Model\ShippingMethod
     */
    public function shippingMethodsGet($shipping_method_id, string $contentType = self::contentTypes['shippingMethodsGet'][0])
    {
        list($response) = $this->shippingMethodsGetWithHttpInfo($shipping_method_id, $contentType);
        return $response;
    }
     ...
     * @throws \kruegge82\jtlffn\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of |\kruegge82\jtlffn\Model\ErrorResponse|\kruegge82\jtlffn\Model\ShippingMethod, HTTP status code, HTTP response headers (array of strings)
     */
    public function shippingMethodsGetWithHttpInfo($shipping_method_id, string $contentType = self::contentTypes['shippingMethodsGet'][0])
    {
        $request = $this->shippingMethodsGetRequest($shipping_method_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\kruegge82\jtlffn\Model\ShippingMethod' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\jtlffn\Model\ShippingMethod' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\jtlffn\Model\ShippingMethod', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\kruegge82\jtlffn\Model\ShippingMethod';
            ...
            switch ($e->getCode()) {
                ...
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kruegge82\jtlffn\Model\ShippingMethod',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function shippingMethodsGetAsync($shipping_method_id, string $contentType = self::contentTypes['shippingMethodsGet'][0])
    {
        return $this->shippingMethodsGetAsyncWithHttpInfo($shipping_method_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function shippingMethodsGetAsyncWithHttpInfo($shipping_method_id, string $contentType = self::contentTypes['shippingMethodsGet'][0])
    {
        $returnType = '\kruegge82\jtlffn\Model\ShippingMethod';
        $request = $this->shippingMethodsGetRequest($shipping_method_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function shippingMethodsGetRequest($shipping_method_id, string $contentType = self::contentTypes['shippingMethodsGet'][0])
    {

        // verify the required parameter 'shipping_method_id' is set
        if ($shipping_method_id === null || (is_array($shipping_method_id) && count($shipping_method_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $shipping_method_id when calling shippingMethodsGet'
            );
        }
    ...
    /**
     * Operation shippingMethodsGetAll
     *
     * Get All
     *
     * @param  int|null $top number of elements returned by the request (optional, default to 50)
     * @param  int|null $skip offset (optional)
     * @param  string|null $filter &lt;h5&gt;allowed fields&lt;/h5&gt;                               &#39;shippingMethodId&#39;, &#39;name&#39;, &#39;carrierCode&#39;, &#39;carrierName&#39;, &#39;shippingType&#39;, &#39;fulfillerShippingMethodNumber&#39;&lt;/br&gt; (optional)
     * @param  string|null $select select fields (optional)
     * @param  string|null $order_by order result by field (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['shippingMethodsGetAll'] to see the possible values for this operation
     *
     * @throws \kruegge82\jtlffn\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return |\kruegge82\jtlffn\Model\PagedShippingMethodResponse
     */
    public function shippingMethodsGetAll($top = 50, $skip = null, $filter = null, $select = null, $order_by = null, string $contentType = self::contentTypes['shippingMethodsGetAll'][0])
    {
        list($response) = $this->shippingMethodsGetAllWithHttpInfo($top, $skip, $filter, $select, $order_by, $contentType);
        return $response;
    }

    /**
     * Operation shippingMethodsGetAllWithHttpInfo
     *
     * Get All
     *
     * @param  int|null $top number of elements returned by the request (optional, default to 50)
     ...
     * @throws \kruegge82\jtlffn\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of |\kruegge82\jtlffn\Model\PagedShippingMethodResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function shippingMethodsGetAllWithHttpInfo($top = 50, $skip = null, $filter = null, $select = null, $order_by = null, string $contentType = self::contentTypes['shippingMethodsGetAll'][0])
    {
        $request = $this->shippingMethodsGetAllRequest($top, $skip, $filter, $select, $order_by, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\jtlffn\Model\PagedShippingMethodResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\jtlffn\Model\PagedShippingMethodResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\jtlffn\Model\PagedShippingMethodResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\kruegge82\jtlffn\Model\PagedShippingMethodResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kruegge82\jtlffn\Model\PagedShippingMethodResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation shippingMethodsGetAllAsync
     *
     * Get All
     *
     * @param  int|null $top number of elements returned by the request (optional, default to 50)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function shippingMethodsGetAllAsync($top = 50, $skip = null, $filter = null, $select = null, $order_by = null, string $contentType = self::contentTypes['shippingMethodsGetAll'][0])
    {
        return $this->shippingMethodsGetAllAsyncWithHttpInfo($top, $skip, $filter, $select, $order_by, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation shippingMethodsGetAllAsyncWithHttpInfo
     *
     * Get All
     *
     * @param  int|null $top number of elements returned by the request (optional, default to 50)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function shippingMethodsGetAllAsyncWithHttpInfo($top = 50, $skip = null, $filter = null, $select = null, $order_by = null, string $contentType = self::contentTypes['shippingMethodsGetAll'][0])
    {
        $returnType = '\kruegge82\jtlffn\Model\PagedShippingMethodResponse';
        $request = $this->shippingMethodsGetAllRequest($top, $skip, $filter, $select, $order_by, $contentType);
    ...
    /**
     * Create request for operation 'shippingMethodsGetAll'
     *
     * @param  int|null $top number of elements returned by the request (optional, default to 50)
     * @param  int|null $skip offset (optional)
     * @param  string|null $filter &lt;h5&gt;allowed fields&lt;/h5&gt;                               &#39;shippingMethodId&#39;, &#39;name&#39;, &#39;carrierCode&#39;, &#39;carrierName&#39;, &#39;shippingType&#39;, &#39;fulfillerShippingMethodNumber&#39;&lt;/br&gt; (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function shippingMethodsGetAllRequest($top = 50, $skip = null, $filter = null, $select = null, $order_by = null, string $contentType = self::contentTypes['shippingMethodsGetAll'][0])
    {
        ...
        $resourcePath = '/api/v1/fulfiller/shippingmethods';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation shippingMethodsGetUpdates
     *
     * Get Updates
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['shippingMethodsGetUpdates'] to see the possible values for this operation
     *
     * @throws \kruegge82\jtlffn\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\jtlffn\Model\RecentShippingMethodList
     */
    public function shippingMethodsGetUpdates($from_date = null, $to_date = null, $page = 1, $ignore_own_application_id = false, $ignore_own_user_id = false, string $contentType = self::contentTypes['shippingMethodsGetUpdates'][0])
    {
        list($response) = $this->shippingMethodsGetUpdatesWithHttpInfo($from_date, $to_date, $page, $ignore_own_application_id, $ignore_own_user_id, $contentType);
        return $response;
    }

    /**
     * Operation shippingMethodsGetUpdatesWithHttpInfo
     *
     * Get Updates
     *
     * @param  string|null $from_date The start date of the timeframe. (optional)
     ...
     * @throws \kruegge82\jtlffn\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \kruegge82\jtlffn\Model\RecentShippingMethodList, HTTP status code, HTTP response headers (array of strings)
     */
    public function shippingMethodsGetUpdatesWithHttpInfo($from_date = null, $to_date = null, $page = 1, $ignore_own_application_id = false, $ignore_own_user_id = false, string $contentType = self::contentTypes['shippingMethodsGetUpdates'][0])
    {
        $request = $this->shippingMethodsGetUpdatesRequest($from_date, $to_date, $page, $ignore_own_application_id, $ignore_own_user_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\jtlffn\Model\RecentShippingMethodList' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\jtlffn\Model\RecentShippingMethodList' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\jtlffn\Model\RecentShippingMethodList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\kruegge82\jtlffn\Model\RecentShippingMethodList';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kruegge82\jtlffn\Model\RecentShippingMethodList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation shippingMethodsGetUpdatesAsync
     *
     * Get Updates
     *
     * @param  string|null $from_date The start date of the timeframe. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function shippingMethodsGetUpdatesAsync($from_date = null, $to_date = null, $page = 1, $ignore_own_application_id = false, $ignore_own_user_id = false, string $contentType = self::contentTypes['shippingMethodsGetUpdates'][0])
    {
        return $this->shippingMethodsGetUpdatesAsyncWithHttpInfo($from_date, $to_date, $page, $ignore_own_application_id, $ignore_own_user_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation shippingMethodsGetUpdatesAsyncWithHttpInfo
     *
     * Get Updates
     *
     * @param  string|null $from_date The start date of the timeframe. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function shippingMethodsGetUpdatesAsyncWithHttpInfo($from_date = null, $to_date = null, $page = 1, $ignore_own_application_id = false, $ignore_own_user_id = false, string $contentType = self::contentTypes['shippingMethodsGetUpdates'][0])
    {
        $returnType = '\kruegge82\jtlffn\Model\RecentShippingMethodList';
        $request = $this->shippingMethodsGetUpdatesRequest($from_date, $to_date, $page, $ignore_own_application_id, $ignore_own_user_id, $contentType);
    ...
    /**
     * Create request for operation 'shippingMethodsGetUpdates'
     *
     * @param  string|null $from_date The start date of the timeframe. (optional)
     * @param  string|null $to_date The end date of the timeframe. (optional)
     * @param  int|null $page Page number. (optional, default to 1)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function shippingMethodsGetUpdatesRequest($from_date = null, $to_date = null, $page = 1, $ignore_own_application_id = false, $ignore_own_user_id = false, string $contentType = self::contentTypes['shippingMethodsGetUpdates'][0])
    {
        ...
        $resourcePath = '/api/v1/fulfiller/shippingmethods/updates';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation shippingMethodsPost
     *
     * Post
     *
     * @param  \kruegge82\jtlffn\Model\CreateShippingMethodRequest|null $create_shipping_method_request Details af the shipping method that has to be created (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['shippingMethodsPost'] to see the possible values for this operation
     *
     * @throws \kruegge82\jtlffn\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return |\kruegge82\jtlffn\Model\ErrorResponse|\kruegge82\jtlffn\Model\ShippingMethod
     */
    public function shippingMethodsPost($create_shipping_method_request = null, string $contentType = self::contentTypes['shippingMethodsPost'][0])
    {
        list($response) = $this->shippingMethodsPostWithHttpInfo($create_shipping_method_request, $contentType);
        return $response;
    }

    /**
     * Operation shippingMethodsPostWithHttpInfo
     *
     * Post
     *
     * @param  \kruegge82\jtlffn\Model\CreateShippingMethodRequest|null $create_shipping_method_request Details af the shipping method that has to be created (optional)
     ...
     * @return array of |\kruegge82\jtlffn\Model\ErrorResponse|\kruegge82\jtlffn\Model\ShippingMethod, HTTP status code, HTTP response headers (array of strings)
     */
    public function shippingMethodsPostWithHttpInfo($create_shipping_method_request = null, string $contentType = self::contentTypes['shippingMethodsPost'][0])
    {
        $request = $this->shippingMethodsPostRequest($create_shipping_method_request, $contentType);
    ...
    /**
     * Operation shippingMethodsPostAsync
     *
     * Post
     *
     * @param  \kruegge82\jtlffn\Model\CreateShippingMethodRequest|null $create_shipping_method_request Details af the shipping method that has to be created (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function shippingMethodsPostAsync($create_shipping_method_request = null, string $contentType = self::contentTypes['shippingMethodsPost'][0])
    {
        return $this->shippingMethodsPostAsyncWithHttpInfo($create_shipping_method_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation shippingMethodsPostAsyncWithHttpInfo
     *
     * Post
     *
     * @param  \kruegge82\jtlffn\Model\CreateShippingMethodRequest|null $create_shipping_method_request Details af the shipping method that has to be created (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function shippingMethodsPostAsyncWithHttpInfo($create_shipping_method_request = null, string $contentType = self::contentTypes['shippingMethodsPost'][0])
    {
        $returnType = '\kruegge82\jtlffn\Model\ShippingMethod';
        $request = $this->shippingMethodsPostRequest($create_shipping_method_request, $contentType);
    ...
    /**
     * Create request for operation 'shippingMethodsPost'
     *
     * @param  \kruegge82\jtlffn\Model\CreateShippingMethodRequest|null $create_shipping_method_request Details af the shipping method that has to be created (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['shippingMethodsPost'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function shippingMethodsPostRequest($create_shipping_method_request = null, string $contentType = self::contentTypes['shippingMethodsPost'][0])
    {
        ...
        // for model (json/xml)
        if (isset($create_shipping_method_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($create_shipping_method_request));
            } else {
                $httpBody = $create_shipping_method_request;
            }
    ...
    /**
     * Operation shippingMethodsUpdate
     *
     * Update
     *
     * @param  string $shipping_method_id  (required)
     * @param  \kruegge82\jtlffn\Model\UpdateShippingMethodRequest|null $update_shipping_method_request Details af the shipping method that has to be created (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['shippingMethodsUpdate'] to see the possible values for this operation
     *
     * @throws \kruegge82\jtlffn\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function shippingMethodsUpdate($shipping_method_id, $update_shipping_method_request = null, string $contentType = self::contentTypes['shippingMethodsUpdate'][0])
    {
        $this->shippingMethodsUpdateWithHttpInfo($shipping_method_id, $update_shipping_method_request, $contentType);
    }

    /**
     * Operation shippingMethodsUpdateWithHttpInfo
     *
     * Update
     *
     * @param  string $shipping_method_id  (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function shippingMethodsUpdateWithHttpInfo($shipping_method_id, $update_shipping_method_request = null, string $contentType = self::contentTypes['shippingMethodsUpdate'][0])
    {
        $request = $this->shippingMethodsUpdateRequest($shipping_method_id, $update_shipping_method_request, $contentType);
    ...
    /**
     * Operation shippingMethodsUpdateAsync
     *
     * Update
     *
     * @param  string $shipping_method_id  (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function shippingMethodsUpdateAsync($shipping_method_id, $update_shipping_method_request = null, string $contentType = self::contentTypes['shippingMethodsUpdate'][0])
    {
        return $this->shippingMethodsUpdateAsyncWithHttpInfo($shipping_method_id, $update_shipping_method_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation shippingMethodsUpdateAsyncWithHttpInfo
     *
     * Update
     *
     * @param  string $shipping_method_id  (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function shippingMethodsUpdateAsyncWithHttpInfo($shipping_method_id, $update_shipping_method_request = null, string $contentType = self::contentTypes['shippingMethodsUpdate'][0])
    {
        $returnType = '';
        $request = $this->shippingMethodsUpdateRequest($shipping_method_id, $update_shipping_method_request, $contentType);
    ...
    /**
     * Create request for operation 'shippingMethodsUpdate'
     *
     * @param  string $shipping_method_id  (required)
     * @param  \kruegge82\jtlffn\Model\UpdateShippingMethodRequest|null $update_shipping_method_request Details af the shipping method that has to be created (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['shippingMethodsUpdate'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function shippingMethodsUpdateRequest($shipping_method_id, $update_shipping_method_request = null, string $contentType = self::contentTypes['shippingMethodsUpdate'][0])
    {

        // verify the required parameter 'shipping_method_id' is set
        if ($shipping_method_id === null || (is_array($shipping_method_id) && count($shipping_method_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $shipping_method_id when calling shippingMethodsUpdate'
            );
        }
        ...
        // for model (json/xml)
        if (isset($update_shipping_method_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($update_shipping_method_request));
            } else {
                $httpBody = $update_shipping_method_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
