...
class ReturnsApi
{
    ...
    public function returnsGetWithHttpInfo($return_id, string $contentType = self::contentTypes['returnsGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\kruegge82\jtlffn\Model\ModelReturn' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\jtlffn\Model\ModelReturn' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\jtlffn\Model\ModelReturn', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    public function returnsGetAllWithHttpInfo($top = 50, $skip = null, $filter = null, $select = null, $order_by = null, string $contentType = self::contentTypes['returnsGetAll'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\jtlffn\Model\PagedReturnResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\jtlffn\Model\PagedReturnResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\jtlffn\Model\PagedReturnResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    public function returnsGetChangesWithHttpInfo($from_date = null, $to_date = null, $page = 1, $ignore_own_application_id = false, $ignore_own_user_id = false, string $contentType = self::contentTypes['returnsGetChanges'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\jtlffn\Model\RecentReturnChangeList' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\jtlffn\Model\RecentReturnChangeList' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\jtlffn\Model\RecentReturnChangeList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    public function returnsGetReturnItemWithHttpInfo($return_id, $return_item_id, string $contentType = self::contentTypes['returnsGetReturnItem'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\kruegge82\jtlffn\Model\ReturnItem' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\jtlffn\Model\ReturnItem' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\jtlffn\Model\ReturnItem', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    public function returnsGetUpdatesWithHttpInfo($from_date = null, $to_date = null, $page = 1, $ignore_own_application_id = false, $ignore_own_user_id = false, string $contentType = self::contentTypes['returnsGetUpdates'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\jtlffn\Model\RecentReturnList' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\jtlffn\Model\RecentReturnList' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\jtlffn\Model\RecentReturnList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
