...
class ProductsApi
{
     ...
     * @return |\kruegge82\jtlffn\Model\ErrorResponse|\kruegge82\jtlffn\Model\Product
     */
    public function productsGet($jfsku, string $contentType = self::contentTypes['productsGet'][0])
    {
        list($response) = $this->productsGetWithHttpInfo($jfsku, $contentType);
        return $response;
    }
     ...
     * @throws \kruegge82\jtlffn\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of |\kruegge82\jtlffn\Model\ErrorResponse|\kruegge82\jtlffn\Model\Product, HTTP status code, HTTP response headers (array of strings)
     */
    public function productsGetWithHttpInfo($jfsku, string $contentType = self::contentTypes['productsGet'][0])
    {
        $request = $this->productsGetRequest($jfsku, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\kruegge82\jtlffn\Model\Product' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\jtlffn\Model\Product' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\jtlffn\Model\Product', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\kruegge82\jtlffn\Model\Product';
            ...
            switch ($e->getCode()) {
                ...
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kruegge82\jtlffn\Model\Product',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     */
    public function productsGetAsync($jfsku, string $contentType = self::contentTypes['productsGet'][0])
    {
        return $this->productsGetAsyncWithHttpInfo($jfsku, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsGetAsyncWithHttpInfo($jfsku, string $contentType = self::contentTypes['productsGet'][0])
    {
        $returnType = '\kruegge82\jtlffn\Model\Product';
        $request = $this->productsGetRequest($jfsku, $contentType);
     ...
     */
    public function productsGetRequest($jfsku, string $contentType = self::contentTypes['productsGet'][0])
    {

        // verify the required parameter 'jfsku' is set
        if ($jfsku === null || (is_array($jfsku) && count($jfsku) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $jfsku when calling productsGet'
            );
        }


        $resourcePath = '/api/v1/fulfiller/products/{jfsku}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \kruegge82\jtlffn\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of |\kruegge82\jtlffn\Model\PagedProductResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function productsGetAllWithHttpInfo($referenced_warehouse = null, $top = 50, $skip = null, $filter = null, $select = null, $order_by = null, string $contentType = self::contentTypes['productsGetAll'][0])
    {
        $request = $this->productsGetAllRequest($referenced_warehouse, $top, $skip, $filter, $select, $order_by, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\jtlffn\Model\PagedProductResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\jtlffn\Model\PagedProductResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\jtlffn\Model\PagedProductResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\kruegge82\jtlffn\Model\PagedProductResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kruegge82\jtlffn\Model\PagedProductResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsGetAllAsync($referenced_warehouse = null, $top = 50, $skip = null, $filter = null, $select = null, $order_by = null, string $contentType = self::contentTypes['productsGetAll'][0])
    {
        return $this->productsGetAllAsyncWithHttpInfo($referenced_warehouse, $top, $skip, $filter, $select, $order_by, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsGetAllAsyncWithHttpInfo($referenced_warehouse = null, $top = 50, $skip = null, $filter = null, $select = null, $order_by = null, string $contentType = self::contentTypes['productsGetAll'][0])
    {
        $returnType = '\kruegge82\jtlffn\Model\PagedProductResponse';
        $request = $this->productsGetAllRequest($referenced_warehouse, $top, $skip, $filter, $select, $order_by, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function productsGetAllRequest($referenced_warehouse = null, $top = 50, $skip = null, $filter = null, $select = null, $order_by = null, string $contentType = self::contentTypes['productsGetAll'][0])
    {
        ...
        $resourcePath = '/api/v1/fulfiller/products';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $referenced_warehouse,
            'referencedWarehouse', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
    ...
    /**
     * Operation productsGetPicture
     *
     * Get Picture
     *
     * @param  string $jfsku Product identifer (required)
     * @param  int $number Number of the picture. A Product can have several pictures (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['productsGetPicture'] to see the possible values for this operation
     *
     * @throws \kruegge82\jtlffn\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return |\kruegge82\jtlffn\Model\ErrorResponse|\kruegge82\jtlffn\Model\PictureData
     */
    public function productsGetPicture($jfsku, $number, string $contentType = self::contentTypes['productsGetPicture'][0])
    {
        list($response) = $this->productsGetPictureWithHttpInfo($jfsku, $number, $contentType);
        return $response;
    }

    /**
     * Operation productsGetPictureWithHttpInfo
     *
     * Get Picture
     *
     * @param  string $jfsku Product identifer (required)
     ...
     * @throws \kruegge82\jtlffn\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of |\kruegge82\jtlffn\Model\ErrorResponse|\kruegge82\jtlffn\Model\PictureData, HTTP status code, HTTP response headers (array of strings)
     */
    public function productsGetPictureWithHttpInfo($jfsku, $number, string $contentType = self::contentTypes['productsGetPicture'][0])
    {
        $request = $this->productsGetPictureRequest($jfsku, $number, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\kruegge82\jtlffn\Model\PictureData' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\jtlffn\Model\PictureData' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\jtlffn\Model\PictureData', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\kruegge82\jtlffn\Model\PictureData';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                ...
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kruegge82\jtlffn\Model\PictureData',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation productsGetPictureAsync
     *
     * Get Picture
     *
     * @param  string $jfsku Product identifer (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsGetPictureAsync($jfsku, $number, string $contentType = self::contentTypes['productsGetPicture'][0])
    {
        return $this->productsGetPictureAsyncWithHttpInfo($jfsku, $number, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation productsGetPictureAsyncWithHttpInfo
     *
     * Get Picture
     *
     * @param  string $jfsku Product identifer (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsGetPictureAsyncWithHttpInfo($jfsku, $number, string $contentType = self::contentTypes['productsGetPicture'][0])
    {
        $returnType = '\kruegge82\jtlffn\Model\PictureData';
        $request = $this->productsGetPictureRequest($jfsku, $number, $contentType);
    ...
    /**
     * Create request for operation 'productsGetPicture'
     *
     * @param  string $jfsku Product identifer (required)
     * @param  int $number Number of the picture. A Product can have several pictures (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['productsGetPicture'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function productsGetPictureRequest($jfsku, $number, string $contentType = self::contentTypes['productsGetPicture'][0])
    {

        // verify the required parameter 'jfsku' is set
        if ($jfsku === null || (is_array($jfsku) && count($jfsku) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $jfsku when calling productsGetPicture'
            );
        }
        ...
        if ($number === null || (is_array($number) && count($number) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $number when calling productsGetPicture'
            );
        }


        $resourcePath = '/api/v1/fulfiller/products/{jfsku}/pictures/{number}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation productsGetPictureData
     *
     * Get Picture Data
     *
     * @param  string $jfsku Product identifer (required)
     * @param  int $number The number of the picture you want to receive (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['productsGetPictureData'] to see the possible values for this operation
     *
     * @throws \kruegge82\jtlffn\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return |\kruegge82\jtlffn\Model\ErrorResponse|\SplFileObject
     */
    public function productsGetPictureData($jfsku, $number, string $contentType = self::contentTypes['productsGetPictureData'][0])
    {
        list($response) = $this->productsGetPictureDataWithHttpInfo($jfsku, $number, $contentType);
        return $response;
    }

    /**
     * Operation productsGetPictureDataWithHttpInfo
     *
     * Get Picture Data
     *
     * @param  string $jfsku Product identifer (required)
     ...
     * @throws \kruegge82\jtlffn\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of |\kruegge82\jtlffn\Model\ErrorResponse|\SplFileObject, HTTP status code, HTTP response headers (array of strings)
     */
    public function productsGetPictureDataWithHttpInfo($jfsku, $number, string $contentType = self::contentTypes['productsGetPictureData'][0])
    {
        $request = $this->productsGetPictureDataRequest($jfsku, $number, $contentType);
    ...
    /**
     * Operation productsGetPictureDataAsync
     *
     * Get Picture Data
     *
     * @param  string $jfsku Product identifer (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsGetPictureDataAsync($jfsku, $number, string $contentType = self::contentTypes['productsGetPictureData'][0])
    {
        return $this->productsGetPictureDataAsyncWithHttpInfo($jfsku, $number, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation productsGetPictureDataAsyncWithHttpInfo
     *
     * Get Picture Data
     *
     * @param  string $jfsku Product identifer (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsGetPictureDataAsyncWithHttpInfo($jfsku, $number, string $contentType = self::contentTypes['productsGetPictureData'][0])
    {
        $returnType = '\SplFileObject';
        $request = $this->productsGetPictureDataRequest($jfsku, $number, $contentType);
    ...
    /**
     * Create request for operation 'productsGetPictureData'
     *
     * @param  string $jfsku Product identifer (required)
     * @param  int $number The number of the picture you want to receive (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['productsGetPictureData'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function productsGetPictureDataRequest($jfsku, $number, string $contentType = self::contentTypes['productsGetPictureData'][0])
    {

        // verify the required parameter 'jfsku' is set
        if ($jfsku === null || (is_array($jfsku) && count($jfsku) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $jfsku when calling productsGetPictureData'
            );
        }
        ...
        if ($number === null || (is_array($number) && count($number) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $number when calling productsGetPictureData'
            );
        }


        $resourcePath = '/api/v1/fulfiller/products/{jfsku}/pictures/{number}/data';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['productsGetUpdates'] to see the possible values for this operation
     *
     * @throws \kruegge82\jtlffn\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \kruegge82\jtlffn\Model\RecentProductList
     */
    public function productsGetUpdates($from_date = null, $to_date = null, $page = 1, $ignore_own_application_id = false, $ignore_own_user_id = false, string $contentType = self::contentTypes['productsGetUpdates'][0])
    {
        list($response) = $this->productsGetUpdatesWithHttpInfo($from_date, $to_date, $page, $ignore_own_application_id, $ignore_own_user_id, $contentType);
        return $response;
    }

    /**
     * Operation productsGetUpdatesWithHttpInfo
     *
     * Get Updates
     *
     * @param  string|null $from_date The start date of the timeframe. (optional)
     ...
     * @throws \kruegge82\jtlffn\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \kruegge82\jtlffn\Model\RecentProductList, HTTP status code, HTTP response headers (array of strings)
     */
    public function productsGetUpdatesWithHttpInfo($from_date = null, $to_date = null, $page = 1, $ignore_own_application_id = false, $ignore_own_user_id = false, string $contentType = self::contentTypes['productsGetUpdates'][0])
    {
        $request = $this->productsGetUpdatesRequest($from_date, $to_date, $page, $ignore_own_application_id, $ignore_own_user_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\kruegge82\jtlffn\Model\RecentProductList' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\kruegge82\jtlffn\Model\RecentProductList' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\kruegge82\jtlffn\Model\RecentProductList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\kruegge82\jtlffn\Model\RecentProductList';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\kruegge82\jtlffn\Model\RecentProductList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation productsGetUpdatesAsync
     *
     * Get Updates
     *
     * @param  string|null $from_date The start date of the timeframe. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsGetUpdatesAsync($from_date = null, $to_date = null, $page = 1, $ignore_own_application_id = false, $ignore_own_user_id = false, string $contentType = self::contentTypes['productsGetUpdates'][0])
    {
        return $this->productsGetUpdatesAsyncWithHttpInfo($from_date, $to_date, $page, $ignore_own_application_id, $ignore_own_user_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation productsGetUpdatesAsyncWithHttpInfo
     *
     * Get Updates
     *
     * @param  string|null $from_date The start date of the timeframe. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsGetUpdatesAsyncWithHttpInfo($from_date = null, $to_date = null, $page = 1, $ignore_own_application_id = false, $ignore_own_user_id = false, string $contentType = self::contentTypes['productsGetUpdates'][0])
    {
        $returnType = '\kruegge82\jtlffn\Model\RecentProductList';
        $request = $this->productsGetUpdatesRequest($from_date, $to_date, $page, $ignore_own_application_id, $ignore_own_user_id, $contentType);
    ...
    /**
     * Create request for operation 'productsGetUpdates'
     *
     * @param  string|null $from_date The start date of the timeframe. (optional)
     * @param  string|null $to_date The end date of the timeframe. (optional)
     * @param  int|null $page Page number. (optional, default to 1)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function productsGetUpdatesRequest($from_date = null, $to_date = null, $page = 1, $ignore_own_application_id = false, $ignore_own_user_id = false, string $contentType = self::contentTypes['productsGetUpdates'][0])
    {
        ...
        $resourcePath = '/api/v1/fulfiller/products/updates';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation productsPostRelated
     *
     * Post Related
     *
     * @param  string $jfsku  (required)
     * @param  \kruegge82\jtlffn\Model\CreateRelatedProductRequest|null $create_related_product_request Product details (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['productsPostRelated'] to see the possible values for this operation
     *
     * @throws \kruegge82\jtlffn\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return |\kruegge82\jtlffn\Model\ErrorResponse|\kruegge82\jtlffn\Model\ErrorResponse|\kruegge82\jtlffn\Model\Product
     */
    public function productsPostRelated($jfsku, $create_related_product_request = null, string $contentType = self::contentTypes['productsPostRelated'][0])
    {
        list($response) = $this->productsPostRelatedWithHttpInfo($jfsku, $create_related_product_request, $contentType);
        return $response;
    }

    /**
     * Operation productsPostRelatedWithHttpInfo
     *
     * Post Related
     *
     * @param  string $jfsku  (required)
     ...
     * @throws \kruegge82\jtlffn\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of |\kruegge82\jtlffn\Model\ErrorResponse|\kruegge82\jtlffn\Model\ErrorResponse|\kruegge82\jtlffn\Model\Product, HTTP status code, HTTP response headers (array of strings)
     */
    public function productsPostRelatedWithHttpInfo($jfsku, $create_related_product_request = null, string $contentType = self::contentTypes['productsPostRelated'][0])
    {
        $request = $this->productsPostRelatedRequest($jfsku, $create_related_product_request, $contentType);
    ...
    /**
     * Operation productsPostRelatedAsync
     *
     * Post Related
     *
     * @param  string $jfsku  (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsPostRelatedAsync($jfsku, $create_related_product_request = null, string $contentType = self::contentTypes['productsPostRelated'][0])
    {
        return $this->productsPostRelatedAsyncWithHttpInfo($jfsku, $create_related_product_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation productsPostRelatedAsyncWithHttpInfo
     *
     * Post Related
     *
     * @param  string $jfsku  (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsPostRelatedAsyncWithHttpInfo($jfsku, $create_related_product_request = null, string $contentType = self::contentTypes['productsPostRelated'][0])
    {
        $returnType = '\kruegge82\jtlffn\Model\Product';
        $request = $this->productsPostRelatedRequest($jfsku, $create_related_product_request, $contentType);
    ...
    /**
     * Create request for operation 'productsPostRelated'
     *
     * @param  string $jfsku  (required)
     * @param  \kruegge82\jtlffn\Model\CreateRelatedProductRequest|null $create_related_product_request Product details (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['productsPostRelated'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function productsPostRelatedRequest($jfsku, $create_related_product_request = null, string $contentType = self::contentTypes['productsPostRelated'][0])
    {

        // verify the required parameter 'jfsku' is set
        if ($jfsku === null || (is_array($jfsku) && count($jfsku) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $jfsku when calling productsPostRelated'
            );
        }



        $resourcePath = '/api/v1/fulfiller/products/{jfsku}/related-products/condition';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($create_related_product_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($create_related_product_request));
            } else {
                $httpBody = $create_related_product_request;
            }
