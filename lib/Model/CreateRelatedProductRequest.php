...
/**
 * CreateRelatedProductRequest Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\jtlffn
 * @author   OpenAPI Generator team
 ...
 */
class CreateRelatedProductRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateRelatedProductRequest';
    ...
    public const CONDITION__DEFAULT = 'Default';
