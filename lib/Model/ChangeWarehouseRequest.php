...
/**
 * ChangeWarehouseRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class ChangeWarehouseRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChangeWarehouseRequest';
    ...
    */
    ...
    public function setWarehouseId($warehouse_id)
    {
        ...
        if ((mb_strlen($warehouse_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $warehouse_id when calling ChangeWarehouseRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($warehouse_id) < 14)) {
            throw new \InvalidArgumentException('invalid length for $warehouse_id when calling ChangeWarehouseRequest., must be bigger than or equal to 14.');
        }
