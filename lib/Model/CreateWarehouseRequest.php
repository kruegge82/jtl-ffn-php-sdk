...
/**
 * CreateWarehouseRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateWarehouseRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateWarehouseRequest';
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'address' => '\kruegge82\jtlffn\Model\CreateAddressRequest'
    ];
    ...
    */
     ...
     * Sets address
     *
     * @param \kruegge82\jtlffn\Model\CreateAddressRequest $address address
     *
     * @return self
     */
