 ...
 */
class StockChange implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StockChange';
    ...
    */
    ...
    public function setFulfillerStockChangeId($fulfiller_stock_change_id)
    {
        ...
        if (!is_null($fulfiller_stock_change_id) && (mb_strlen($fulfiller_stock_change_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $fulfiller_stock_change_id when calling StockChange., must be smaller than or equal to 255.');
        }
        if (!is_null($fulfiller_stock_change_id) && (mb_strlen($fulfiller_stock_change_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $fulfiller_stock_change_id when calling StockChange., must be bigger than or equal to 0.');
        }
    ...
    public function setBatch($batch)
    {
        ...
        if (!is_null($batch) && (mb_strlen($batch) > 255)) {
            throw new \InvalidArgumentException('invalid length for $batch when calling StockChange., must be smaller than or equal to 255.');
        }
        if (!is_null($batch) && (mb_strlen($batch) < 0)) {
            throw new \InvalidArgumentException('invalid length for $batch when calling StockChange., must be bigger than or equal to 0.');
        }
    ...
    public function setNote($note)
    {
        ...
        if (!is_null($note) && (mb_strlen($note) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $note when calling StockChange., must be smaller than or equal to 4096.');
        }
        if (!is_null($note) && (mb_strlen($note) < 0)) {
            throw new \InvalidArgumentException('invalid length for $note when calling StockChange., must be bigger than or equal to 0.');
        }
    ...
    public function setMerchantSku($merchant_sku)
    {
        ...
        if ((mb_strlen($merchant_sku) > 255)) {
            throw new \InvalidArgumentException('invalid length for $merchant_sku when calling StockChange., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($merchant_sku) < 0)) {
            throw new \InvalidArgumentException('invalid length for $merchant_sku when calling StockChange., must be bigger than or equal to 0.');
        }
