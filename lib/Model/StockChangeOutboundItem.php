...
/**
 * StockChangeOutboundItem Class Doc Comment
 *
 * @category Class
 ...
 */
class StockChangeOutboundItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StockChangeOutboundItem';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['outbound_id']) < 0)) {
    ...
    public function setOutboundId($outbound_id)
    {
        ...
        if ((mb_strlen($outbound_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $outbound_id when calling StockChangeOutboundItem., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($outbound_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $outbound_id when calling StockChangeOutboundItem., must be bigger than or equal to 0.');
        }
    ...
    public function setOutboundItemId($outbound_item_id)
    {
        ...
        if (!is_null($outbound_item_id) && (mb_strlen($outbound_item_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $outbound_item_id when calling StockChangeOutboundItem., must be smaller than or equal to 255.');
        }
        if (!is_null($outbound_item_id) && (mb_strlen($outbound_item_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $outbound_item_id when calling StockChangeOutboundItem., must be bigger than or equal to 0.');
        }
