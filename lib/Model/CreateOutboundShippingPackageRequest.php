...
/**
 * CreateOutboundShippingPackageRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateOutboundShippingPackageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateOutboundShippingPackageRequest';
    ...
    protected static $openAPITypes = [
        ...
        'note' => 'string',
        'tracking_url' => 'string',
        'identifier' => '\kruegge82\jtlffn\Model\CreatePackageIdentifierRequest[]',
        'shipping_date' => '\DateTime',
        'shipping_method_id' => 'string',
        'dimensions' => '\kruegge82\jtlffn\Model\CreateOutboundShippingPackageDimensionsRequest',
        'weight' => 'float'
    ];
    ...
    */
     ...
     * Gets freight_option
     *
     * @return \kruegge82\jtlffn\Model\FreightOptionType|null
     */
     ...
     * Sets freight_option
     *
     * @param \kruegge82\jtlffn\Model\FreightOptionType|null $freight_option freight_option
     *
     * @return self
     */
    ...
    public function setNote($note)
    {
        ...
        if (!is_null($note) && (mb_strlen($note) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $note when calling CreateOutboundShippingPackageRequest., must be smaller than or equal to 4096.');
        }
        if (!is_null($note) && (mb_strlen($note) < 0)) {
            throw new \InvalidArgumentException('invalid length for $note when calling CreateOutboundShippingPackageRequest., must be bigger than or equal to 0.');
        }
     ...
     * Gets identifier
     *
     * @return \kruegge82\jtlffn\Model\CreatePackageIdentifierRequest[]|null
     */
     ...
     * Sets identifier
     *
     * @param \kruegge82\jtlffn\Model\CreatePackageIdentifierRequest[]|null $identifier Package identifier container
     *
     * @return self
     */
    ...
    public function setShippingMethodId($shipping_method_id)
    {
        ...
        if ((mb_strlen($shipping_method_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $shipping_method_id when calling CreateOutboundShippingPackageRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($shipping_method_id) < 4)) {
            throw new \InvalidArgumentException('invalid length for $shipping_method_id when calling CreateOutboundShippingPackageRequest., must be bigger than or equal to 4.');
        }
     ...
     * Gets dimensions
     *
     * @return \kruegge82\jtlffn\Model\CreateOutboundShippingPackageDimensionsRequest|null
     */
     ...
     * Sets dimensions
     *
     * @param \kruegge82\jtlffn\Model\CreateOutboundShippingPackageDimensionsRequest|null $dimensions dimensions
     *
     * @return self
     */
