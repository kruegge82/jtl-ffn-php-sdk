...
/**
 * OutboundShippingPackage Class Doc Comment
 *
 * @category Class
 ...
 */
class OutboundShippingPackage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OutboundShippingPackage';
    ...
    protected static $openAPITypes = [
        ...
        'dimensions' => '\kruegge82\jtlffn\Model\OutboundShippingPackageDimensions',
        'weight' => 'float'
    ];
    ...
    */
    ...
    public function setNote($note)
    {
        ...
        if (!is_null($note) && (mb_strlen($note) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $note when calling OutboundShippingPackage., must be smaller than or equal to 4096.');
        }
        if (!is_null($note) && (mb_strlen($note) < 0)) {
            throw new \InvalidArgumentException('invalid length for $note when calling OutboundShippingPackage., must be bigger than or equal to 0.');
        }
    ...
    public function setTrackingUrl($tracking_url)
    {
        ...
        if (!is_null($tracking_url) && (mb_strlen($tracking_url) > 255)) {
            throw new \InvalidArgumentException('invalid length for $tracking_url when calling OutboundShippingPackage., must be smaller than or equal to 255.');
        }
        if (!is_null($tracking_url) && (mb_strlen($tracking_url) < 0)) {
            throw new \InvalidArgumentException('invalid length for $tracking_url when calling OutboundShippingPackage., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param string $shipping_method_id Shipping method identifier
     *
     * @return self
     */
    public function setShippingMethodId($shipping_method_id)
    {
        ...
        if ((mb_strlen($shipping_method_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $shipping_method_id when calling OutboundShippingPackage., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($shipping_method_id) < 4)) {
            throw new \InvalidArgumentException('invalid length for $shipping_method_id when calling OutboundShippingPackage., must be bigger than or equal to 4.');
        }
     ...
     * Gets dimensions
     *
     * @return \kruegge82\jtlffn\Model\OutboundShippingPackageDimensions|null
     */
     ...
     * Sets dimensions
     *
     * @param \kruegge82\jtlffn\Model\OutboundShippingPackageDimensions|null $dimensions dimensions
     *
     * @return self
     */
