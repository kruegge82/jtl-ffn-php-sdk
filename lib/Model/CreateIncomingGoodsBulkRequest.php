...
/**
 * CreateIncomingGoodsBulkRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateIncomingGoodsBulkRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateIncomingGoodsBulkRequest';
    ...
    protected static $openAPITypes = [
        'items' => '\kruegge82\jtlffn\Model\CreateIncomingGoodsItemRequest[]'
    ];
    ...
    */
     ...
     * Gets items
     *
     * @return \kruegge82\jtlffn\Model\CreateIncomingGoodsItemRequest[]
     */
     ...
     * Sets items
     *
     * @param \kruegge82\jtlffn\Model\CreateIncomingGoodsItemRequest[] $items Collection of incoming goods items
     *
     * @return self
     */
