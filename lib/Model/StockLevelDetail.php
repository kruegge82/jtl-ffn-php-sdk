...
/**
 * StockLevelDetail Class Doc Comment
 *
 * @category Class
 ...
 */
class StockLevelDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StockLevelDetail';
    ...
    */
     ...
     * Sets batch
     *
     * @param string|null $batch Batch of a product
     *
     * @return self
     */
    public function setBatch($batch)
    {
        ...
        if (!is_null($batch) && (mb_strlen($batch) > 255)) {
            throw new \InvalidArgumentException('invalid length for $batch when calling StockLevelDetail., must be smaller than or equal to 255.');
        }
        if (!is_null($batch) && (mb_strlen($batch) < 0)) {
            throw new \InvalidArgumentException('invalid length for $batch when calling StockLevelDetail., must be bigger than or equal to 0.');
        }
