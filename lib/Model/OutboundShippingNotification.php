...
/**
 * OutboundShippingNotification Class Doc Comment
 *
 * @category Class
 ...
 */
class OutboundShippingNotification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OutboundShippingNotification';
    ...
    protected static $openAPITypes = [
        'outbound_id' => 'string',
        'merchant_id' => 'string',
        'fulfiller_shipping_notification_number' => 'string',
        'outbound_shipping_notification_id' => 'string',
        'items' => '\kruegge82\jtlffn\Model\OutboundShippingNotificationItem[]',
        'packages' => '\kruegge82\jtlffn\Model\OutboundShippingPackage[]',
        'outbound_status' => '\kruegge82\jtlffn\Model\OutboundStatusType',
        'note' => 'string',
    ...
    protected static $openAPIFormats = [
        'outbound_id' => null,
        'merchant_id' => null,
        'fulfiller_shipping_notification_number' => null,
        'outbound_shipping_notification_id' => null,
        'items' => null,
        'packages' => null,
    ...
    protected static array $openAPINullables = [
        'outbound_id' => false,
        'merchant_id' => false,
        'fulfiller_shipping_notification_number' => false,
        'outbound_shipping_notification_id' => false,
        'items' => false,
        'packages' => false,
    ...
    protected static $attributeMap = [
        ...
        'fulfiller_shipping_notification_number' => 'fulfillerShippingNotificationNumber',
        'outbound_shipping_notification_id' => 'outboundShippingNotificationId',
        'items' => 'items',
        'packages' => 'packages',
    ...
    protected static $setters = [
        ...
        'fulfiller_shipping_notification_number' => 'setFulfillerShippingNotificationNumber',
        'outbound_shipping_notification_id' => 'setOutboundShippingNotificationId',
        'items' => 'setItems',
        'packages' => 'setPackages',
        'outbound_status' => 'setOutboundStatus',
        'note' => 'setNote',
    ...
    protected static $getters = [
        ...
        'fulfiller_shipping_notification_number' => 'getFulfillerShippingNotificationNumber',
        'outbound_shipping_notification_id' => 'getOutboundShippingNotificationId',
        'items' => 'getItems',
        'packages' => 'getPackages',
        'outbound_status' => 'getOutboundStatus',
        'note' => 'getNote',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('fulfiller_shipping_notification_number', $data ?? [], null);
        $this->setIfExists('outbound_shipping_notification_id', $data ?? [], null);
        $this->setIfExists('items', $data ?? [], null);
        $this->setIfExists('packages', $data ?? [], null);
        $this->setIfExists('outbound_status', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['fulfiller_shipping_notification_number'] === null) {
            $invalidProperties[] = "'fulfiller_shipping_notification_number' can't be null";
        }
        if ((mb_strlen($this->container['fulfiller_shipping_notification_number']) > 255)) {
            $invalidProperties[] = "invalid value for 'fulfiller_shipping_notification_number', the character length must be smaller than or equal to 255.";
        }

        if ((mb_strlen($this->container['fulfiller_shipping_notification_number']) < 0)) {
            $invalidProperties[] = "invalid value for 'fulfiller_shipping_notification_number', the character length must be bigger than or equal to 0.";
        }

        if ($this->container['outbound_shipping_notification_id'] === null) {
            $invalidProperties[] = "'outbound_shipping_notification_id' can't be null";
        }
        if ((mb_strlen($this->container['outbound_shipping_notification_id']) > 255)) {
            $invalidProperties[] = "invalid value for 'outbound_shipping_notification_id', the character length must be smaller than or equal to 255.";
        }

        if ((mb_strlen($this->container['outbound_shipping_notification_id']) < 7)) {
            $invalidProperties[] = "invalid value for 'outbound_shipping_notification_id', the character length must be bigger than or equal to 7.";
        }
        ...
        if ($this->container['outbound_status'] === null) {
            $invalidProperties[] = "'outbound_status' can't be null";
        }
    ...
    public function setOutboundId($outbound_id)
    {
        ...
        if ((mb_strlen($outbound_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $outbound_id when calling OutboundShippingNotification., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($outbound_id) < 7)) {
            throw new \InvalidArgumentException('invalid length for $outbound_id when calling OutboundShippingNotification., must be bigger than or equal to 7.');
        }
    ...
    public function setMerchantId($merchant_id)
    {
        ...
        if ((mb_strlen($merchant_id) > 4)) {
            throw new \InvalidArgumentException('invalid length for $merchant_id when calling OutboundShippingNotification., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($merchant_id) < 4)) {
            throw new \InvalidArgumentException('invalid length for $merchant_id when calling OutboundShippingNotification., must be bigger than or equal to 4.');
        }
    ...
    /**
     * Gets fulfiller_shipping_notification_number
     *
     * @return string
     */
    public function getFulfillerShippingNotificationNumber()
    {
        return $this->container['fulfiller_shipping_notification_number'];
    }

    /**
     * Sets fulfiller_shipping_notification_number
     *
     * @param string $fulfiller_shipping_notification_number Outbound shipping notification identifier
     *
     * @return self
     */
    public function setFulfillerShippingNotificationNumber($fulfiller_shipping_notification_number)
    {
        if (is_null($fulfiller_shipping_notification_number)) {
            throw new \InvalidArgumentException('non-nullable fulfiller_shipping_notification_number cannot be null');
        }
        if ((mb_strlen($fulfiller_shipping_notification_number) > 255)) {
            throw new \InvalidArgumentException('invalid length for $fulfiller_shipping_notification_number when calling OutboundShippingNotification., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($fulfiller_shipping_notification_number) < 0)) {
            throw new \InvalidArgumentException('invalid length for $fulfiller_shipping_notification_number when calling OutboundShippingNotification., must be bigger than or equal to 0.');
        }

        $this->container['fulfiller_shipping_notification_number'] = $fulfiller_shipping_notification_number;

        return $this;
    }

    /**
     * Gets outbound_shipping_notification_id
     *
     * @return string
     */
    public function getOutboundShippingNotificationId()
    {
        return $this->container['outbound_shipping_notification_id'];
    }

    /**
     * Sets outbound_shipping_notification_id
     *
     * @param string $outbound_shipping_notification_id Outbound shipping notification identifier
     *
     * @return self
     */
    public function setOutboundShippingNotificationId($outbound_shipping_notification_id)
    {
        if (is_null($outbound_shipping_notification_id)) {
            throw new \InvalidArgumentException('non-nullable outbound_shipping_notification_id cannot be null');
        }
        if ((mb_strlen($outbound_shipping_notification_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $outbound_shipping_notification_id when calling OutboundShippingNotification., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($outbound_shipping_notification_id) < 7)) {
            throw new \InvalidArgumentException('invalid length for $outbound_shipping_notification_id when calling OutboundShippingNotification., must be bigger than or equal to 7.');
        }

        $this->container['outbound_shipping_notification_id'] = $outbound_shipping_notification_id;
     ...
     * Gets items
     *
     * @return \kruegge82\jtlffn\Model\OutboundShippingNotificationItem[]
     */
     ...
     * Sets items
     *
     * @param \kruegge82\jtlffn\Model\OutboundShippingNotificationItem[] $items Items within the outbound shipping notification
     *
     * @return self
     */
     ...
     * Gets packages
     *
     * @return \kruegge82\jtlffn\Model\OutboundShippingPackage[]
     */
     ...
     * Sets packages
     *
     * @param \kruegge82\jtlffn\Model\OutboundShippingPackage[] $packages Packages within the outbound shipping notification
     *
     * @return self
     */
    ...
    /**
     * Gets outbound_status
     *
     * @return \kruegge82\jtlffn\Model\OutboundStatusType
     */
    public function getOutboundStatus()
    {
        return $this->container['outbound_status'];
    }

    /**
     * Sets outbound_status
     *
     * @param \kruegge82\jtlffn\Model\OutboundStatusType $outbound_status outbound_status
     *
     * @return self
     */
    public function setOutboundStatus($outbound_status)
    {
        if (is_null($outbound_status)) {
            throw new \InvalidArgumentException('non-nullable outbound_status cannot be null');
        }
        $this->container['outbound_status'] = $outbound_status;
     ...
     * Sets note
     *
     * @param string|null $note Note of an outbound shipping notification
     *
     * @return self
     */
    public function setNote($note)
    {
        ...
        if (!is_null($note) && (mb_strlen($note) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $note when calling OutboundShippingNotification., must be smaller than or equal to 4096.');
        }
        if (!is_null($note) && (mb_strlen($note) < 0)) {
            throw new \InvalidArgumentException('invalid length for $note when calling OutboundShippingNotification., must be bigger than or equal to 0.');
        }
