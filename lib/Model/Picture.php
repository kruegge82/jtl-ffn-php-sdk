...
class Picture implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets url
     *
     * @param string $url URL of that picture
     *
     * @return self
     */
     ...
     * Sets public_url
     *
     * @param string $public_url URL of that picture
     *
     * @return self
     */
    ...
    public function setHash($hash)
    {
        ...
        if (!is_null($hash) && (mb_strlen($hash) > 255)) {
            throw new \InvalidArgumentException('invalid length for $hash when calling Picture., must be smaller than or equal to 255.');
        }
        if (!is_null($hash) && (mb_strlen($hash) < 0)) {
            throw new \InvalidArgumentException('invalid length for $hash when calling Picture., must be bigger than or equal to 0.');
        }
    ...
    public function setMimeType($mime_type)
    {
        ...
        if ((mb_strlen($mime_type) > 255)) {
            throw new \InvalidArgumentException('invalid length for $mime_type when calling Picture., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($mime_type) < 0)) {
            throw new \InvalidArgumentException('invalid length for $mime_type when calling Picture., must be bigger than or equal to 0.');
        }
