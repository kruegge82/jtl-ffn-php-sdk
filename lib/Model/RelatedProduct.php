...
/**
 * RelatedProduct Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\jtlffn
 * @author   OpenAPI Generator team
 ...
 */
class RelatedProduct implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RelatedProduct';
    ...
    protected static $openAPITypes = [
        ...
        'kind_of_relation' => '\kruegge82\jtlffn\Model\KindOfRelationType'
    ];
    ...
    protected static $attributeMap = [
        'jfsku' => 'jfsku',
        'condition' => 'condition',
        'kind_of_relation' => 'kindOfRelation'
    ];
    ...
    protected static $setters = [
        ...
        'kind_of_relation' => 'setKindOfRelation'
    ];
    ...
    protected static $getters = [
        ...
        'kind_of_relation' => 'getKindOfRelation'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('kind_of_relation', $data ?? [], null);
    }
    ...
    */
    ...
    public function setJfsku($jfsku)
    {
        ...
        if (!is_null($jfsku) && (mb_strlen($jfsku) > 11)) {
            throw new \InvalidArgumentException('invalid length for $jfsku when calling RelatedProduct., must be smaller than or equal to 11.');
        }
        if (!is_null($jfsku) && (mb_strlen($jfsku) < 11)) {
            throw new \InvalidArgumentException('invalid length for $jfsku when calling RelatedProduct., must be bigger than or equal to 11.');
        }
    ...
    /**
     * Gets kind_of_relation
     *
     * @return \kruegge82\jtlffn\Model\KindOfRelationType|null
     */
    public function getKindOfRelation()
    {
        return $this->container['kind_of_relation'];
    }

    /**
     * Sets kind_of_relation
     *
     * @param \kruegge82\jtlffn\Model\KindOfRelationType|null $kind_of_relation kind_of_relation
     *
     * @return self
     */
    public function setKindOfRelation($kind_of_relation)
    {
        if (is_null($kind_of_relation)) {
            throw new \InvalidArgumentException('non-nullable kind_of_relation cannot be null');
        }
        $this->container['kind_of_relation'] = $kind_of_relation;
