<?php
/**
 * FfnServerApiV1FulfillerStocksModelsChangedStockChangeId
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * FfnServerApiV1FulfillerStocksModelsChangedStockChangeId Class Doc Comment
 *
 * @category Class
 ...
 */
class FfnServerApiV1FulfillerStocksModelsChangedStockChangeId implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Ffn.Server.Api.v1.Fulfiller.Stocks.Models.ChangedStockChangeId';
    ...
    protected static $openAPITypes = [
        ...
        'stock_version' => '\kruegge82\jtlffn\Model\FfnServerApiV1FulfillerSharedModelsChangedInt'
    ];
    ...
    */
     ...
     * Gets stock_version
     *
     * @return \kruegge82\jtlffn\Model\FfnServerApiV1FulfillerSharedModelsChangedInt|null
     */
     ...
     * Sets stock_version
     *
     * @param \kruegge82\jtlffn\Model\FfnServerApiV1FulfillerSharedModelsChangedInt|null $stock_version stock_version
     *
     * @return self
     */
    public function setStockVersion($stock_version)
    {
        if (is_null($stock_version)) {
            array_push($this->openAPINullablesSetToNull, 'stock_version');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('stock_version', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
