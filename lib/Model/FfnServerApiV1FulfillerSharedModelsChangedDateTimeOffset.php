<?php
/**
 * FfnServerApiV1FulfillerSharedModelsChangedDateTimeOffset
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * FfnServerApiV1FulfillerSharedModelsChangedDateTimeOffset Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\jtlffn
 * @author   OpenAPI Generator team
 ...
 */
class FfnServerApiV1FulfillerSharedModelsChangedDateTimeOffset implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Ffn.Server.Api.v1.Fulfiller.Shared.Models.ChangedDateTimeOffset';
    ...
    */
     ...
     * Sets previous_value
     *
     * @param \DateTime|null $previous_value previous_value
     *
     * @return self
     */
