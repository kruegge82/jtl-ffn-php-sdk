<?php
/**
 * FfnServerApiV1FulfillerReturnsModelsChangedLockStatus
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * FfnServerApiV1FulfillerReturnsModelsChangedLockStatus Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\jtlffn
 * @author   OpenAPI Generator team
 ...
 */
class FfnServerApiV1FulfillerReturnsModelsChangedLockStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Ffn.Server.Api.v1.Fulfiller.Returns.Models.ChangedLockStatus';
    ...
    protected static $openAPITypes = [
        'locked_by_user_id' => '\kruegge82\jtlffn\Model\FfnServerApiV1FulfillerSharedModelsChangedString',
        'locked_at' => '\kruegge82\jtlffn\Model\FfnServerApiV1FulfillerSharedModelsChangedDateTimeOffset',
        'locked_until' => '\kruegge82\jtlffn\Model\FfnServerApiV1FulfillerSharedModelsChangedDateTimeOffset'
    ];
    ...
    protected static $setters = [
        'locked_by_user_id' => 'setLockedByUserId',
    ...
    protected static $getters = [
        'locked_by_user_id' => 'getLockedByUserId',
    ...
    {
        $this->setIfExists('locked_by_user_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets locked_by_user_id
     *
     * @return \kruegge82\jtlffn\Model\FfnServerApiV1FulfillerSharedModelsChangedString|null
     */
    public function getLockedByUserId()
    {
        return $this->container['locked_by_user_id'];
    }

    /**
     * Sets locked_by_user_id
     *
     * @param \kruegge82\jtlffn\Model\FfnServerApiV1FulfillerSharedModelsChangedString|null $locked_by_user_id locked_by_user_id
     *
     * @return self
     */
    public function setLockedByUserId($locked_by_user_id)
    {
        if (is_null($locked_by_user_id)) {
            array_push($this->openAPINullablesSetToNull, 'locked_by_user_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('locked_by_user_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['locked_by_user_id'] = $locked_by_user_id;
     ...
     * Gets locked_at
     *
     * @return \kruegge82\jtlffn\Model\FfnServerApiV1FulfillerSharedModelsChangedDateTimeOffset|null
     */
     ...
     * Sets locked_at
     *
     * @param \kruegge82\jtlffn\Model\FfnServerApiV1FulfillerSharedModelsChangedDateTimeOffset|null $locked_at locked_at
     *
     * @return self
     */
     ...
     * Sets locked_until
     *
     * @param \kruegge82\jtlffn\Model\FfnServerApiV1FulfillerSharedModelsChangedDateTimeOffset|null $locked_until locked_until
     *
     * @return self
     */
    public function setLockedUntil($locked_until)
    {
        if (is_null($locked_until)) {
            array_push($this->openAPINullablesSetToNull, 'locked_until');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('locked_until', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
