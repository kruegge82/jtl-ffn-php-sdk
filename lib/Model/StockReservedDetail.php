...
/**
 * StockReservedDetail Class Doc Comment
 *
 * @category Class
 ...
 */
class StockReservedDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StockReservedDetail';
    ...
    */
    ...
    public function setOutboundId($outbound_id)
    {
        ...
        if ((mb_strlen($outbound_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $outbound_id when calling StockReservedDetail., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($outbound_id) < 7)) {
            throw new \InvalidArgumentException('invalid length for $outbound_id when calling StockReservedDetail., must be bigger than or equal to 7.');
        }
    ...
    public function setOutboundItemId($outbound_item_id)
    {
        ...
        if ((mb_strlen($outbound_item_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $outbound_item_id when calling StockReservedDetail., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($outbound_item_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $outbound_item_id when calling StockReservedDetail., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param float $quantity_reserved Reserved quantity caused by that outbound item
     *
     * @return self
     */
