...
class Merchant implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['user_id']) > 4)) {
            $invalidProperties[] = "invalid value for 'user_id', the character length must be smaller than or equal to 4.";
        }
    ...
    public function setUserId($user_id)
    {
        ...
        if ((mb_strlen($user_id) > 4)) {
            throw new \InvalidArgumentException('invalid length for $user_id when calling Merchant., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($user_id) < 4)) {
            throw new \InvalidArgumentException('invalid length for $user_id when calling Merchant., must be bigger than or equal to 4.');
        }
