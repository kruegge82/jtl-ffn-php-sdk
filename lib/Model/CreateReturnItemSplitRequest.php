...
/**
 * CreateReturnItemSplitRequest Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\jtlffn
 * @author   OpenAPI Generator team
 ...
 */
class CreateReturnItemSplitRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateReturnItemSplitRequest';
    ...
    */
     ...
     * Sets quantity
     *
     * @param float $quantity Quantity of that return item.
     *
     * @return self
     */
