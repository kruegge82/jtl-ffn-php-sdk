    ...
    */
    ...
    public function setZip($zip)
    {
        ...
        if (!is_null($zip) && (mb_strlen($zip) > 255)) {
            throw new \InvalidArgumentException('invalid length for $zip when calling CreateAddressRequest., must be smaller than or equal to 255.');
        }
        if (!is_null($zip) && (mb_strlen($zip) < 1)) {
            throw new \InvalidArgumentException('invalid length for $zip when calling CreateAddressRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setCountry($country)
    {
        ...
        if ((mb_strlen($country) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling CreateAddressRequest., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($country) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling CreateAddressRequest., must be bigger than or equal to 2.');
        }
