...
/**
 * ChangedOutboundStatus Class Doc Comment
 *
 * @category Class
 ...
 */
class ChangedOutboundStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChangedOutboundStatus';
    ...
    protected static $setters = [
        ...
        'object_version' => 'setObjectVersion'
    ];
    ...
    protected static $getters = [
        ...
        'object_version' => 'getObjectVersion'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('object_version', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['error_code']) && (mb_strlen($this->container['error_code']) > 255)) {
            $invalidProperties[] = "invalid value for 'error_code', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['error_code']) && (mb_strlen($this->container['error_code']) < 0)) {
            $invalidProperties[] = "invalid value for 'error_code', the character length must be bigger than or equal to 0.";
        }
    ...
    public function setOutboundId($outbound_id)
    {
        ...
        if ((mb_strlen($outbound_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $outbound_id when calling ChangedOutboundStatus., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($outbound_id) < 7)) {
            throw new \InvalidArgumentException('invalid length for $outbound_id when calling ChangedOutboundStatus., must be bigger than or equal to 7.');
        }
    ...
    public function setErrorCode($error_code)
    {
        ...
        if (!is_null($error_code) && (mb_strlen($error_code) > 255)) {
            throw new \InvalidArgumentException('invalid length for $error_code when calling ChangedOutboundStatus., must be smaller than or equal to 255.');
        }
        if (!is_null($error_code) && (mb_strlen($error_code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $error_code when calling ChangedOutboundStatus., must be bigger than or equal to 0.');
        }
    ...
    {
        return $this->container['object_version'];
    }

    /**
     * Sets object_version
     *
     * @param \DateTime|null $object_version object_version
     *
     * @return self
     */
    public function setObjectVersion($object_version)
    {
        if (is_null($object_version)) {
            array_push($this->openAPINullablesSetToNull, 'object_version');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('object_version', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $this->container['object_version'] = $object_version;
