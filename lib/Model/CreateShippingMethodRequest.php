...
/**
 * CreateShippingMethodRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateShippingMethodRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateShippingMethodRequest';
    ...
    */
    ...
    public function setNote($note)
    {
        ...
        if (!is_null($note) && (mb_strlen($note) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $note when calling CreateShippingMethodRequest., must be smaller than or equal to 4096.');
        }
        if (!is_null($note) && (mb_strlen($note) < 0)) {
            throw new \InvalidArgumentException('invalid length for $note when calling CreateShippingMethodRequest., must be bigger than or equal to 0.');
        }
