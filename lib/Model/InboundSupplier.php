...
/**
 * InboundSupplier Class Doc Comment
 *
 * @category Class
 ...
 */
class InboundSupplier implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InboundSupplier';
    ...
    protected static $openAPITypes = [
        'merchant_supplier_name' => 'string',
        'merchant_supplier_number' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'merchant_supplier_name' => null,
        'merchant_supplier_number' => null
    ];
    ...
    protected static array $openAPINullables = [
        'merchant_supplier_name' => true,
        'merchant_supplier_number' => false
    ];
    ...
    protected static $attributeMap = [
        'merchant_supplier_name' => 'merchantSupplierName',
        'merchant_supplier_number' => 'merchantSupplierNumber'
    ];
    ...
    protected static $setters = [
        'merchant_supplier_name' => 'setMerchantSupplierName',
        'merchant_supplier_number' => 'setMerchantSupplierNumber'
    ];
    ...
    protected static $getters = [
        'merchant_supplier_name' => 'getMerchantSupplierName',
        'merchant_supplier_number' => 'getMerchantSupplierNumber'
    ];
    ...
    {
        $this->setIfExists('merchant_supplier_name', $data ?? [], null);
        $this->setIfExists('merchant_supplier_number', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['merchant_supplier_name']) && (mb_strlen($this->container['merchant_supplier_name']) > 255)) {
            $invalidProperties[] = "invalid value for 'merchant_supplier_name', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['merchant_supplier_name']) && (mb_strlen($this->container['merchant_supplier_name']) < 0)) {
            $invalidProperties[] = "invalid value for 'merchant_supplier_name', the character length must be bigger than or equal to 0.";
        }

        if ($this->container['merchant_supplier_number'] === null) {
            $invalidProperties[] = "'merchant_supplier_number' can't be null";
        }
        if ((mb_strlen($this->container['merchant_supplier_number']) > 255)) {
            $invalidProperties[] = "invalid value for 'merchant_supplier_number', the character length must be smaller than or equal to 255.";
        }

        if ((mb_strlen($this->container['merchant_supplier_number']) < 0)) {
            $invalidProperties[] = "invalid value for 'merchant_supplier_number', the character length must be bigger than or equal to 0.";
        }

        if (!preg_match("/^.*$/", $this->container['merchant_supplier_number'])) {
            $invalidProperties[] = "invalid value for 'merchant_supplier_number', must be conform to the pattern /^.*$/.";
        }
    ...
    /**
     * Gets merchant_supplier_name
     *
     * @return string|null
     */
    public function getMerchantSupplierName()
    {
        return $this->container['merchant_supplier_name'];
    }

    /**
     * Sets merchant_supplier_name
     *
     * @param string|null $merchant_supplier_name merchant supplier name
     *
     * @return self
     */
    public function setMerchantSupplierName($merchant_supplier_name)
    {
        if (is_null($merchant_supplier_name)) {
            array_push($this->openAPINullablesSetToNull, 'merchant_supplier_name');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('merchant_supplier_name', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($merchant_supplier_name) && (mb_strlen($merchant_supplier_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $merchant_supplier_name when calling InboundSupplier., must be smaller than or equal to 255.');
        }
        if (!is_null($merchant_supplier_name) && (mb_strlen($merchant_supplier_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $merchant_supplier_name when calling InboundSupplier., must be bigger than or equal to 0.');
        }

        $this->container['merchant_supplier_name'] = $merchant_supplier_name;

        return $this;
    }

    /**
     * Gets merchant_supplier_number
     *
     * @return string
     */
    public function getMerchantSupplierNumber()
    {
        return $this->container['merchant_supplier_number'];
    }

    /**
     * Sets merchant_supplier_number
     *
     * @param string $merchant_supplier_number merchant supplier number
     *
     * @return self
     */
    public function setMerchantSupplierNumber($merchant_supplier_number)
    {
        if (is_null($merchant_supplier_number)) {
            throw new \InvalidArgumentException('non-nullable merchant_supplier_number cannot be null');
        }
        if ((mb_strlen($merchant_supplier_number) > 255)) {
            throw new \InvalidArgumentException('invalid length for $merchant_supplier_number when calling InboundSupplier., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($merchant_supplier_number) < 0)) {
            throw new \InvalidArgumentException('invalid length for $merchant_supplier_number when calling InboundSupplier., must be bigger than or equal to 0.');
        }
        if ((!preg_match("/^.*$/", ObjectSerializer::toString($merchant_supplier_number)))) {
            throw new \InvalidArgumentException("invalid value for \$merchant_supplier_number when calling InboundSupplier., must conform to the pattern /^.*$/.");
        }

        $this->container['merchant_supplier_number'] = $merchant_supplier_number;
