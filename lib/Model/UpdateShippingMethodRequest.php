...
/**
 * UpdateShippingMethodRequest Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\jtlffn
 * @author   OpenAPI Generator team
 ...
 */
class UpdateShippingMethodRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateShippingMethodRequest';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Name of the shipping method
     *
     * @return self
     */
    ...
    public function setNote($note)
    {
        ...
        if (!is_null($note) && (mb_strlen($note) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $note when calling UpdateShippingMethodRequest., must be smaller than or equal to 4096.');
        }
        if (!is_null($note) && (mb_strlen($note) < 0)) {
            throw new \InvalidArgumentException('invalid length for $note when calling UpdateShippingMethodRequest., must be bigger than or equal to 0.');
        }
     ...
     * Sets cutoff_time
     *
     * @param string|null $cutoff_time Cut off time of the shipping method. The cut off time is the lastest time an outbound can arrive at Fulfillment Network so that the outbound will be shipped and handed over to the carrier
     *
     * @return self
     */
