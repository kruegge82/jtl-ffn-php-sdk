 ...
 */
class InboundItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InboundItem';
    ...
    protected static $setters = [
        'inbound_item_id' => 'setInboundItemId',
        'jfsku' => 'setJfsku',
        'quantity' => 'setQuantity',
        'quantity_open' => 'setQuantityOpen',
        'supplier_sku' => 'setSupplierSku',
        'supplier_product_name' => 'setSupplierProductName',
        'note' => 'setNote'
    ];
    ...
    protected static $getters = [
        'inbound_item_id' => 'getInboundItemId',
        'jfsku' => 'getJfsku',
        'quantity' => 'getQuantity',
        'quantity_open' => 'getQuantityOpen',
        'supplier_sku' => 'getSupplierSku',
        'supplier_product_name' => 'getSupplierProductName',
        'note' => 'getNote'
    ];
    ...
    {
        $this->setIfExists('inbound_item_id', $data ?? [], null);
        $this->setIfExists('jfsku', $data ?? [], null);
        $this->setIfExists('quantity', $data ?? [], null);
        $this->setIfExists('quantity_open', $data ?? [], null);
        $this->setIfExists('supplier_sku', $data ?? [], null);
        $this->setIfExists('supplier_product_name', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['inbound_item_id'] === null) {
            $invalidProperties[] = "'inbound_item_id' can't be null";
        }
        if ((mb_strlen($this->container['inbound_item_id']) > 255)) {
            $invalidProperties[] = "invalid value for 'inbound_item_id', the character length must be smaller than or equal to 255.";
        }

        if ((mb_strlen($this->container['inbound_item_id']) < 0)) {
            $invalidProperties[] = "invalid value for 'inbound_item_id', the character length must be bigger than or equal to 0.";
        }
        ...
        if (!is_null($this->container['supplier_sku']) && (mb_strlen($this->container['supplier_sku']) > 255)) {
            $invalidProperties[] = "invalid value for 'supplier_sku', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['supplier_sku']) && (mb_strlen($this->container['supplier_sku']) < 0)) {
            $invalidProperties[] = "invalid value for 'supplier_sku', the character length must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['supplier_product_name']) && (mb_strlen($this->container['supplier_product_name']) > 255)) {
            $invalidProperties[] = "invalid value for 'supplier_product_name', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['supplier_product_name']) && (mb_strlen($this->container['supplier_product_name']) < 0)) {
            $invalidProperties[] = "invalid value for 'supplier_product_name', the character length must be bigger than or equal to 0.";
        }
    ...
    /**
     * Gets inbound_item_id
     *
     * @return string
     */
    public function getInboundItemId()
    {
        return $this->container['inbound_item_id'];
    }

    /**
     * Sets inbound_item_id
     *
     * @param string $inbound_item_id Inbound item identifier
     *
     * @return self
     */
    public function setInboundItemId($inbound_item_id)
    {
        if (is_null($inbound_item_id)) {
            throw new \InvalidArgumentException('non-nullable inbound_item_id cannot be null');
        }
        if ((mb_strlen($inbound_item_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $inbound_item_id when calling InboundItem., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($inbound_item_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $inbound_item_id when calling InboundItem., must be bigger than or equal to 0.');
        }

        $this->container['inbound_item_id'] = $inbound_item_id;
    ...
    public function setJfsku($jfsku)
    {
        ...
        if ((mb_strlen($jfsku) > 11)) {
            throw new \InvalidArgumentException('invalid length for $jfsku when calling InboundItem., must be smaller than or equal to 11.');
        }
        if ((mb_strlen($jfsku) < 11)) {
            throw new \InvalidArgumentException('invalid length for $jfsku when calling InboundItem., must be bigger than or equal to 11.');
        }
     ...
     * Sets quantity
     *
     * @param float $quantity Quantity of the inbound item in that inbound
     *
     * @return self
     */
     ...
     * Sets quantity_open
     *
     * @param float $quantity_open Quantity of that inbound item which has not arrived at the fulfiller's warehouse yet
     *
     * @return self
     */
     ...
     * Sets supplier_sku
     *
     * @param string|null $supplier_sku The SKU (stock keeping unit) of the supplier for that inbound item
     *
     * @return self
     */
    public function setSupplierSku($supplier_sku)
    {
        if (is_null($supplier_sku)) {
            array_push($this->openAPINullablesSetToNull, 'supplier_sku');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('supplier_sku', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($supplier_sku) && (mb_strlen($supplier_sku) > 255)) {
            throw new \InvalidArgumentException('invalid length for $supplier_sku when calling InboundItem., must be smaller than or equal to 255.');
        }
        if (!is_null($supplier_sku) && (mb_strlen($supplier_sku) < 0)) {
            throw new \InvalidArgumentException('invalid length for $supplier_sku when calling InboundItem., must be bigger than or equal to 0.');
        }
    ...
    /**
     * Gets supplier_product_name
     *
     * @return string|null
     */
    public function getSupplierProductName()
    {
        return $this->container['supplier_product_name'];
    }

    /**
     * Sets supplier_product_name
     *
     * @param string|null $supplier_product_name The product name of the supplier for that inbound item
     *
     * @return self
     */
    public function setSupplierProductName($supplier_product_name)
    {
        if (is_null($supplier_product_name)) {
            array_push($this->openAPINullablesSetToNull, 'supplier_product_name');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('supplier_product_name', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($supplier_product_name) && (mb_strlen($supplier_product_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $supplier_product_name when calling InboundItem., must be smaller than or equal to 255.');
        }
        if (!is_null($supplier_product_name) && (mb_strlen($supplier_product_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $supplier_product_name when calling InboundItem., must be bigger than or equal to 0.');
        }

        $this->container['supplier_product_name'] = $supplier_product_name;
    ...
    public function setNote($note)
    {
        ...
        if (!is_null($note) && (mb_strlen($note) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $note when calling InboundItem., must be smaller than or equal to 4096.');
        }
        if (!is_null($note) && (mb_strlen($note) < 0)) {
            throw new \InvalidArgumentException('invalid length for $note when calling InboundItem., must be bigger than or equal to 0.');
        }
