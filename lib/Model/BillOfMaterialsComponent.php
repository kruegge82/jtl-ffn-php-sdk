...
/**
 * BillOfMaterialsComponent Class Doc Comment
 *
 * @category Class
 ...
 */
class BillOfMaterialsComponent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BillOfMaterialsComponent';
    ...
    */
    ...
    public function setJfsku($jfsku)
    {
        ...
        if ((mb_strlen($jfsku) > 11)) {
            throw new \InvalidArgumentException('invalid length for $jfsku when calling BillOfMaterialsComponent., must be smaller than or equal to 11.');
        }
        if ((mb_strlen($jfsku) < 11)) {
            throw new \InvalidArgumentException('invalid length for $jfsku when calling BillOfMaterialsComponent., must be bigger than or equal to 11.');
        }
     ...
     * Sets quantity
     *
     * @param float $quantity Quantity of the set item within this set
     *
     * @return self
     */
