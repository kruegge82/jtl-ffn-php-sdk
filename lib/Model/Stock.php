...
class Stock implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'warehouses' => '\kruegge82\jtlffn\Model\StockInWarehouse[]',
        'merchant_sku' => 'string',
    ...
    */
    ...
    public function setJfsku($jfsku)
    {
        ...
        if ((mb_strlen($jfsku) > 11)) {
            throw new \InvalidArgumentException('invalid length for $jfsku when calling Stock., must be smaller than or equal to 11.');
        }
        if ((mb_strlen($jfsku) < 11)) {
            throw new \InvalidArgumentException('invalid length for $jfsku when calling Stock., must be bigger than or equal to 11.');
        }
     ...
     * Gets warehouses
     *
     * @return \kruegge82\jtlffn\Model\StockInWarehouse[]
     */
     ...
     * Sets warehouses
     *
     * @param \kruegge82\jtlffn\Model\StockInWarehouse[] $warehouses Stock information distributed over all warehouses this product is located
     *
     * @return self
     */
    ...
    public function setMerchantSku($merchant_sku)
    {
        ...
        if ((mb_strlen($merchant_sku) > 255)) {
            throw new \InvalidArgumentException('invalid length for $merchant_sku when calling Stock., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($merchant_sku) < 0)) {
            throw new \InvalidArgumentException('invalid length for $merchant_sku when calling Stock., must be bigger than or equal to 0.');
        }
