...
/**
 * Specifications Class Doc Comment
 *
 * @category Class
 ...
 */
class Specifications implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Specifications';
    ...
    protected static $openAPITypes = [
        ...
        'is_bill_of_materials' => 'bool',
        'bill_of_materials_components' => '\kruegge82\jtlffn\Model\BillOfMaterialsComponent[]',
        'is_packaging' => 'bool'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'is_bill_of_materials' => null,
        'bill_of_materials_components' => null,
        'is_packaging' => null
    ];
    ...
    protected static array $openAPINullables = [
        'un_number' => true,
        'hazard_identifier' => true,
        'taric' => true,
        'fnsku' => true,
        'is_batch' => false,
        'is_divisible' => false,
        'is_best_before' => false,
        'is_serial_number' => false,
        'is_bill_of_materials' => false,
        'bill_of_materials_components' => false,
        'is_packaging' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'is_bill_of_materials' => 'isBillOfMaterials',
        'bill_of_materials_components' => 'billOfMaterialsComponents',
    ...
    protected static $setters = [
        ...
        'hazard_identifier' => 'setHazardIdentifier',
        'taric' => 'setTaric',
        'fnsku' => 'setFnsku',
        'is_batch' => 'setIsBatch',
        'is_divisible' => 'setIsDivisible',
        'is_best_before' => 'setIsBestBefore',
        'is_serial_number' => 'setIsSerialNumber',
        'is_bill_of_materials' => 'setIsBillOfMaterials',
        'bill_of_materials_components' => 'setBillOfMaterialsComponents',
        'is_packaging' => 'setIsPackaging'
    ];
    ...
    protected static $getters = [
        ...
        'hazard_identifier' => 'getHazardIdentifier',
        'taric' => 'getTaric',
        'fnsku' => 'getFnsku',
        'is_batch' => 'getIsBatch',
        'is_divisible' => 'getIsDivisible',
        'is_best_before' => 'getIsBestBefore',
        'is_serial_number' => 'getIsSerialNumber',
        'is_bill_of_materials' => 'getIsBillOfMaterials',
        'bill_of_materials_components' => 'getBillOfMaterialsComponents',
        'is_packaging' => 'getIsPackaging'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('hazard_identifier', $data ?? [], null);
        $this->setIfExists('taric', $data ?? [], null);
        $this->setIfExists('fnsku', $data ?? [], null);
        $this->setIfExists('is_batch', $data ?? [], null);
        $this->setIfExists('is_divisible', $data ?? [], null);
        $this->setIfExists('is_best_before', $data ?? [], null);
        $this->setIfExists('is_serial_number', $data ?? [], null);
        $this->setIfExists('is_bill_of_materials', $data ?? [], null);
        $this->setIfExists('bill_of_materials_components', $data ?? [], null);
        $this->setIfExists('is_packaging', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['un_number']) && (mb_strlen($this->container['un_number']) > 255)) {
            $invalidProperties[] = "invalid value for 'un_number', the character length must be smaller than or equal to 255.";
        }
        ...
        if (!is_null($this->container['hazard_identifier']) && (mb_strlen($this->container['hazard_identifier']) > 255)) {
            $invalidProperties[] = "invalid value for 'hazard_identifier', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['hazard_identifier']) && (mb_strlen($this->container['hazard_identifier']) < 0)) {
            $invalidProperties[] = "invalid value for 'hazard_identifier', the character length must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['taric']) && (mb_strlen($this->container['taric']) > 255)) {
            $invalidProperties[] = "invalid value for 'taric', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['taric']) && (mb_strlen($this->container['taric']) < 0)) {
            $invalidProperties[] = "invalid value for 'taric', the character length must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['fnsku']) && (mb_strlen($this->container['fnsku']) > 255)) {
            $invalidProperties[] = "invalid value for 'fnsku', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['fnsku']) && (mb_strlen($this->container['fnsku']) < 0)) {
            $invalidProperties[] = "invalid value for 'fnsku', the character length must be bigger than or equal to 0.";
        }

        if ($this->container['is_batch'] === null) {
            $invalidProperties[] = "'is_batch' can't be null";
        }
        if ($this->container['is_divisible'] === null) {
            $invalidProperties[] = "'is_divisible' can't be null";
        }
        if ($this->container['is_best_before'] === null) {
            $invalidProperties[] = "'is_best_before' can't be null";
        }
        if ($this->container['is_serial_number'] === null) {
            $invalidProperties[] = "'is_serial_number' can't be null";
        }
        if ($this->container['is_bill_of_materials'] === null) {
            $invalidProperties[] = "'is_bill_of_materials' can't be null";
        }
        if ($this->container['bill_of_materials_components'] === null) {
            $invalidProperties[] = "'bill_of_materials_components' can't be null";
        }
        if ($this->container['is_packaging'] === null) {
            $invalidProperties[] = "'is_packaging' can't be null";
        }
     ...
     * Sets un_number
     *
     * @param string|null $un_number UN Number of the product
     *
     * @return self
     */
    public function setUnNumber($un_number)
    {
        ...
        if (!is_null($un_number) && (mb_strlen($un_number) > 255)) {
            throw new \InvalidArgumentException('invalid length for $un_number when calling Specifications., must be smaller than or equal to 255.');
        }
        if (!is_null($un_number) && (mb_strlen($un_number) < 0)) {
            throw new \InvalidArgumentException('invalid length for $un_number when calling Specifications., must be bigger than or equal to 0.');
        }
    ...
    /**
     * Gets hazard_identifier
     *
     * @return string|null
     */
    public function getHazardIdentifier()
    {
        return $this->container['hazard_identifier'];
    }

    /**
     * Sets hazard_identifier
     *
     * @param string|null $hazard_identifier hazard identifier of the product
     *
     * @return self
     */
    public function setHazardIdentifier($hazard_identifier)
    {
        if (is_null($hazard_identifier)) {
            array_push($this->openAPINullablesSetToNull, 'hazard_identifier');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('hazard_identifier', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($hazard_identifier) && (mb_strlen($hazard_identifier) > 255)) {
            throw new \InvalidArgumentException('invalid length for $hazard_identifier when calling Specifications., must be smaller than or equal to 255.');
        }
        if (!is_null($hazard_identifier) && (mb_strlen($hazard_identifier) < 0)) {
            throw new \InvalidArgumentException('invalid length for $hazard_identifier when calling Specifications., must be bigger than or equal to 0.');
        }

        $this->container['hazard_identifier'] = $hazard_identifier;
     ...
     * Sets taric
     *
     * @param string|null $taric Taric code of the product
     *
     * @return self
     */
    ...
    {
        if (is_null($taric)) {
            array_push($this->openAPINullablesSetToNull, 'taric');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('taric', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($taric) && (mb_strlen($taric) > 255)) {
            throw new \InvalidArgumentException('invalid length for $taric when calling Specifications., must be smaller than or equal to 255.');
        }
        if (!is_null($taric) && (mb_strlen($taric) < 0)) {
            throw new \InvalidArgumentException('invalid length for $taric when calling Specifications., must be bigger than or equal to 0.');
        }
     ...
     * Sets fnsku
     *
     * @param string|null $fnsku Amazon Fulfillment Network Stock Keeping Unit
     *
     * @return self
     */
    public function setFnsku($fnsku)
    {
        ...
        if (!is_null($fnsku) && (mb_strlen($fnsku) > 255)) {
            throw new \InvalidArgumentException('invalid length for $fnsku when calling Specifications., must be smaller than or equal to 255.');
        }
        if (!is_null($fnsku) && (mb_strlen($fnsku) < 0)) {
            throw new \InvalidArgumentException('invalid length for $fnsku when calling Specifications., must be bigger than or equal to 0.');
        }
     ...
     * Sets is_batch
     *
     * @param bool $is_batch Whether the product has a batch
     *
     * @return self
     */
    ...
    {
        return $this->container['is_divisible'];
    }

    /**
     * Sets is_divisible
     *
     * @param bool $is_divisible Whether the product is divisible
     *
     * @return self
     */
    public function setIsDivisible($is_divisible)
    {
        if (is_null($is_divisible)) {
            throw new \InvalidArgumentException('non-nullable is_divisible cannot be null');
        }


        $this->container['is_divisible'] = $is_divisible;
     ...
     * Sets is_best_before
     *
     * @param bool $is_best_before Whether the product has a best before date
     *
     * @return self
     */
    public function setIsBestBefore($is_best_before)
    {
        if (is_null($is_best_before)) {
            throw new \InvalidArgumentException('non-nullable is_best_before cannot be null');
        }
     ...
     *
     * @param bool $is_serial_number Whether the product has a serial number
     *
     * @return self
     */
    ...
    /**
     * Gets is_bill_of_materials
     *
     * @return bool
     */
    public function getIsBillOfMaterials()
    {
        return $this->container['is_bill_of_materials'];
    }

    /**
     * Sets is_bill_of_materials
     *
     * @param bool $is_bill_of_materials Whether the product is a bill of materials
     *
     * @return self
     */
    public function setIsBillOfMaterials($is_bill_of_materials)
    {
        if (is_null($is_bill_of_materials)) {
            throw new \InvalidArgumentException('non-nullable is_bill_of_materials cannot be null');
        }


        $this->container['is_bill_of_materials'] = $is_bill_of_materials;

        return $this;
    }

    /**
     * Gets bill_of_materials_components
     *
     * @return \kruegge82\jtlffn\Model\BillOfMaterialsComponent[]
     */
    public function getBillOfMaterialsComponents()
    {
        return $this->container['bill_of_materials_components'];
    }

    /**
     * Sets bill_of_materials_components
     *
     * @param \kruegge82\jtlffn\Model\BillOfMaterialsComponent[] $bill_of_materials_components Components which are included in this bill of materials product
     *
     * @return self
     */
    public function setBillOfMaterialsComponents($bill_of_materials_components)
    {
        if (is_null($bill_of_materials_components)) {
            throw new \InvalidArgumentException('non-nullable bill_of_materials_components cannot be null');
        }


        $this->container['bill_of_materials_components'] = $bill_of_materials_components;
     ...
     * @return bool
     */
    public function getIsPackaging()
    {
        return $this->container['is_packaging'];
    }

    /**
     * Sets is_packaging
     *
     * @param bool $is_packaging is_packaging
     *
     * @return self
     */
    public function setIsPackaging($is_packaging)
    {
        if (is_null($is_packaging)) {
            throw new \InvalidArgumentException('non-nullable is_packaging cannot be null');
        }


        $this->container['is_packaging'] = $is_packaging;
