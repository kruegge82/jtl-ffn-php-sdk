...
class ModificationInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'created_at' => '\DateTime',
        'updated_at' => '\DateTime',
        'state' => '\kruegge82\jtlffn\Model\ObjectState',
        'changes_in_range' => '\kruegge82\jtlffn\Model\ModificationInfo[]'
    ];
    ...
    protected static $attributeMap = [
        ...
        'state' => 'state',
        'changes_in_range' => 'changesInRange'
    ];
    ...
    protected static $setters = [
        ...
        'state' => 'setState',
        'changes_in_range' => 'setChangesInRange'
    ];
    ...
    protected static $getters = [
        ...
        'state' => 'getState',
        'changes_in_range' => 'getChangesInRange'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('changes_in_range', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets state
     *
     * @param \kruegge82\jtlffn\Model\ObjectState|null $state state
     *
     * @return self
     */
    ...
    /**
     * Gets changes_in_range
     *
     * @return \kruegge82\jtlffn\Model\ModificationInfo[]|null
     */
    public function getChangesInRange()
    {
        return $this->container['changes_in_range'];
    }

    /**
     * Sets changes_in_range
     *
     * @param \kruegge82\jtlffn\Model\ModificationInfo[]|null $changes_in_range changes_in_range
     *
     * @return self
     */
    public function setChangesInRange($changes_in_range)
    {
        if (is_null($changes_in_range)) {
            throw new \InvalidArgumentException('non-nullable changes_in_range cannot be null');
        }
        $this->container['changes_in_range'] = $changes_in_range;
