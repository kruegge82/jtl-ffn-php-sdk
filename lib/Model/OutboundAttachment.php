...
/**
 * OutboundAttachment Class Doc Comment
 *
 * @category Class
 ...
 */
class OutboundAttachment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OutboundAttachment';
    ...
    */
     ...
     * Sets url
     *
     * @param string $url URL of that attachment
     *
     * @return self
     */
