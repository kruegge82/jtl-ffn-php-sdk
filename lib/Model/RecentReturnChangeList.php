...
/**
 * RecentReturnChangeList Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\jtlffn
 * @author   OpenAPI Generator team
 ...
 */
class RecentReturnChangeList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RecentReturnChangeList';
    ...
    protected static $openAPITypes = [
        ...
        'from' => '\DateTime',
        'to' => '\DateTime',
        'data' => '\kruegge82\jtlffn\Model\FfnServerApiV1FulfillerReturnsModelsReturnChange[]',
    ...
    protected static $setters = [
        'next_chunk_url' => 'setNextChunkUrl',
        'from' => 'setFrom',
        'to' => 'setTo',
        'data' => 'setData',
        'more_data_available' => 'setMoreDataAvailable'
    ];
    ...
    protected static $getters = [
        'next_chunk_url' => 'getNextChunkUrl',
        'from' => 'getFrom',
        'to' => 'getTo',
        'data' => 'getData',
        'more_data_available' => 'getMoreDataAvailable'
    ];
    ...
    {
        $this->setIfExists('next_chunk_url', $data ?? [], null);
        $this->setIfExists('from', $data ?? [], null);
        $this->setIfExists('to', $data ?? [], null);
        $this->setIfExists('data', $data ?? [], null);
        $this->setIfExists('more_data_available', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['more_data_available'] === null) {
            $invalidProperties[] = "'more_data_available' can't be null";
        }
     ...
     * @return string|null
     */
    public function getNextChunkUrl()
    {
        return $this->container['next_chunk_url'];
    }

    /**
     * Sets next_chunk_url
     *
     * @param string|null $next_chunk_url next_chunk_url
     *
     * @return self
     */
    public function setNextChunkUrl($next_chunk_url)
    {
        if (is_null($next_chunk_url)) {
            throw new \InvalidArgumentException('non-nullable next_chunk_url cannot be null');
        }


        $this->container['next_chunk_url'] = $next_chunk_url;
     ...
     * Gets data
     *
     * @return \kruegge82\jtlffn\Model\FfnServerApiV1FulfillerReturnsModelsReturnChange[]
     */
     ...
     * Sets data
     *
     * @param \kruegge82\jtlffn\Model\FfnServerApiV1FulfillerReturnsModelsReturnChange[] $data data
     *
     * @return self
     */
    ...
    /**
     * Gets more_data_available
     *
     * @return bool
     */
    public function getMoreDataAvailable()
    {
        return $this->container['more_data_available'];
    }

    /**
     * Sets more_data_available
     *
     * @param bool $more_data_available more_data_available
     *
     * @return self
     */
    public function setMoreDataAvailable($more_data_available)
    {
        if (is_null($more_data_available)) {
            throw new \InvalidArgumentException('non-nullable more_data_available cannot be null');
        }
        $this->container['more_data_available'] = $more_data_available;
