 ...
 */
class Outbound implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Outbound';
    ...
    protected static $openAPITypes = [
        ...
        'status' => '\kruegge82\jtlffn\Model\OutboundStatusType',
        'priority' => 'int',
        'merchant_outbound_number' => 'string',
        'warehouse_id' => 'string',
        'currency' => 'string',
        'internal_note' => 'string',
        'external_note' => 'string',
        'premium_type' => '\kruegge82\jtlffn\Model\PremiumType',
        'sales_channel' => 'string',
        'attributes' => '\kruegge82\jtlffn\Model\Attribute[]',
        'desired_delivery_date' => '\DateTime',
        'shipping_method_id' => 'string',
        'shipping_type' => '\kruegge82\jtlffn\Model\ShippingType',
        'shipping_address' => '\kruegge82\jtlffn\Model\Address',
        'sender_address' => '\kruegge82\jtlffn\Model\Address',
        'cancel_reason_code' => 'string',
        'cancel_reason' => 'string',
        'shipping_fee' => 'float',
        'order_value' => 'float',
        'items' => '\kruegge82\jtlffn\Model\OutboundItem[]',
        'attachments' => '\kruegge82\jtlffn\Model\OutboundAttachment[]',
        'modification_info' => '\kruegge82\jtlffn\Model\ModificationInfo',
        'status_timestamp' => '\kruegge82\jtlffn\Model\StatusTimestamp'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'sales_channel' => null,
        'attributes' => null,
        'desired_delivery_date' => 'date-time',
    ...
    protected static array $openAPINullables = [
        ...
        'status' => false,
        'priority' => false,
        'merchant_outbound_number' => false,
        'warehouse_id' => false,
        'currency' => false,
        'internal_note' => true,
        'external_note' => true,
        ...
        'sales_channel' => true,
        'attributes' => false,
        'desired_delivery_date' => true,
        'shipping_method_id' => true,
        'shipping_type' => false,
        'shipping_address' => true,
        'sender_address' => true,
        'cancel_reason_code' => true,
        'cancel_reason' => true,
        'shipping_fee' => true,
        'order_value' => true,
        'items' => false,
        'attachments' => false,
        'modification_info' => true,
    ...
    protected static $attributeMap = [
        ...
        'status' => 'status',
        'priority' => 'priority',
        'merchant_outbound_number' => 'merchantOutboundNumber',
    ...
    protected static $setters = [
        'outbound_id' => 'setOutboundId',
        'merchant_id' => 'setMerchantId',
        'external_number' => 'setExternalNumber',
        'status' => 'setStatus',
        'priority' => 'setPriority',
        'merchant_outbound_number' => 'setMerchantOutboundNumber',
        'warehouse_id' => 'setWarehouseId',
        'currency' => 'setCurrency',
        'internal_note' => 'setInternalNote',
        'external_note' => 'setExternalNote',
        'premium_type' => 'setPremiumType',
        'sales_channel' => 'setSalesChannel',
        'attributes' => 'setAttributes',
        'desired_delivery_date' => 'setDesiredDeliveryDate',
        ...
        'modification_info' => 'setModificationInfo',
    ...
    protected static $getters = [
        'outbound_id' => 'getOutboundId',
        'merchant_id' => 'getMerchantId',
        'external_number' => 'getExternalNumber',
        'status' => 'getStatus',
        'priority' => 'getPriority',
        'merchant_outbound_number' => 'getMerchantOutboundNumber',
        'warehouse_id' => 'getWarehouseId',
        'currency' => 'getCurrency',
        'internal_note' => 'getInternalNote',
        'external_note' => 'getExternalNote',
        'premium_type' => 'getPremiumType',
        'sales_channel' => 'getSalesChannel',
        'attributes' => 'getAttributes',
        'desired_delivery_date' => 'getDesiredDeliveryDate',
        ...
        'modification_info' => 'getModificationInfo',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('cancel_reason_code', $data ?? [], null);
        ...
        $this->setIfExists('modification_info', $data ?? [], null);
        $this->setIfExists('status_timestamp', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['outbound_id'] === null) {
            $invalidProperties[] = "'outbound_id' can't be null";
        }
        if ((mb_strlen($this->container['outbound_id']) > 255)) {
            $invalidProperties[] = "invalid value for 'outbound_id', the character length must be smaller than or equal to 255.";
        }

        if ((mb_strlen($this->container['outbound_id']) < 7)) {
            $invalidProperties[] = "invalid value for 'outbound_id', the character length must be bigger than or equal to 7.";
        }

        if ($this->container['merchant_id'] === null) {
            $invalidProperties[] = "'merchant_id' can't be null";
        }
        if ((mb_strlen($this->container['merchant_id']) > 4)) {
            $invalidProperties[] = "invalid value for 'merchant_id', the character length must be smaller than or equal to 4.";
        }

        if ((mb_strlen($this->container['merchant_id']) < 4)) {
            $invalidProperties[] = "invalid value for 'merchant_id', the character length must be bigger than or equal to 4.";
        }

        if (!is_null($this->container['external_number']) && (mb_strlen($this->container['external_number']) > 255)) {
            $invalidProperties[] = "invalid value for 'external_number', the character length must be smaller than or equal to 255.";
        }
        ...
        if (($this->container['priority'] > 5)) {
            $invalidProperties[] = "invalid value for 'priority', must be smaller than or equal to 5.";
        }

        if (($this->container['priority'] < -5)) {
            $invalidProperties[] = "invalid value for 'priority', must be bigger than or equal to -5.";
        }

        if ($this->container['merchant_outbound_number'] === null) {
            $invalidProperties[] = "'merchant_outbound_number' can't be null";
        }
        if ((mb_strlen($this->container['merchant_outbound_number']) > 255)) {
            $invalidProperties[] = "invalid value for 'merchant_outbound_number', the character length must be smaller than or equal to 255.";
        }

        if ((mb_strlen($this->container['merchant_outbound_number']) < 1)) {
            $invalidProperties[] = "invalid value for 'merchant_outbound_number', the character length must be bigger than or equal to 1.";
        }

        if (!preg_match("/^.*$/", $this->container['merchant_outbound_number'])) {
            $invalidProperties[] = "invalid value for 'merchant_outbound_number', must be conform to the pattern /^.*$/.";
        }

        if ($this->container['warehouse_id'] === null) {
            $invalidProperties[] = "'warehouse_id' can't be null";
        }
        if ((mb_strlen($this->container['warehouse_id']) > 255)) {
            $invalidProperties[] = "invalid value for 'warehouse_id', the character length must be smaller than or equal to 255.";
        }

        if ((mb_strlen($this->container['warehouse_id']) < 14)) {
            $invalidProperties[] = "invalid value for 'warehouse_id', the character length must be bigger than or equal to 14.";
        }
        ...
        if (!is_null($this->container['internal_note']) && (mb_strlen($this->container['internal_note']) > 4096)) {
            $invalidProperties[] = "invalid value for 'internal_note', the character length must be smaller than or equal to 4096.";
        }

        if (!is_null($this->container['internal_note']) && (mb_strlen($this->container['internal_note']) < 0)) {
            $invalidProperties[] = "invalid value for 'internal_note', the character length must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['external_note']) && (mb_strlen($this->container['external_note']) > 4096)) {
            $invalidProperties[] = "invalid value for 'external_note', the character length must be smaller than or equal to 4096.";
        }

        if (!is_null($this->container['external_note']) && (mb_strlen($this->container['external_note']) < 0)) {
            $invalidProperties[] = "invalid value for 'external_note', the character length must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['sales_channel']) && (mb_strlen($this->container['sales_channel']) > 255)) {
            $invalidProperties[] = "invalid value for 'sales_channel', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['sales_channel']) && (mb_strlen($this->container['sales_channel']) < 0)) {
            $invalidProperties[] = "invalid value for 'sales_channel', the character length must be bigger than or equal to 0.";
        }

        if ($this->container['attributes'] === null) {
            $invalidProperties[] = "'attributes' can't be null";
        }
        if (!is_null($this->container['shipping_method_id']) && (mb_strlen($this->container['shipping_method_id']) > 255)) {
            $invalidProperties[] = "invalid value for 'shipping_method_id', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['shipping_method_id']) && (mb_strlen($this->container['shipping_method_id']) < 4)) {
            $invalidProperties[] = "invalid value for 'shipping_method_id', the character length must be bigger than or equal to 4.";
        }

        if ($this->container['shipping_address'] === null) {
            $invalidProperties[] = "'shipping_address' can't be null";
        }
        if (!is_null($this->container['cancel_reason_code']) && (mb_strlen($this->container['cancel_reason_code']) > 255)) {
            $invalidProperties[] = "invalid value for 'cancel_reason_code', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['cancel_reason_code']) && (mb_strlen($this->container['cancel_reason_code']) < 0)) {
            $invalidProperties[] = "invalid value for 'cancel_reason_code', the character length must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['cancel_reason']) && (mb_strlen($this->container['cancel_reason']) > 255)) {
            $invalidProperties[] = "invalid value for 'cancel_reason', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['cancel_reason']) && (mb_strlen($this->container['cancel_reason']) < 0)) {
            $invalidProperties[] = "invalid value for 'cancel_reason', the character length must be bigger than or equal to 0.";
        }
        ...
        if ($this->container['modification_info'] === null) {
            $invalidProperties[] = "'modification_info' can't be null";
        }
    ...
    {
        return $this->container['outbound_id'];
    }

    /**
     * Sets outbound_id
     *
     * @param string $outbound_id Outbound identifier
     *
     * @return self
     */
    public function setOutboundId($outbound_id)
    {
        if (is_null($outbound_id)) {
            throw new \InvalidArgumentException('non-nullable outbound_id cannot be null');
        }
        if ((mb_strlen($outbound_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $outbound_id when calling Outbound., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($outbound_id) < 7)) {
            throw new \InvalidArgumentException('invalid length for $outbound_id when calling Outbound., must be bigger than or equal to 7.');
        }

        $this->container['outbound_id'] = $outbound_id;
    ...
    public function setMerchantId($merchant_id)
    {
        ...
        if ((mb_strlen($merchant_id) > 4)) {
            throw new \InvalidArgumentException('invalid length for $merchant_id when calling Outbound., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($merchant_id) < 4)) {
            throw new \InvalidArgumentException('invalid length for $merchant_id when calling Outbound., must be bigger than or equal to 4.');
        }
     ...
     *
     * @param string|null $external_number External outbound number
     *
     * @return self
     */
    public function setExternalNumber($external_number)
    {
        ...
        if (!is_null($external_number) && (mb_strlen($external_number) > 255)) {
            throw new \InvalidArgumentException('invalid length for $external_number when calling Outbound., must be smaller than or equal to 255.');
        }
        if (!is_null($external_number) && (mb_strlen($external_number) < 0)) {
            throw new \InvalidArgumentException('invalid length for $external_number when calling Outbound., must be bigger than or equal to 0.');
        }
     ...
     * Gets status
     *
     * @return \kruegge82\jtlffn\Model\OutboundStatusType
     */
     ...
     * Sets status
     *
     * @param \kruegge82\jtlffn\Model\OutboundStatusType $status status
     *
     * @return self
     */
     ...
     * Sets priority
     *
     * @param int $priority Priority of the outbound
     *
     * @return self
     */
    public function setPriority($priority)
    {
        ...
        if (($priority > 5)) {
            throw new \InvalidArgumentException('invalid value for $priority when calling Outbound., must be smaller than or equal to 5.');
        }
        if (($priority < -5)) {
            throw new \InvalidArgumentException('invalid value for $priority when calling Outbound., must be bigger than or equal to -5.');
        }
    ...
    /**
     * Gets merchant_outbound_number
     *
     * @return string
     */
    public function getMerchantOutboundNumber()
    {
        return $this->container['merchant_outbound_number'];
    }

    /**
     * Sets merchant_outbound_number
     *
     * @param string $merchant_outbound_number Merchant order number
     *
     * @return self
     */
    public function setMerchantOutboundNumber($merchant_outbound_number)
    {
        if (is_null($merchant_outbound_number)) {
            throw new \InvalidArgumentException('non-nullable merchant_outbound_number cannot be null');
        }
        if ((mb_strlen($merchant_outbound_number) > 255)) {
            throw new \InvalidArgumentException('invalid length for $merchant_outbound_number when calling Outbound., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($merchant_outbound_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $merchant_outbound_number when calling Outbound., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^.*$/", ObjectSerializer::toString($merchant_outbound_number)))) {
            throw new \InvalidArgumentException("invalid value for \$merchant_outbound_number when calling Outbound., must conform to the pattern /^.*$/.");
        }

        $this->container['merchant_outbound_number'] = $merchant_outbound_number;
    ...
    public function setWarehouseId($warehouse_id)
    {
        ...
        if ((mb_strlen($warehouse_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $warehouse_id when calling Outbound., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($warehouse_id) < 14)) {
            throw new \InvalidArgumentException('invalid length for $warehouse_id when calling Outbound., must be bigger than or equal to 14.');
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling Outbound., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling Outbound., must be bigger than or equal to 3.');
        }
     ...
     * Sets internal_note
     *
     * @param string|null $internal_note Internal note of the outbound. This note is for the fulfiller only
     *
     * @return self
     */
    public function setInternalNote($internal_note)
    {
        ...
        if (!is_null($internal_note) && (mb_strlen($internal_note) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $internal_note when calling Outbound., must be smaller than or equal to 4096.');
        }
        if (!is_null($internal_note) && (mb_strlen($internal_note) < 0)) {
            throw new \InvalidArgumentException('invalid length for $internal_note when calling Outbound., must be bigger than or equal to 0.');
        }
    ...
    {
        return $this->container['external_note'];
    }

    /**
     * Sets external_note
     *
     * @param string|null $external_note External note of the outbound. This note can be shown to the customer who will receive the shipment
     *
     * @return self
     */
    public function setExternalNote($external_note)
    {
        if (is_null($external_note)) {
            array_push($this->openAPINullablesSetToNull, 'external_note');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('external_note', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($external_note) && (mb_strlen($external_note) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $external_note when calling Outbound., must be smaller than or equal to 4096.');
        }
        if (!is_null($external_note) && (mb_strlen($external_note) < 0)) {
            throw new \InvalidArgumentException('invalid length for $external_note when calling Outbound., must be bigger than or equal to 0.');
        }

        $this->container['external_note'] = $external_note;
     ...
     * Gets premium_type
     *
     * @return \kruegge82\jtlffn\Model\PremiumType|null
     */
     ...
     * Sets premium_type
     *
     * @param \kruegge82\jtlffn\Model\PremiumType|null $premium_type premium_type
     *
     * @return self
     */
     ...
     * Sets sales_channel
     *
     * @param string|null $sales_channel Sales channel
     *
     * @return self
     */
    public function setSalesChannel($sales_channel)
    {
        ...
        if (!is_null($sales_channel) && (mb_strlen($sales_channel) > 255)) {
            throw new \InvalidArgumentException('invalid length for $sales_channel when calling Outbound., must be smaller than or equal to 255.');
        }
        if (!is_null($sales_channel) && (mb_strlen($sales_channel) < 0)) {
            throw new \InvalidArgumentException('invalid length for $sales_channel when calling Outbound., must be bigger than or equal to 0.');
        }
     ...
     * Gets attributes
     *
     * @return \kruegge82\jtlffn\Model\Attribute[]
     */
     ...
     * Sets attributes
     *
     * @param \kruegge82\jtlffn\Model\Attribute[] $attributes Attributes of the outbound. Attributes are flexible custom fields
     *
     * @return self
     */
    ...
    /**
     * Gets desired_delivery_date
     *
     * @return \DateTime|null
     */
    public function getDesiredDeliveryDate()
    {
        return $this->container['desired_delivery_date'];
    }

    /**
     * Sets desired_delivery_date
     *
     * @param \DateTime|null $desired_delivery_date Desired delivery date
     *
     * @return self
     */
    public function setDesiredDeliveryDate($desired_delivery_date)
    {
        if (is_null($desired_delivery_date)) {
            array_push($this->openAPINullablesSetToNull, 'desired_delivery_date');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('desired_delivery_date', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $this->container['desired_delivery_date'] = $desired_delivery_date;
     ...
     *
     * @param string|null $shipping_method_id Shipping method identifier. You can either specify a shiiping method id or a shipping type in an outbound
     *
     * @return self
     */
    public function setShippingMethodId($shipping_method_id)
    {
        ...
        if (!is_null($shipping_method_id) && (mb_strlen($shipping_method_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $shipping_method_id when calling Outbound., must be smaller than or equal to 255.');
        }
        if (!is_null($shipping_method_id) && (mb_strlen($shipping_method_id) < 4)) {
            throw new \InvalidArgumentException('invalid length for $shipping_method_id when calling Outbound., must be bigger than or equal to 4.');
        }
     ...
     * Gets shipping_type
     *
     * @return \kruegge82\jtlffn\Model\ShippingType|null
     */
     ...
     * Sets shipping_type
     *
     * @param \kruegge82\jtlffn\Model\ShippingType|null $shipping_type shipping_type
     *
     * @return self
     */
     ...
     *
     * @return \kruegge82\jtlffn\Model\Address
     */
     ...
     *
     * @param \kruegge82\jtlffn\Model\Address $shipping_address shipping_address
     *
     * @return self
     */
     ...
     * Gets sender_address
     *
     * @return \kruegge82\jtlffn\Model\Address|null
     */
     ...
     * Sets sender_address
     *
     * @param \kruegge82\jtlffn\Model\Address|null $sender_address sender_address
     *
     * @return self
     */
     ...
     *
     * @param string|null $cancel_reason_code cancel_reason_code
     *
     * @return self
     */
    public function setCancelReasonCode($cancel_reason_code)
    {
        if (is_null($cancel_reason_code)) {
            array_push($this->openAPINullablesSetToNull, 'cancel_reason_code');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('cancel_reason_code', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($cancel_reason_code) && (mb_strlen($cancel_reason_code) > 255)) {
            throw new \InvalidArgumentException('invalid length for $cancel_reason_code when calling Outbound., must be smaller than or equal to 255.');
        }
        if (!is_null($cancel_reason_code) && (mb_strlen($cancel_reason_code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $cancel_reason_code when calling Outbound., must be bigger than or equal to 0.');
        }
     ...
     * Sets cancel_reason
     *
     * @param string|null $cancel_reason An cancellation reason in case this outbound is cancelled
     *
     * @return self
     */
    public function setCancelReason($cancel_reason)
    {
        ...
        if (!is_null($cancel_reason) && (mb_strlen($cancel_reason) > 255)) {
            throw new \InvalidArgumentException('invalid length for $cancel_reason when calling Outbound., must be smaller than or equal to 255.');
        }
        if (!is_null($cancel_reason) && (mb_strlen($cancel_reason) < 0)) {
            throw new \InvalidArgumentException('invalid length for $cancel_reason when calling Outbound., must be bigger than or equal to 0.');
        }
     ...
     * Sets shipping_fee
     *
     * @param float|null $shipping_fee Shipping fee of the outbound
     *
     * @return self
     */
     ...
     * Sets order_value
     *
     * @param float|null $order_value Order value of the outbound
     *
     * @return self
     */
    public function setOrderValue($order_value)
    {
        if (is_null($order_value)) {
            array_push($this->openAPINullablesSetToNull, 'order_value');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('order_value', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets items
     *
     * @return \kruegge82\jtlffn\Model\OutboundItem[]
     */
     ...
     * Sets items
     *
     * @param \kruegge82\jtlffn\Model\OutboundItem[] $items Items included in the outbound
     *
     * @return self
     */
     ...
     * Gets attachments
     *
     * @return \kruegge82\jtlffn\Model\OutboundAttachment[]
     */
     ...
     * Sets attachments
     *
     * @param \kruegge82\jtlffn\Model\OutboundAttachment[] $attachments Attachments for the outbounds. For example an invoice in PDF format
     *
     * @return self
     */
    ...
    /**
     * Gets modification_info
     *
     * @return \kruegge82\jtlffn\Model\ModificationInfo
     */
    public function getModificationInfo()
    {
        return $this->container['modification_info'];
    }

    /**
     * Sets modification_info
     *
     * @param \kruegge82\jtlffn\Model\ModificationInfo $modification_info modification_info
     *
     * @return self
     */
    public function setModificationInfo($modification_info)
    {
        if (is_null($modification_info)) {
            array_push($this->openAPINullablesSetToNull, 'modification_info');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('modification_info', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['modification_info'] = $modification_info;
     ...
     *
     * @return \kruegge82\jtlffn\Model\StatusTimestamp|null
     */
     ...
     *
     * @param \kruegge82\jtlffn\Model\StatusTimestamp|null $status_timestamp status_timestamp
     *
     * @return self
     */
    public function setStatusTimestamp($status_timestamp)
    {
        if (is_null($status_timestamp)) {
            array_push($this->openAPINullablesSetToNull, 'status_timestamp');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('status_timestamp', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
