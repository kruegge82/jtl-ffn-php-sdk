...
/**
 * InboundShippingNotificationItem Class Doc Comment
 *
 * @category Class
 ...
 */
class InboundShippingNotificationItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InboundShippingNotificationItem';
    ...
    protected static $openAPITypes = [
        'inbound_shipping_notification_item_id' => 'string',
        'jfsku' => 'string',
        'quantity' => 'float',
        'note' => 'string',
        'package_id' => 'int',
    ...
    protected static $openAPIFormats = [
        'inbound_shipping_notification_item_id' => null,
        'jfsku' => null,
        'quantity' => 'decimal',
        'note' => null,
        'package_id' => 'int32',
    ...
    protected static array $openAPINullables = [
        'inbound_shipping_notification_item_id' => false,
        'jfsku' => false,
        'quantity' => false,
        'note' => true,
        'package_id' => true,
    ...
    protected static $attributeMap = [
        'inbound_shipping_notification_item_id' => 'inboundShippingNotificationItemId',
        'jfsku' => 'jfsku',
        'quantity' => 'quantity',
        'note' => 'note',
    ...
    protected static $setters = [
        'inbound_shipping_notification_item_id' => 'setInboundShippingNotificationItemId',
        'jfsku' => 'setJfsku',
    ...
    protected static $getters = [
        'inbound_shipping_notification_item_id' => 'getInboundShippingNotificationItemId',
        'jfsku' => 'getJfsku',
    ...
    {
        $this->setIfExists('inbound_shipping_notification_item_id', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['inbound_shipping_notification_item_id'] === null) {
            $invalidProperties[] = "'inbound_shipping_notification_item_id' can't be null";
        }
        if ((mb_strlen($this->container['inbound_shipping_notification_item_id']) > 255)) {
            $invalidProperties[] = "invalid value for 'inbound_shipping_notification_item_id', the character length must be smaller than or equal to 255.";
        }

        if ((mb_strlen($this->container['inbound_shipping_notification_item_id']) < 0)) {
            $invalidProperties[] = "invalid value for 'inbound_shipping_notification_item_id', the character length must be bigger than or equal to 0.";
        }
    ...
    /**
     * Gets inbound_shipping_notification_item_id
     *
     * @return string
     */
    public function getInboundShippingNotificationItemId()
    {
        return $this->container['inbound_shipping_notification_item_id'];
    }

    /**
     * Sets inbound_shipping_notification_item_id
     *
     * @param string $inbound_shipping_notification_item_id Inbound item identifier
     *
     * @return self
     */
    public function setInboundShippingNotificationItemId($inbound_shipping_notification_item_id)
    {
        if (is_null($inbound_shipping_notification_item_id)) {
            throw new \InvalidArgumentException('non-nullable inbound_shipping_notification_item_id cannot be null');
        }
        if ((mb_strlen($inbound_shipping_notification_item_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $inbound_shipping_notification_item_id when calling InboundShippingNotificationItem., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($inbound_shipping_notification_item_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $inbound_shipping_notification_item_id when calling InboundShippingNotificationItem., must be bigger than or equal to 0.');
        }

        $this->container['inbound_shipping_notification_item_id'] = $inbound_shipping_notification_item_id;
    ...
    public function setJfsku($jfsku)
    {
        ...
        if ((mb_strlen($jfsku) > 11)) {
            throw new \InvalidArgumentException('invalid length for $jfsku when calling InboundShippingNotificationItem., must be smaller than or equal to 11.');
        }
        if ((mb_strlen($jfsku) < 11)) {
            throw new \InvalidArgumentException('invalid length for $jfsku when calling InboundShippingNotificationItem., must be bigger than or equal to 11.');
        }
     ...
     * Sets quantity
     *
     * @param float $quantity Quantity of that inbound item
     *
     * @return self
     */
    ...
    public function setNote($note)
    {
        ...
        if (!is_null($note) && (mb_strlen($note) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $note when calling InboundShippingNotificationItem., must be smaller than or equal to 4096.');
        }
        if (!is_null($note) && (mb_strlen($note) < 0)) {
            throw new \InvalidArgumentException('invalid length for $note when calling InboundShippingNotificationItem., must be bigger than or equal to 0.');
        }
     ...
     * Sets package_id
     *
     * @param int|null $package_id Specifies the package that contains the item. The id is the position of the package within the corresponding array
     *
     * @return self
     */
     ...
     * Sets batch
     *
     * @param string|null $batch Batch of the item within the inbound shipping notification
     *
     * @return self
     */
    public function setBatch($batch)
    {
        ...
        if (!is_null($batch) && (mb_strlen($batch) > 255)) {
            throw new \InvalidArgumentException('invalid length for $batch when calling InboundShippingNotificationItem., must be smaller than or equal to 255.');
        }
        if (!is_null($batch) && (mb_strlen($batch) < 0)) {
            throw new \InvalidArgumentException('invalid length for $batch when calling InboundShippingNotificationItem., must be bigger than or equal to 0.');
        }
     ...
     * Sets serialnumbers
     *
     * @param string[] $serialnumbers Serial numbers of the item within the inbound shipping notification
     *
     * @return self
     */
