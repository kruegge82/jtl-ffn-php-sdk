<?php
/**
 * FfnServerApiV1FulfillerSharedModelsChangedString
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * FfnServerApiV1FulfillerSharedModelsChangedString Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\jtlffn
 * @author   OpenAPI Generator team
 ...
 */
class FfnServerApiV1FulfillerSharedModelsChangedString implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Ffn.Server.Api.v1.Fulfiller.Shared.Models.ChangedString';
    ...
    */
     ...
     * Sets previous_value
     *
     * @param string|null $previous_value previous_value
     *
     * @return self
     */
