...
class Authorization implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'merchant_id' => 'string',
        'warehouses' => '\kruegge82\jtlffn\Model\WarehouseAuthorization[]',
    ...
    */
    ...
    public function setMerchantId($merchant_id)
    {
        ...
        if ((mb_strlen($merchant_id) > 4)) {
            throw new \InvalidArgumentException('invalid length for $merchant_id when calling Authorization., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($merchant_id) < 4)) {
            throw new \InvalidArgumentException('invalid length for $merchant_id when calling Authorization., must be bigger than or equal to 4.');
        }
     ...
     * Gets warehouses
     *
     * @return \kruegge82\jtlffn\Model\WarehouseAuthorization[]
     */
     ...
     * Sets warehouses
     *
     * @param \kruegge82\jtlffn\Model\WarehouseAuthorization[] $warehouses Warehouse identifier
     *
     * @return self
     */
