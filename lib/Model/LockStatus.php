 ...
 */
class LockStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LockStatus';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['locked_by_user_id']) && (mb_strlen($this->container['locked_by_user_id']) > 255)) {
            $invalidProperties[] = "invalid value for 'locked_by_user_id', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['locked_by_user_id']) && (mb_strlen($this->container['locked_by_user_id']) < 0)) {
            $invalidProperties[] = "invalid value for 'locked_by_user_id', the character length must be bigger than or equal to 0.";
        }
     ...
     *
     * @param string|null $locked_by_user_id locked_by_user_id
     *
     * @return self
     */
    public function setLockedByUserId($locked_by_user_id)
    {
        ...
        if (!is_null($locked_by_user_id) && (mb_strlen($locked_by_user_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $locked_by_user_id when calling LockStatus., must be smaller than or equal to 255.');
        }
        if (!is_null($locked_by_user_id) && (mb_strlen($locked_by_user_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $locked_by_user_id when calling LockStatus., must be bigger than or equal to 0.');
        }
     ...
     * Sets locked_at
     *
     * @param \DateTime|null $locked_at Created at datetime
     *
     * @return self
     */
     ...
     * Sets locked_until
     *
     * @param \DateTime|null $locked_until Created at datetime
     *
     * @return self
     */
