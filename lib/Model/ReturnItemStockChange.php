...
/**
 * ReturnItemStockChange Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\jtlffn
 * @author   OpenAPI Generator team
 ...
 */
class ReturnItemStockChange implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReturnItemStockChange';
    ...
    */
     ...
     * Sets merchant_sku
     *
     * @param string $merchant_sku The SKU (stock keeping unit) of the merchant for that outbound item
     *
     * @return self
     */
    public function setMerchantSku($merchant_sku)
    {
        ...
        if ((mb_strlen($merchant_sku) > 255)) {
            throw new \InvalidArgumentException('invalid length for $merchant_sku when calling ReturnItemStockChange., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($merchant_sku) < 0)) {
            throw new \InvalidArgumentException('invalid length for $merchant_sku when calling ReturnItemStockChange., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param float $quantity_blocked quantity_blocked
     *
     * @return self
     */
