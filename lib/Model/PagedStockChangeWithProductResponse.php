...
/**
 * PagedStockChangeWithProductResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class PagedStockChangeWithProductResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PagedStockChangeWithProductResponse';
    ...
    protected static $openAPITypes = [
        'items' => '\kruegge82\jtlffn\Model\StockChangeWithProduct[]',
        '_page' => '\kruegge82\jtlffn\Model\Page',
        '_links' => '\kruegge82\jtlffn\Model\PageLinks',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('_page', $data ?? [], null);
        $this->setIfExists('_links', $data ?? [], null);
        $this->setIfExists('next_page_link', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['_page'] === null) {
            $invalidProperties[] = "'_page' can't be null";
        }
     ...
     * Gets items
     *
     * @return \kruegge82\jtlffn\Model\StockChangeWithProduct[]|null
     */
     ...
     * Sets items
     *
     * @param \kruegge82\jtlffn\Model\StockChangeWithProduct[]|null $items items
     *
     * @return self
     */
     ...
     * Gets _page
     *
     * @return \kruegge82\jtlffn\Model\Page
     */
     ...
     * Sets _page
     *
     * @param \kruegge82\jtlffn\Model\Page $_page _page
     *
     * @return self
     */
    ...
    {
        if (is_null($_page)) {
            throw new \InvalidArgumentException('non-nullable _page cannot be null');
        }
     ...
     * Gets _links
     *
     * @return \kruegge82\jtlffn\Model\PageLinks|null
     */
     ...
     * Sets _links
     *
     * @param \kruegge82\jtlffn\Model\PageLinks|null $_links _links
     *
     * @return self
     */
     ...
     * Sets next_page_link
     *
     * @param string|null $next_page_link next_page_link
     *
     * @return self
     */
    public function setNextPageLink($next_page_link)
    {
        if (is_null($next_page_link)) {
            throw new \InvalidArgumentException('non-nullable next_page_link cannot be null');
        }
