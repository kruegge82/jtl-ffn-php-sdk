...
class ReturnItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'quantity' => 'float',
        'reason' => '\kruegge82\jtlffn\Model\ReturnReasonType',
        'reason_note' => 'string',
        'condition_note' => 'string',
        'state' => '\kruegge82\jtlffn\Model\ReturnType',
        'condition' => '\kruegge82\jtlffn\Model\ConditionType',
        'stock_changes' => '\kruegge82\jtlffn\Model\ReturnItemStockChange[]'
    ];
    ...
    protected static $setters = [
        ...
        'outbound_item_id' => 'setOutboundItemId',
    ...
    protected static $getters = [
        ...
        'outbound_item_id' => 'getOutboundItemId',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('outbound_item_id', $data ?? [], null);
        $this->setIfExists('quantity', $data ?? [], null);
        $this->setIfExists('reason', $data ?? [], null);
        $this->setIfExists('reason_note', $data ?? [], null);
        $this->setIfExists('condition_note', $data ?? [], null);
        $this->setIfExists('state', $data ?? [], null);
        $this->setIfExists('condition', $data ?? [], null);
        $this->setIfExists('stock_changes', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['return_item_id']) > 255)) {
            $invalidProperties[] = "invalid value for 'return_item_id', the character length must be smaller than or equal to 255.";
        }

        if ((mb_strlen($this->container['return_item_id']) < 0)) {
            $invalidProperties[] = "invalid value for 'return_item_id', the character length must be bigger than or equal to 0.";
        }
        ...
        if (!is_null($this->container['outbound_id']) && (mb_strlen($this->container['outbound_id']) > 255)) {
            $invalidProperties[] = "invalid value for 'outbound_id', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['outbound_id']) && (mb_strlen($this->container['outbound_id']) < 0)) {
            $invalidProperties[] = "invalid value for 'outbound_id', the character length must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['outbound_item_id']) && (mb_strlen($this->container['outbound_item_id']) > 255)) {
            $invalidProperties[] = "invalid value for 'outbound_item_id', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['outbound_item_id']) && (mb_strlen($this->container['outbound_item_id']) < 0)) {
            $invalidProperties[] = "invalid value for 'outbound_item_id', the character length must be bigger than or equal to 0.";
        }
        ...
        if (!is_null($this->container['reason_note']) && (mb_strlen($this->container['reason_note']) > 4096)) {
            $invalidProperties[] = "invalid value for 'reason_note', the character length must be smaller than or equal to 4096.";
        }

        if (!is_null($this->container['reason_note']) && (mb_strlen($this->container['reason_note']) < 0)) {
            $invalidProperties[] = "invalid value for 'reason_note', the character length must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['condition_note']) && (mb_strlen($this->container['condition_note']) > 4096)) {
            $invalidProperties[] = "invalid value for 'condition_note', the character length must be smaller than or equal to 4096.";
        }

        if (!is_null($this->container['condition_note']) && (mb_strlen($this->container['condition_note']) < 0)) {
            $invalidProperties[] = "invalid value for 'condition_note', the character length must be bigger than or equal to 0.";
        }
        ...
        if ($this->container['stock_changes'] === null) {
            $invalidProperties[] = "'stock_changes' can't be null";
        }
     ...
     * Sets return_item_id
     *
     * @param string $return_item_id The SKU (stock keeping unit) of the merchant for that outbound item
     *
     * @return self
     */
    public function setReturnItemId($return_item_id)
    {
        ...
        if ((mb_strlen($return_item_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $return_item_id when calling ReturnItem., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($return_item_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $return_item_id when calling ReturnItem., must be bigger than or equal to 0.');
        }
    ...
    public function setJfsku($jfsku)
    {
        ...
        if ((mb_strlen($jfsku) > 11)) {
            throw new \InvalidArgumentException('invalid length for $jfsku when calling ReturnItem., must be smaller than or equal to 11.');
        }
        if ((mb_strlen($jfsku) < 11)) {
            throw new \InvalidArgumentException('invalid length for $jfsku when calling ReturnItem., must be bigger than or equal to 11.');
        }
     ...
     * Sets merchant_sku
     *
     * @param string $merchant_sku The SKU (stock keeping unit) of the merchant for that return item
     *
     * @return self
     */
    public function setMerchantSku($merchant_sku)
    {
        ...
        if ((mb_strlen($merchant_sku) > 255)) {
            throw new \InvalidArgumentException('invalid length for $merchant_sku when calling ReturnItem., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($merchant_sku) < 0)) {
            throw new \InvalidArgumentException('invalid length for $merchant_sku when calling ReturnItem., must be bigger than or equal to 0.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ReturnItem., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ReturnItem., must be bigger than or equal to 0.');
        }
     ...
     * Sets outbound_id
     *
     * @param string|null $outbound_id Outbound Identifier
     *
     * @return self
     */
    public function setOutboundId($outbound_id)
    {
        if (is_null($outbound_id)) {
            array_push($this->openAPINullablesSetToNull, 'outbound_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('outbound_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($outbound_id) && (mb_strlen($outbound_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $outbound_id when calling ReturnItem., must be smaller than or equal to 255.');
        }
        if (!is_null($outbound_id) && (mb_strlen($outbound_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $outbound_id when calling ReturnItem., must be bigger than or equal to 0.');
        }
    ...
    /**
     * Gets outbound_item_id
     *
     * @return string|null
     */
    public function getOutboundItemId()
    {
        return $this->container['outbound_item_id'];
    }

    /**
     * Sets outbound_item_id
     *
     * @param string|null $outbound_item_id Outbound item identifier
     *
     * @return self
     */
    public function setOutboundItemId($outbound_item_id)
    {
        if (is_null($outbound_item_id)) {
            array_push($this->openAPINullablesSetToNull, 'outbound_item_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('outbound_item_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($outbound_item_id) && (mb_strlen($outbound_item_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $outbound_item_id when calling ReturnItem., must be smaller than or equal to 255.');
        }
        if (!is_null($outbound_item_id) && (mb_strlen($outbound_item_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $outbound_item_id when calling ReturnItem., must be bigger than or equal to 0.');
        }

        $this->container['outbound_item_id'] = $outbound_item_id;
     ...
     * Sets quantity
     *
     * @param float $quantity Quantity of that return item. This quantity of that item shall be shipped to the customer
     *
     * @return self
     */
     ...
     * Gets reason
     *
     * @return \kruegge82\jtlffn\Model\ReturnReasonType
     */
     ...
     * Sets reason
     *
     * @param \kruegge82\jtlffn\Model\ReturnReasonType $reason reason
     *
     * @return self
     */
     ...
     * Sets reason_note
     *
     * @param string|null $reason_note Internal note of the outbound. This note is for the fulfiller only
     *
     * @return self
     */
    public function setReasonNote($reason_note)
    {
        if (is_null($reason_note)) {
            array_push($this->openAPINullablesSetToNull, 'reason_note');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('reason_note', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($reason_note) && (mb_strlen($reason_note) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $reason_note when calling ReturnItem., must be smaller than or equal to 4096.');
        }
        if (!is_null($reason_note) && (mb_strlen($reason_note) < 0)) {
            throw new \InvalidArgumentException('invalid length for $reason_note when calling ReturnItem., must be bigger than or equal to 0.');
        }
     ...
     * Sets condition_note
     *
     * @param string|null $condition_note Internal note of the outbound. This note is for the fulfiller only
     *
     * @return self
     */
    public function setConditionNote($condition_note)
    {
        ...
        if (!is_null($condition_note) && (mb_strlen($condition_note) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $condition_note when calling ReturnItem., must be smaller than or equal to 4096.');
        }
        if (!is_null($condition_note) && (mb_strlen($condition_note) < 0)) {
            throw new \InvalidArgumentException('invalid length for $condition_note when calling ReturnItem., must be bigger than or equal to 0.');
        }
     ...
     * Gets condition
     *
     * @return \kruegge82\jtlffn\Model\ConditionType
     */
     ...
     * Sets condition
     *
     * @param \kruegge82\jtlffn\Model\ConditionType $condition condition
     *
     * @return self
     */
     ...
     * Gets stock_changes
     *
     * @return \kruegge82\jtlffn\Model\ReturnItemStockChange[]
     */
    public function getStockChanges()
    {
        return $this->container['stock_changes'];
    }

    /**
     * Sets stock_changes
     *
     * @param \kruegge82\jtlffn\Model\ReturnItemStockChange[] $stock_changes stock_changes
     *
     * @return self
     */
    public function setStockChanges($stock_changes)
    {
        if (is_null($stock_changes)) {
            throw new \InvalidArgumentException('non-nullable stock_changes cannot be null');
        }


        $this->container['stock_changes'] = $stock_changes;
