    ...
    */
    ...
    public function setJfsku($jfsku)
    {
        ...
        if ((mb_strlen($jfsku) > 11)) {
            throw new \InvalidArgumentException('invalid length for $jfsku when calling Product., must be smaller than or equal to 11.');
        }
        if ((mb_strlen($jfsku) < 11)) {
            throw new \InvalidArgumentException('invalid length for $jfsku when calling Product., must be bigger than or equal to 11.');
        }
    ...
    public function setMerchantId($merchant_id)
    {
        ...
        if ((mb_strlen($merchant_id) > 4)) {
            throw new \InvalidArgumentException('invalid length for $merchant_id when calling Product., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($merchant_id) < 4)) {
            throw new \InvalidArgumentException('invalid length for $merchant_id when calling Product., must be bigger than or equal to 4.');
        }
    ...
    public function setMerchantSku($merchant_sku)
    {
        ...
        if ((mb_strlen($merchant_sku) > 255)) {
            throw new \InvalidArgumentException('invalid length for $merchant_sku when calling Product., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($merchant_sku) < 0)) {
            throw new \InvalidArgumentException('invalid length for $merchant_sku when calling Product., must be bigger than or equal to 0.');
        }
    ...
    public function setProductGroup($product_group)
    {
        ...
        if (!is_null($product_group) && (mb_strlen($product_group) > 255)) {
            throw new \InvalidArgumentException('invalid length for $product_group when calling Product., must be smaller than or equal to 255.');
        }
        if (!is_null($product_group) && (mb_strlen($product_group) < 0)) {
            throw new \InvalidArgumentException('invalid length for $product_group when calling Product., must be bigger than or equal to 0.');
        }
    ...
    public function setOriginCountry($origin_country)
    {
        ...
        if (!is_null($origin_country) && (mb_strlen($origin_country) > 2)) {
            throw new \InvalidArgumentException('invalid length for $origin_country when calling Product., must be smaller than or equal to 2.');
        }
        if (!is_null($origin_country) && (mb_strlen($origin_country) < 2)) {
            throw new \InvalidArgumentException('invalid length for $origin_country when calling Product., must be bigger than or equal to 2.');
        }
    ...
    public function setManufacturer($manufacturer)
    {
        ...
        if (!is_null($manufacturer) && (mb_strlen($manufacturer) > 255)) {
            throw new \InvalidArgumentException('invalid length for $manufacturer when calling Product., must be smaller than or equal to 255.');
        }
        if (!is_null($manufacturer) && (mb_strlen($manufacturer) < 0)) {
            throw new \InvalidArgumentException('invalid length for $manufacturer when calling Product., must be bigger than or equal to 0.');
        }
    ...
    public function setNote($note)
    {
        ...
        if (!is_null($note) && (mb_strlen($note) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $note when calling Product., must be smaller than or equal to 4096.');
        }
        if (!is_null($note) && (mb_strlen($note) < 0)) {
            throw new \InvalidArgumentException('invalid length for $note when calling Product., must be bigger than or equal to 0.');
        }
     ...
     * Gets specifications
     *
     * @return \kruegge82\jtlffn\Model\Specifications|null
     */
     ...
     * Sets specifications
     *
     * @param \kruegge82\jtlffn\Model\Specifications|null $specifications specifications
     *
     * @return self
     */
