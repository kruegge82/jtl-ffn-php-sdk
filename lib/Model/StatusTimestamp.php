...
/**
 * StatusTimestamp Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\jtlffn
 * @author   OpenAPI Generator team
 ...
 */
class StatusTimestamp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StatusTimestamp';
    ...
    protected static $openAPITypes = [
        ...
        'locked' => '\DateTime',
        'pickprocess' => '\DateTime',
        'shipped' => '\DateTime',
        'partially_shipped' => '\DateTime',
        'canceled' => '\DateTime',
        'partially_canceled' => '\DateTime'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'locked' => 'date-time',
        'pickprocess' => 'date-time',
        'shipped' => 'date-time',
        'partially_shipped' => 'date-time',
        'canceled' => 'date-time',
        'partially_canceled' => 'date-time'
    ];
    ...
    protected static $setters = [
        ...
        'locked' => 'setLocked',
        'pickprocess' => 'setPickprocess',
        'shipped' => 'setShipped',
        'partially_shipped' => 'setPartiallyShipped',
        'canceled' => 'setCanceled',
        'partially_canceled' => 'setPartiallyCanceled'
    ];
    ...
    protected static $getters = [
        ...
        'locked' => 'getLocked',
        'pickprocess' => 'getPickprocess',
        'shipped' => 'getShipped',
        'partially_shipped' => 'getPartiallyShipped',
        'canceled' => 'getCanceled',
        'partially_canceled' => 'getPartiallyCanceled'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('preparation', $data ?? [], null);
        $this->setIfExists('acknowledged', $data ?? [], null);
        $this->setIfExists('locked', $data ?? [], null);
        $this->setIfExists('pickprocess', $data ?? [], null);
        $this->setIfExists('shipped', $data ?? [], null);
        $this->setIfExists('partially_shipped', $data ?? [], null);
        $this->setIfExists('canceled', $data ?? [], null);
        $this->setIfExists('partially_canceled', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets pending
     *
     * @param \DateTime|null $pending Timestamp when the outbound has reached the status 'Pending'
     *
     * @return self
     */
     ...
     * Sets preparation
     *
     * @param \DateTime|null $preparation Timestamp when the outbound has reached the status 'Preparation'
     *
     * @return self
     */
    public function setPreparation($preparation)
    {
        if (is_null($preparation)) {
            array_push($this->openAPINullablesSetToNull, 'preparation');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('preparation', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets acknowledged
     *
     * @param \DateTime|null $acknowledged Timestamp when the outbound has reached the status 'Acknowledged'
     *
     * @return self
     */
    public function setAcknowledged($acknowledged)
    {
        if (is_null($acknowledged)) {
            array_push($this->openAPINullablesSetToNull, 'acknowledged');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('acknowledged', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets locked
     *
     * @param \DateTime|null $locked Timestamp when the outbound has reached the status 'Locked'
     *
     * @return self
     */
     ...
     * @return \DateTime|null
     */
    public function getPickprocess()
    {
        return $this->container['pickprocess'];
    }

    /**
     * Sets pickprocess
     *
     * @param \DateTime|null $pickprocess Timestamp when the outbound has reached the status 'Pickprocess'
     *
     * @return self
     */
    public function setPickprocess($pickprocess)
    {
        if (is_null($pickprocess)) {
            array_push($this->openAPINullablesSetToNull, 'pickprocess');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('pickprocess', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $this->container['pickprocess'] = $pickprocess;
     ...
     * Sets shipped
     *
     * @param \DateTime|null $shipped Timestamp when the outbound has reached the status 'Shipped'
     *
     * @return self
     */
    ...
    {
        if (is_null($shipped)) {
            array_push($this->openAPINullablesSetToNull, 'shipped');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('shipped', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    /**
     * Gets partially_shipped
     *
     * @return \DateTime|null
     */
    public function getPartiallyShipped()
    {
        return $this->container['partially_shipped'];
    }

    /**
     * Sets partially_shipped
     *
     * @param \DateTime|null $partially_shipped Timestamp when the outbound has reached the status 'PartiallyShipped'
     *
     * @return self
     */
    public function setPartiallyShipped($partially_shipped)
    {
        if (is_null($partially_shipped)) {
            array_push($this->openAPINullablesSetToNull, 'partially_shipped');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('partially_shipped', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $this->container['partially_shipped'] = $partially_shipped;
     ...
     * Sets canceled
     *
     * @param \DateTime|null $canceled Timestamp when the outbound has reached the status 'Canceled'
     *
     * @return self
     */
    ...
    {
        if (is_null($canceled)) {
            array_push($this->openAPINullablesSetToNull, 'canceled');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('canceled', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    /**
     * Gets partially_canceled
     *
     * @return \DateTime|null
     */
    public function getPartiallyCanceled()
    {
        return $this->container['partially_canceled'];
    }

    /**
     * Sets partially_canceled
     *
     * @param \DateTime|null $partially_canceled Timestamp when the outbound has reached the status 'PartiallyCanceled'
     *
     * @return self
     */
    public function setPartiallyCanceled($partially_canceled)
    {
        if (is_null($partially_canceled)) {
            array_push($this->openAPINullablesSetToNull, 'partially_canceled');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('partially_canceled', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $this->container['partially_canceled'] = $partially_canceled;
