<?php
/**
 * FfnServerApiV1FulfillerReturnsModelsReturnItemStockChangeChange
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * FfnServerApiV1FulfillerReturnsModelsReturnItemStockChangeChange Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\jtlffn
 * @author   OpenAPI Generator team
 ...
 */
class FfnServerApiV1FulfillerReturnsModelsReturnItemStockChangeChange implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Ffn.Server.Api.v1.Fulfiller.Returns.Models.ReturnItemStockChangeChange';
    ...
    protected static $openAPITypes = [
        'id' => '\kruegge82\jtlffn\Model\StockChangeId',
        'updated_at' => '\DateTime',
        'modification_state' => '\kruegge82\jtlffn\Model\ObjectState',
        'modified_from' => 'string',
        'changes' => '\kruegge82\jtlffn\Model\FfnServerApiV1FulfillerReturnsModelsChangedReturnItemStockChange'
    ];
    ...
    protected static $setters = [
        ...
        'modification_state' => 'setModificationState',
        'modified_from' => 'setModifiedFrom',
        'changes' => 'setChanges'
    ];
    ...
    protected static $getters = [
        ...
        'modification_state' => 'getModificationState',
        'modified_from' => 'getModifiedFrom',
        'changes' => 'getChanges'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('modification_state', $data ?? [], null);
        $this->setIfExists('modified_from', $data ?? [], null);
    ...
    */
     ...
     * Gets id
     *
     * @return \kruegge82\jtlffn\Model\StockChangeId|null
     */
     ...
     * Sets id
     *
     * @param \kruegge82\jtlffn\Model\StockChangeId|null $id id
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param \DateTime|null $updated_at Last updated at datetime
     *
     * @return self
     */
    ...
    /**
     * Gets modification_state
     *
     * @return \kruegge82\jtlffn\Model\ObjectState|null
     */
    public function getModificationState()
    {
        return $this->container['modification_state'];
    }

    /**
     * Sets modification_state
     *
     * @param \kruegge82\jtlffn\Model\ObjectState|null $modification_state modification_state
     *
     * @return self
     */
    public function setModificationState($modification_state)
    {
        if (is_null($modification_state)) {
            throw new \InvalidArgumentException('non-nullable modification_state cannot be null');
        }
        $this->container['modification_state'] = $modification_state;
    ...
    {
        return $this->container['modified_from'];
    }

    /**
     * Sets modified_from
     *
     * @param string|null $modified_from modified_from
     *
     * @return self
     */
    public function setModifiedFrom($modified_from)
    {
        if (is_null($modified_from)) {
            throw new \InvalidArgumentException('non-nullable modified_from cannot be null');
        }
        $this->container['modified_from'] = $modified_from;
     ...
     * Gets changes
     *
     * @return \kruegge82\jtlffn\Model\FfnServerApiV1FulfillerReturnsModelsChangedReturnItemStockChange|null
     */
     ...
     * Sets changes
     *
     * @param \kruegge82\jtlffn\Model\FfnServerApiV1FulfillerReturnsModelsChangedReturnItemStockChange|null $changes changes
     *
     * @return self
     */
