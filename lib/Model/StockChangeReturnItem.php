...
/**
 * StockChangeReturnItem Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\jtlffn
 * @author   OpenAPI Generator team
 ...
 */
class StockChangeReturnItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StockChangeReturnItem';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['return_id']) && (mb_strlen($this->container['return_id']) > 255)) {
            $invalidProperties[] = "invalid value for 'return_id', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['return_id']) && (mb_strlen($this->container['return_id']) < 0)) {
            $invalidProperties[] = "invalid value for 'return_id', the character length must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['return_item_id']) && (mb_strlen($this->container['return_item_id']) > 255)) {
            $invalidProperties[] = "invalid value for 'return_item_id', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['return_item_id']) && (mb_strlen($this->container['return_item_id']) < 0)) {
    ...
    public function setReturnId($return_id)
    {
        ...
        if (!is_null($return_id) && (mb_strlen($return_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $return_id when calling StockChangeReturnItem., must be smaller than or equal to 255.');
        }
        if (!is_null($return_id) && (mb_strlen($return_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $return_id when calling StockChangeReturnItem., must be bigger than or equal to 0.');
        }
     ...
     * Sets return_item_id
     *
     * @param string|null $return_item_id return_item_id
     *
     * @return self
     */
    public function setReturnItemId($return_item_id)
    {
        ...
        if (!is_null($return_item_id) && (mb_strlen($return_item_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $return_item_id when calling StockChangeReturnItem., must be smaller than or equal to 255.');
        }
        if (!is_null($return_item_id) && (mb_strlen($return_item_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $return_item_id when calling StockChangeReturnItem., must be bigger than or equal to 0.');
        }
