...
class UpdateReturnRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'customer_address' => '\kruegge82\jtlffn\Model\UpdateAddressRequest',
    ...
    */
     ...
     * Sets warehouse_id
     *
     * @param string|null $warehouse_id Warehouse must be from the fulfiller who delivered the outbound
     *
     * @return self
     */
    ...
    public function setInternalNote($internal_note)
    {
        ...
        if ((mb_strlen($internal_note) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $internal_note when calling UpdateReturnRequest., must be smaller than or equal to 4096.');
        }
        if ((mb_strlen($internal_note) < 0)) {
            throw new \InvalidArgumentException('invalid length for $internal_note when calling UpdateReturnRequest., must be bigger than or equal to 0.');
        }
     ...
     *
     * @return \kruegge82\jtlffn\Model\UpdateAddressRequest|null
     */
     ...
     *
     * @param \kruegge82\jtlffn\Model\UpdateAddressRequest|null $customer_address customer_address
     *
     * @return self
     */
    ...
    public function setExternalNote($external_note)
    {
        if (is_null($external_note)) {
            throw new \InvalidArgumentException('non-nullable external_note cannot be null');
        }
        if ((mb_strlen($external_note) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $external_note when calling UpdateReturnRequest., must be smaller than or equal to 4096.');
        }
        if ((mb_strlen($external_note) < 0)) {
            throw new \InvalidArgumentException('invalid length for $external_note when calling UpdateReturnRequest., must be bigger than or equal to 0.');
        }
