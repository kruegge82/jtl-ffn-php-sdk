...
/**
 * WarehouseAuthorizationRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class WarehouseAuthorizationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WarehouseAuthorizationRequest';
    ...
    protected static $openAPITypes = [
        'warehouse_id' => 'string',
        'shipping_methods' => '\kruegge82\jtlffn\Model\CreateAuthorizedShippingMethodRequest[]'
    ];
    ...
    */
    ...
    public function setWarehouseId($warehouse_id)
    {
        ...
        if ((mb_strlen($warehouse_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $warehouse_id when calling WarehouseAuthorizationRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($warehouse_id) < 14)) {
            throw new \InvalidArgumentException('invalid length for $warehouse_id when calling WarehouseAuthorizationRequest., must be bigger than or equal to 14.');
        }
     ...
     *
     * @return \kruegge82\jtlffn\Model\CreateAuthorizedShippingMethodRequest[]
     */
     ...
     *
     * @param \kruegge82\jtlffn\Model\CreateAuthorizedShippingMethodRequest[] $shipping_methods List of shipping methods you want to provide in that warehouse
     *
     * @return self
     */
