...
/**
 * FfnServerApiV1FulfillerSharedModelsChangedDecimal Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\jtlffn
 * @author   OpenAPI Generator team
 ...
 */
class FfnServerApiV1FulfillerSharedModelsChangedDecimal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Ffn.Server.Api.v1.Fulfiller.Shared.Models.ChangedDecimal';
