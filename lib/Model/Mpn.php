...
class Mpn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['part_number']) > 255)) {
            $invalidProperties[] = "invalid value for 'part_number', the character length must be smaller than or equal to 255.";
        }

        if ((mb_strlen($this->container['part_number']) < 0)) {
            $invalidProperties[] = "invalid value for 'part_number', the character length must be bigger than or equal to 0.";
        }
    ...
    public function setManufacturer($manufacturer)
    {
        ...
        if ((mb_strlen($manufacturer) > 255)) {
            throw new \InvalidArgumentException('invalid length for $manufacturer when calling Mpn., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($manufacturer) < 0)) {
            throw new \InvalidArgumentException('invalid length for $manufacturer when calling Mpn., must be bigger than or equal to 0.');
        }
    ...
    public function setPartNumber($part_number)
    {
        ...
        if ((mb_strlen($part_number) > 255)) {
            throw new \InvalidArgumentException('invalid length for $part_number when calling Mpn., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($part_number) < 0)) {
            throw new \InvalidArgumentException('invalid length for $part_number when calling Mpn., must be bigger than or equal to 0.');
        }
