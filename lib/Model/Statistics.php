...
class Statistics implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'jfsku' => 'string',
        'incoming_goods' => 'float',
        'outgoing_goods' => 'float',
        'outgoing_goods_last30' => 'float',
        'outgoing_goods_last365' => 'float',
        'outgoing_goods30_to60' => 'float',
        'average_inventory' => 'float',
        'inventory_turnover' => 'float',
        'ranges_of_coverage' => 'float',
        'range' => 'int',
        'statistics_per_warehouse' => '\kruegge82\jtlffn\Model\StatisticsPerWarehouse[]'
    ];
    ...
    protected static $openAPIFormats = [
        'jfsku' => null,
        'incoming_goods' => 'decimal',
        'outgoing_goods' => 'decimal',
        'outgoing_goods_last30' => 'decimal',
        'outgoing_goods_last365' => 'decimal',
        'outgoing_goods30_to60' => 'decimal',
        'average_inventory' => 'decimal',
        'inventory_turnover' => 'decimal',
        'ranges_of_coverage' => 'decimal',
        'range' => 'int32',
        'statistics_per_warehouse' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'incoming_goods' => true,
        'outgoing_goods' => true,
        'outgoing_goods_last30' => true,
        'outgoing_goods_last365' => true,
        'outgoing_goods30_to60' => true,
        'average_inventory' => true,
        'inventory_turnover' => true,
        'ranges_of_coverage' => true,
        'range' => true,
        'statistics_per_warehouse' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'outgoing_goods_last30' => 'outgoingGoodsLast30',
        'outgoing_goods_last365' => 'outgoingGoodsLast365',
        'outgoing_goods30_to60' => 'outgoingGoods30To60',
        'average_inventory' => 'averageInventory',
        'inventory_turnover' => 'inventoryTurnover',
        'ranges_of_coverage' => 'rangesOfCoverage',
        'range' => 'range',
        'statistics_per_warehouse' => 'statisticsPerWarehouse'
    ];
    ...
    protected static $setters = [
        'jfsku' => 'setJfsku',
        'incoming_goods' => 'setIncomingGoods',
        'outgoing_goods' => 'setOutgoingGoods',
        'outgoing_goods_last30' => 'setOutgoingGoodsLast30',
        'outgoing_goods_last365' => 'setOutgoingGoodsLast365',
        'outgoing_goods30_to60' => 'setOutgoingGoods30To60',
        'average_inventory' => 'setAverageInventory',
        'inventory_turnover' => 'setInventoryTurnover',
        'ranges_of_coverage' => 'setRangesOfCoverage',
        'range' => 'setRange',
        'statistics_per_warehouse' => 'setStatisticsPerWarehouse'
    ];
    ...
    protected static $getters = [
        'jfsku' => 'getJfsku',
        'incoming_goods' => 'getIncomingGoods',
        'outgoing_goods' => 'getOutgoingGoods',
        'outgoing_goods_last30' => 'getOutgoingGoodsLast30',
        'outgoing_goods_last365' => 'getOutgoingGoodsLast365',
        'outgoing_goods30_to60' => 'getOutgoingGoods30To60',
        'average_inventory' => 'getAverageInventory',
        'inventory_turnover' => 'getInventoryTurnover',
        'ranges_of_coverage' => 'getRangesOfCoverage',
        'range' => 'getRange',
        'statistics_per_warehouse' => 'getStatisticsPerWarehouse'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('incoming_goods', $data ?? [], null);
        $this->setIfExists('outgoing_goods', $data ?? [], null);
        $this->setIfExists('outgoing_goods_last30', $data ?? [], null);
        $this->setIfExists('outgoing_goods_last365', $data ?? [], null);
        $this->setIfExists('outgoing_goods30_to60', $data ?? [], null);
        $this->setIfExists('average_inventory', $data ?? [], null);
        $this->setIfExists('inventory_turnover', $data ?? [], null);
        $this->setIfExists('ranges_of_coverage', $data ?? [], null);
        $this->setIfExists('range', $data ?? [], null);
        $this->setIfExists('statistics_per_warehouse', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['statistics_per_warehouse'] === null) {
            $invalidProperties[] = "'statistics_per_warehouse' can't be null";
        }
    ...
    public function setJfsku($jfsku)
    {
        ...
        if ((mb_strlen($jfsku) > 11)) {
            throw new \InvalidArgumentException('invalid length for $jfsku when calling Statistics., must be smaller than or equal to 11.');
        }
        if ((mb_strlen($jfsku) < 11)) {
            throw new \InvalidArgumentException('invalid length for $jfsku when calling Statistics., must be bigger than or equal to 11.');
        }
     ...
     * @return float|null
     */
    public function getIncomingGoods()
    {
        return $this->container['incoming_goods'];
    }

    /**
     * Sets incoming_goods
     *
     * @param float|null $incoming_goods incoming_goods
     *
     * @return self
     */
    public function setIncomingGoods($incoming_goods)
    {
        if (is_null($incoming_goods)) {
            array_push($this->openAPINullablesSetToNull, 'incoming_goods');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('incoming_goods', $nullablesSetToNull);
            if ($index !== FALSE) {
        ...
        $this->container['incoming_goods'] = $incoming_goods;
     ...
     * @return float|null
     */
    public function getOutgoingGoods()
    {
        return $this->container['outgoing_goods'];
    }

    /**
     * Sets outgoing_goods
     *
     * @param float|null $outgoing_goods outgoing_goods
     *
     * @return self
     */
    public function setOutgoingGoods($outgoing_goods)
    {
        if (is_null($outgoing_goods)) {
            array_push($this->openAPINullablesSetToNull, 'outgoing_goods');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('outgoing_goods', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $this->container['outgoing_goods'] = $outgoing_goods;

        return $this;
    }

    /**
     * Gets outgoing_goods_last30
     *
     * @return float|null
     */
    public function getOutgoingGoodsLast30()
    {
        return $this->container['outgoing_goods_last30'];
    }

    /**
     * Sets outgoing_goods_last30
     *
     * @param float|null $outgoing_goods_last30 outgoing_goods_last30
     *
     * @return self
     */
    public function setOutgoingGoodsLast30($outgoing_goods_last30)
    {
        if (is_null($outgoing_goods_last30)) {
            array_push($this->openAPINullablesSetToNull, 'outgoing_goods_last30');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('outgoing_goods_last30', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $this->container['outgoing_goods_last30'] = $outgoing_goods_last30;

        return $this;
    }

    /**
     * Gets outgoing_goods_last365
     *
     * @return float|null
     */
    public function getOutgoingGoodsLast365()
    {
        return $this->container['outgoing_goods_last365'];
    }

    /**
     * Sets outgoing_goods_last365
     *
     * @param float|null $outgoing_goods_last365 outgoing_goods_last365
     *
     * @return self
     */
    public function setOutgoingGoodsLast365($outgoing_goods_last365)
    {
        if (is_null($outgoing_goods_last365)) {
            array_push($this->openAPINullablesSetToNull, 'outgoing_goods_last365');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('outgoing_goods_last365', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $this->container['outgoing_goods_last365'] = $outgoing_goods_last365;

        return $this;
    }

    /**
     * Gets outgoing_goods30_to60
     *
     * @return float|null
     */
    public function getOutgoingGoods30To60()
    {
        return $this->container['outgoing_goods30_to60'];
    }

    /**
     * Sets outgoing_goods30_to60
     *
     * @param float|null $outgoing_goods30_to60 outgoing_goods30_to60
     *
     * @return self
     */
    public function setOutgoingGoods30To60($outgoing_goods30_to60)
    {
        if (is_null($outgoing_goods30_to60)) {
            array_push($this->openAPINullablesSetToNull, 'outgoing_goods30_to60');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('outgoing_goods30_to60', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $this->container['outgoing_goods30_to60'] = $outgoing_goods30_to60;

        return $this;
    }

    /**
     * Gets average_inventory
     *
     * @return float|null
     */
    public function getAverageInventory()
    {
        return $this->container['average_inventory'];
    }

    /**
     * Sets average_inventory
     *
     * @param float|null $average_inventory average_inventory
     *
     * @return self
     */
    public function setAverageInventory($average_inventory)
    {
        if (is_null($average_inventory)) {
            array_push($this->openAPINullablesSetToNull, 'average_inventory');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('average_inventory', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $this->container['average_inventory'] = $average_inventory;
     ...
     *
     * @param float|null $inventory_turnover inventory_turnover
     *
     * @return self
     */
    public function setInventoryTurnover($inventory_turnover)
    {
        if (is_null($inventory_turnover)) {
            array_push($this->openAPINullablesSetToNull, 'inventory_turnover');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('inventory_turnover', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    /**
     * Gets ranges_of_coverage
     *
     * @return float|null
     */
    public function getRangesOfCoverage()
    {
        return $this->container['ranges_of_coverage'];
    }

    /**
     * Sets ranges_of_coverage
     *
     * @param float|null $ranges_of_coverage ranges_of_coverage
     *
     * @return self
     */
    public function setRangesOfCoverage($ranges_of_coverage)
    {
        if (is_null($ranges_of_coverage)) {
            array_push($this->openAPINullablesSetToNull, 'ranges_of_coverage');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ranges_of_coverage', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $this->container['ranges_of_coverage'] = $ranges_of_coverage;
    ...
    /**
     * Gets statistics_per_warehouse
     *
     * @return \kruegge82\jtlffn\Model\StatisticsPerWarehouse[]
     */
    public function getStatisticsPerWarehouse()
    {
        return $this->container['statistics_per_warehouse'];
    }

    /**
     * Sets statistics_per_warehouse
     *
     * @param \kruegge82\jtlffn\Model\StatisticsPerWarehouse[] $statistics_per_warehouse statistics_per_warehouse
     *
     * @return self
     */
    public function setStatisticsPerWarehouse($statistics_per_warehouse)
    {
        if (is_null($statistics_per_warehouse)) {
            throw new \InvalidArgumentException('non-nullable statistics_per_warehouse cannot be null');
        }


        $this->container['statistics_per_warehouse'] = $statistics_per_warehouse;
