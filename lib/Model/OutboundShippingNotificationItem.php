...
/**
 * OutboundShippingNotificationItem Class Doc Comment
 *
 * @category Class
 ...
 */
class OutboundShippingNotificationItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OutboundShippingNotificationItem';
    ...
    protected static $openAPITypes = [
        'outbound_shipping_notification_item_id' => 'string',
        'jfsku' => 'string',
        'quantity' => 'float',
        'note' => 'string',
    ...
    protected static $openAPIFormats = [
        'outbound_shipping_notification_item_id' => null,
        'jfsku' => null,
        'quantity' => 'decimal',
        'note' => null,
        'best_before' => null,
    ...
    protected static array $openAPINullables = [
        'outbound_shipping_notification_item_id' => false,
        'jfsku' => true,
        'quantity' => false,
        'note' => true,
        'best_before' => true,
    ...
    protected static $attributeMap = [
        'outbound_shipping_notification_item_id' => 'outboundShippingNotificationItemId',
        'jfsku' => 'jfsku',
        'quantity' => 'quantity',
        'note' => 'note',
    ...
    protected static $setters = [
        'outbound_shipping_notification_item_id' => 'setOutboundShippingNotificationItemId',
        'jfsku' => 'setJfsku',
    ...
    protected static $getters = [
        'outbound_shipping_notification_item_id' => 'getOutboundShippingNotificationItemId',
        'jfsku' => 'getJfsku',
    ...
    {
        $this->setIfExists('outbound_shipping_notification_item_id', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['outbound_shipping_notification_item_id'] === null) {
            $invalidProperties[] = "'outbound_shipping_notification_item_id' can't be null";
        }
        if ((mb_strlen($this->container['outbound_shipping_notification_item_id']) > 255)) {
            $invalidProperties[] = "invalid value for 'outbound_shipping_notification_item_id', the character length must be smaller than or equal to 255.";
        }

        if ((mb_strlen($this->container['outbound_shipping_notification_item_id']) < 0)) {
            $invalidProperties[] = "invalid value for 'outbound_shipping_notification_item_id', the character length must be bigger than or equal to 0.";
        }
        ...
        if ($this->container['serialnumbers'] === null) {
            $invalidProperties[] = "'serialnumbers' can't be null";
        }
    ...
    /**
     * Gets outbound_shipping_notification_item_id
     *
     * @return string
     */
    public function getOutboundShippingNotificationItemId()
    {
        return $this->container['outbound_shipping_notification_item_id'];
    }

    /**
     * Sets outbound_shipping_notification_item_id
     *
     * @param string $outbound_shipping_notification_item_id Outbound shipping notification item identifier
     *
     * @return self
     */
    public function setOutboundShippingNotificationItemId($outbound_shipping_notification_item_id)
    {
        if (is_null($outbound_shipping_notification_item_id)) {
            throw new \InvalidArgumentException('non-nullable outbound_shipping_notification_item_id cannot be null');
        }
        if ((mb_strlen($outbound_shipping_notification_item_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $outbound_shipping_notification_item_id when calling OutboundShippingNotificationItem., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($outbound_shipping_notification_item_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $outbound_shipping_notification_item_id when calling OutboundShippingNotificationItem., must be bigger than or equal to 0.');
        }

        $this->container['outbound_shipping_notification_item_id'] = $outbound_shipping_notification_item_id;
    ...
    public function setJfsku($jfsku)
    {
        ...
        if (!is_null($jfsku) && (mb_strlen($jfsku) > 11)) {
            throw new \InvalidArgumentException('invalid length for $jfsku when calling OutboundShippingNotificationItem., must be smaller than or equal to 11.');
        }
        if (!is_null($jfsku) && (mb_strlen($jfsku) < 11)) {
            throw new \InvalidArgumentException('invalid length for $jfsku when calling OutboundShippingNotificationItem., must be bigger than or equal to 11.');
        }
     ...
     * Sets quantity
     *
     * @param float $quantity Quantity of the item which has been shipped within that outbound shipping notification
     *
     * @return self
     */
     ...
     * Sets note
     *
     * @param string|null $note Note of the outbound shipping notification
     *
     * @return self
     */
    public function setNote($note)
    {
        ...
        if (!is_null($note) && (mb_strlen($note) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $note when calling OutboundShippingNotificationItem., must be smaller than or equal to 4096.');
        }
        if (!is_null($note) && (mb_strlen($note) < 0)) {
            throw new \InvalidArgumentException('invalid length for $note when calling OutboundShippingNotificationItem., must be bigger than or equal to 0.');
        }
     ...
     * Sets batch
     *
     * @param string|null $batch Batch of the item within the outbound shipping notification
     *
     * @return self
     */
    public function setBatch($batch)
    {
        ...
        if (!is_null($batch) && (mb_strlen($batch) > 255)) {
            throw new \InvalidArgumentException('invalid length for $batch when calling OutboundShippingNotificationItem., must be smaller than or equal to 255.');
        }
        if (!is_null($batch) && (mb_strlen($batch) < 0)) {
            throw new \InvalidArgumentException('invalid length for $batch when calling OutboundShippingNotificationItem., must be bigger than or equal to 0.');
        }
     ...
     * Sets serialnumbers
     *
     * @param string[] $serialnumbers Serial numbers of the item within the outbound shipping notification
     *
     * @return self
     */
