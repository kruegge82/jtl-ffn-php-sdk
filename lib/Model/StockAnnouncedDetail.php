...
/**
 * StockAnnouncedDetail Class Doc Comment
 *
 * @category Class
 ...
 */
class StockAnnouncedDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StockAnnouncedDetail';
    ...
    */
    ...
    public function setInboundId($inbound_id)
    {
        ...
        if ((mb_strlen($inbound_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $inbound_id when calling StockAnnouncedDetail., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($inbound_id) < 7)) {
            throw new \InvalidArgumentException('invalid length for $inbound_id when calling StockAnnouncedDetail., must be bigger than or equal to 7.');
        }
    ...
    public function setInboundItemId($inbound_item_id)
    {
        ...
        if ((mb_strlen($inbound_item_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $inbound_item_id when calling StockAnnouncedDetail., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($inbound_item_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $inbound_item_id when calling StockAnnouncedDetail., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param float $quantity_announced Announced quantity caused by that inbound item
     *
     * @return self
     */
