...
/**
 * CreateStockAdjustmentRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateStockAdjustmentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateStockAdjustmentRequest';
    ...
    */
    ...
    public function setJfsku($jfsku)
    {
        ...
        if ((mb_strlen($jfsku) > 11)) {
            throw new \InvalidArgumentException('invalid length for $jfsku when calling CreateStockAdjustmentRequest., must be smaller than or equal to 11.');
        }
        if ((mb_strlen($jfsku) < 11)) {
            throw new \InvalidArgumentException('invalid length for $jfsku when calling CreateStockAdjustmentRequest., must be bigger than or equal to 11.');
        }
    ...
    public function setWarehouseId($warehouse_id)
    {
        ...
        if ((mb_strlen($warehouse_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $warehouse_id when calling CreateStockAdjustmentRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($warehouse_id) < 14)) {
            throw new \InvalidArgumentException('invalid length for $warehouse_id when calling CreateStockAdjustmentRequest., must be bigger than or equal to 14.');
        }
     ...
     * Sets note
     *
     * @param string|null $note Note of that stock adjustment
     *
     * @return self
     */
    public function setNote($note)
    {
        ...
        if (!is_null($note) && (mb_strlen($note) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $note when calling CreateStockAdjustmentRequest., must be smaller than or equal to 4096.');
        }
        if (!is_null($note) && (mb_strlen($note) < 0)) {
            throw new \InvalidArgumentException('invalid length for $note when calling CreateStockAdjustmentRequest., must be bigger than or equal to 0.');
        }
