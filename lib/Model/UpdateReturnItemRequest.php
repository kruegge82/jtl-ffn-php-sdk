...
/**
 * UpdateReturnItemRequest Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\jtlffn
 * @author   OpenAPI Generator team
 ...
 */
class UpdateReturnItemRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateReturnItemRequest';
    ...
    */
     ...
     * Sets quantity
     *
     * @param float|null $quantity Quantity of that outbound item. This quantity of that item shall be shipped to the customer
     *
     * @return self
     */
    ...
    public function setReasonNote($reason_note)
    {
        ...
        if (!is_null($reason_note) && (mb_strlen($reason_note) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $reason_note when calling UpdateReturnItemRequest., must be smaller than or equal to 4096.');
        }
        if (!is_null($reason_note) && (mb_strlen($reason_note) < 0)) {
            throw new \InvalidArgumentException('invalid length for $reason_note when calling UpdateReturnItemRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setConditionNote($condition_note)
    {
        ...
        if (!is_null($condition_note) && (mb_strlen($condition_note) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $condition_note when calling UpdateReturnItemRequest., must be smaller than or equal to 4096.');
        }
        if (!is_null($condition_note) && (mb_strlen($condition_note) < 0)) {
            throw new \InvalidArgumentException('invalid length for $condition_note when calling UpdateReturnItemRequest., must be bigger than or equal to 0.');
        }
     ...
     * Gets state
     *
     * @return \kruegge82\jtlffn\Model\ReturnType|null
     */
     ...
     * Sets state
     *
     * @param \kruegge82\jtlffn\Model\ReturnType|null $state state
     *
     * @return self
     */
