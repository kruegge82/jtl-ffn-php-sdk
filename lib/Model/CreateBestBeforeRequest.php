...
/**
 * CreateBestBeforeRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateBestBeforeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateBestBeforeRequest';
    ...
    */
     ...
     * Sets year
     *
     * @param int $year Year of best before date
     *
     * @return self
     */
     ...
     * Sets month
     *
     * @param int $month Month of best before date
     *
     * @return self
     */
     ...
     * Sets day
     *
     * @param int $day Day of best before date
     *
     * @return self
     */
