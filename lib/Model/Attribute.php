...
class Attribute implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'key' => 'string',
        'value' => 'string',
        'attribute_type' => '\kruegge82\jtlffn\Model\AttributeType'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['value']) > 4096)) {
            $invalidProperties[] = "invalid value for 'value', the character length must be smaller than or equal to 4096.";
        }
    ...
    public function setKey($key)
    {
        ...
        if ((mb_strlen($key) > 255)) {
            throw new \InvalidArgumentException('invalid length for $key when calling Attribute., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($key) < 0)) {
            throw new \InvalidArgumentException('invalid length for $key when calling Attribute., must be bigger than or equal to 0.');
        }
    ...
    public function setValue($value)
    {
        ...
        if ((mb_strlen($value) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $value when calling Attribute., must be smaller than or equal to 4096.');
        }
        if ((mb_strlen($value) < 0)) {
            throw new \InvalidArgumentException('invalid length for $value when calling Attribute., must be bigger than or equal to 0.');
        }
     ...
     * Gets attribute_type
     *
     * @return \kruegge82\jtlffn\Model\AttributeType
     */
     ...
     * Sets attribute_type
     *
     * @param \kruegge82\jtlffn\Model\AttributeType $attribute_type attribute_type
     *
     * @return self
     */
