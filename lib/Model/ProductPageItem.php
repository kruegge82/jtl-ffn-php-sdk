...
/**
 * ProductPageItem Class Doc Comment
 *
 * @category Class
 ...
 */
class ProductPageItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductPageItem';
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'merchant_sku' => 'string',
        'pictures' => '\kruegge82\jtlffn\Model\Picture[]',
        ...
        'net_weight' => 'float',
        'note' => 'string',
        'identifier' => '\kruegge82\jtlffn\Model\Identifier',
        'specifications' => '\kruegge82\jtlffn\Model\Specifications',
        'dimensions' => '\kruegge82\jtlffn\Model\Dimensions',
        'attributes' => '\kruegge82\jtlffn\Model\Attribute[]',
        'net_retail_price' => '\kruegge82\jtlffn\Model\Price',
        'bundles' => '\kruegge82\jtlffn\Model\ProductBundle[]',
        'related_products' => '\kruegge82\jtlffn\Model\RelatedProduct[]',
    ...
    protected static $openAPIFormats = [
        ...
        'pictures' => null,
        'product_group' => null,
        'origin_country' => 'ISO 3166 alpha-2',
        'manufacturer' => null,
        'weight' => 'decimal',
        'net_weight' => 'decimal',
        'note' => null,
    ...
    protected static $setters = [
        ...
        'net_retail_price' => 'setNetRetailPrice',
        'bundles' => 'setBundles',
    ...
    protected static $getters = [
        ...
        'net_retail_price' => 'getNetRetailPrice',
        'bundles' => 'getBundles',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('net_retail_price', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['jfsku']) && (mb_strlen($this->container['jfsku']) > 11)) {
        ...
        if (!is_null($this->container['merchant_id']) && (mb_strlen($this->container['merchant_id']) > 4)) {
        ...
        if (!is_null($this->container['product_group']) && (mb_strlen($this->container['product_group']) > 255)) {
            $invalidProperties[] = "invalid value for 'product_group', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['product_group']) && (mb_strlen($this->container['product_group']) < 0)) {
            $invalidProperties[] = "invalid value for 'product_group', the character length must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['origin_country']) && (mb_strlen($this->container['origin_country']) > 2)) {
        ...
        if ($this->container['bundles'] === null) {
            $invalidProperties[] = "'bundles' can't be null";
        }
        if ($this->container['related_products'] === null) {
            $invalidProperties[] = "'related_products' can't be null";
        }
     ...
     * Sets jfsku
     *
     * @param string|null $jfsku Product identifer
     *
     * @return self
     */
    ...
    {
        if (is_null($jfsku)) {
            array_push($this->openAPINullablesSetToNull, 'jfsku');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('jfsku', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($jfsku) && (mb_strlen($jfsku) > 11)) {
            throw new \InvalidArgumentException('invalid length for $jfsku when calling ProductPageItem., must be smaller than or equal to 11.');
        }
        if (!is_null($jfsku) && (mb_strlen($jfsku) < 11)) {
            throw new \InvalidArgumentException('invalid length for $jfsku when calling ProductPageItem., must be bigger than or equal to 11.');
        }
    ...
    public function setMerchantId($merchant_id)
    {
        ...
        if (!is_null($merchant_id) && (mb_strlen($merchant_id) > 4)) {
            throw new \InvalidArgumentException('invalid length for $merchant_id when calling ProductPageItem., must be smaller than or equal to 4.');
        }
        if (!is_null($merchant_id) && (mb_strlen($merchant_id) < 4)) {
            throw new \InvalidArgumentException('invalid length for $merchant_id when calling ProductPageItem., must be bigger than or equal to 4.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ProductPageItem., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ProductPageItem., must be bigger than or equal to 0.');
        }
    ...
    public function setMerchantSku($merchant_sku)
    {
        ...
        if ((mb_strlen($merchant_sku) > 255)) {
            throw new \InvalidArgumentException('invalid length for $merchant_sku when calling ProductPageItem., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($merchant_sku) < 0)) {
            throw new \InvalidArgumentException('invalid length for $merchant_sku when calling ProductPageItem., must be bigger than or equal to 0.');
        }
     ...
     * Gets pictures
     *
     * @return \kruegge82\jtlffn\Model\Picture[]
     */
     ...
     * Sets pictures
     *
     * @param \kruegge82\jtlffn\Model\Picture[] $pictures Pictures of the product
     *
     * @return self
     */
     ...
     * Sets product_group
     *
     * @param string|null $product_group Group of the product
     *
     * @return self
     */
    public function setProductGroup($product_group)
    {
        ...
        if (!is_null($product_group) && (mb_strlen($product_group) > 255)) {
            throw new \InvalidArgumentException('invalid length for $product_group when calling ProductPageItem., must be smaller than or equal to 255.');
        }
        if (!is_null($product_group) && (mb_strlen($product_group) < 0)) {
            throw new \InvalidArgumentException('invalid length for $product_group when calling ProductPageItem., must be bigger than or equal to 0.');
        }
     ...
     * Sets origin_country
     *
     * @param string|null $origin_country Country of origin
     *
     * @return self
     */
    public function setOriginCountry($origin_country)
    {
        ...
        if (!is_null($origin_country) && (mb_strlen($origin_country) > 2)) {
            throw new \InvalidArgumentException('invalid length for $origin_country when calling ProductPageItem., must be smaller than or equal to 2.');
        }
        if (!is_null($origin_country) && (mb_strlen($origin_country) < 2)) {
            throw new \InvalidArgumentException('invalid length for $origin_country when calling ProductPageItem., must be bigger than or equal to 2.');
        }
     ...
     * Sets manufacturer
     *
     * @param string|null $manufacturer Name of manufacturer
     *
     * @return self
     */
    public function setManufacturer($manufacturer)
    {
        ...
        if (!is_null($manufacturer) && (mb_strlen($manufacturer) > 255)) {
            throw new \InvalidArgumentException('invalid length for $manufacturer when calling ProductPageItem., must be smaller than or equal to 255.');
        }
        if (!is_null($manufacturer) && (mb_strlen($manufacturer) < 0)) {
            throw new \InvalidArgumentException('invalid length for $manufacturer when calling ProductPageItem., must be bigger than or equal to 0.');
        }
     ...
     * Sets net_weight
     *
     * @param float|null $net_weight Weight of the raw product in kg (does not include the weight of the products packaging or container)
     *
     * @return self
     */
    ...
    public function setNote($note)
    {
        ...
        if (!is_null($note) && (mb_strlen($note) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $note when calling ProductPageItem., must be smaller than or equal to 4096.');
        }
        if (!is_null($note) && (mb_strlen($note) < 0)) {
            throw new \InvalidArgumentException('invalid length for $note when calling ProductPageItem., must be bigger than or equal to 0.');
        }
     ...
     * Gets identifier
     *
     * @return \kruegge82\jtlffn\Model\Identifier
     */
     ...
     * Sets identifier
     *
     * @param \kruegge82\jtlffn\Model\Identifier $identifier identifier
     *
     * @return self
     */
     ...
     * Gets specifications
     *
     * @return \kruegge82\jtlffn\Model\Specifications
     */
     ...
     * Sets specifications
     *
     * @param \kruegge82\jtlffn\Model\Specifications $specifications specifications
     *
     * @return self
     */
    public function setSpecifications($specifications)
    {
        if (is_null($specifications)) {
            array_push($this->openAPINullablesSetToNull, 'specifications');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('specifications', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets dimensions
     *
     * @return \kruegge82\jtlffn\Model\Dimensions|null
     */
     ...
     * Sets dimensions
     *
     * @param \kruegge82\jtlffn\Model\Dimensions|null $dimensions dimensions
     *
     * @return self
     */
     ...
     * Sets attributes
     *
     * @param \kruegge82\jtlffn\Model\Attribute[] $attributes A product can have multiple attributes which represent custom fields
     *
     * @return self
     */
    ...
    /**
     * Gets net_retail_price
     *
     * @return \kruegge82\jtlffn\Model\Price|null
     */
    public function getNetRetailPrice()
    {
        return $this->container['net_retail_price'];
    }

    /**
     * Sets net_retail_price
     *
     * @param \kruegge82\jtlffn\Model\Price|null $net_retail_price net_retail_price
     *
     * @return self
     */
    public function setNetRetailPrice($net_retail_price)
    {
        if (is_null($net_retail_price)) {
            array_push($this->openAPINullablesSetToNull, 'net_retail_price');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('net_retail_price', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['net_retail_price'] = $net_retail_price;
     ...
     * Gets bundles
     *
     * @return \kruegge82\jtlffn\Model\ProductBundle[]
     */
     ...
     * Sets bundles
     *
     * @param \kruegge82\jtlffn\Model\ProductBundle[] $bundles Packagings of a quantity products
     *
     * @return self
     */
     ...
     *
     * @return \kruegge82\jtlffn\Model\RelatedProduct[]
     */
     ...
     *
     * @param \kruegge82\jtlffn\Model\RelatedProduct[] $related_products Packagings of a quantity products
     *
     * @return self
     */
     ...
     * Gets condition
     *
     * @return \kruegge82\jtlffn\Model\ConditionType|null
     */
     ...
     * Sets condition
     *
     * @param \kruegge82\jtlffn\Model\ConditionType|null $condition condition
     *
     * @return self
     */
