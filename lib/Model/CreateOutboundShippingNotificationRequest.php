...
/**
 * CreateOutboundShippingNotificationRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateOutboundShippingNotificationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateOutboundShippingNotificationRequest';
    ...
    protected static $openAPITypes = [
        ...
        'items' => '\kruegge82\jtlffn\Model\CreateOutboundShippingNotificationItemRequest[]',
        'packages' => '\kruegge82\jtlffn\Model\CreateOutboundShippingPackageRequest[]',
        'note' => 'string'
    ];
    ...
    protected static array $openAPINullables = [
        'outbound_shipping_notification_id' => true,
    ...
    */
     ...
     *
     * @param string|null $outbound_shipping_notification_id Outbound shipping notification identifier If not provided, one will be generated.
     *
     * @return self
     */
    public function setOutboundShippingNotificationId($outbound_shipping_notification_id)
    {
        if (is_null($outbound_shipping_notification_id)) {
            array_push($this->openAPINullablesSetToNull, 'outbound_shipping_notification_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('outbound_shipping_notification_id', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     *
     * @param string $fulfiller_shipping_notification_number Fulfiller outbound shipping notification number
     *
     * @return self
     */
     ...
     * Gets items
     *
     * @return \kruegge82\jtlffn\Model\CreateOutboundShippingNotificationItemRequest[]
     */
     ...
     * Sets items
     *
     * @param \kruegge82\jtlffn\Model\CreateOutboundShippingNotificationItemRequest[] $items Affected items by the shipping notification
     *
     * @return self
     */
     ...
     * Gets packages
     *
     * @return \kruegge82\jtlffn\Model\CreateOutboundShippingPackageRequest[]
     */
     ...
     * Sets packages
     *
     * @param \kruegge82\jtlffn\Model\CreateOutboundShippingPackageRequest[] $packages Information about packages in the shipment notification
     *
     * @return self
     */
    ...
    public function setNote($note)
    {
        ...
        if (!is_null($note) && (mb_strlen($note) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $note when calling CreateOutboundShippingNotificationRequest., must be smaller than or equal to 4096.');
        }
        if (!is_null($note) && (mb_strlen($note) < 0)) {
            throw new \InvalidArgumentException('invalid length for $note when calling CreateOutboundShippingNotificationRequest., must be bigger than or equal to 0.');
        }
