...
class Inbound implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'inbound_id' => 'string',
        'merchant_id' => 'string',
        'items' => '\kruegge82\jtlffn\Model\InboundItem[]',
        'status' => '\kruegge82\jtlffn\Model\InboundStatus',
        'merchant_inbound_number' => 'string',
        'warehouse_id' => 'string',
        'note' => 'string',
        'purchase_order_number' => 'string',
        'external_inbound_number' => 'string',
        'attributes' => '\kruegge82\jtlffn\Model\Attribute[]',
        'modification_info' => '\kruegge82\jtlffn\Model\ModificationInfo',
        'supplier' => '\kruegge82\jtlffn\Model\InboundSupplier'
    ];
    ...
    protected static $attributeMap = [
        ...
        'external_inbound_number' => 'externalInboundNumber',
    ...
    protected static $setters = [
        ...
        'external_inbound_number' => 'setExternalInboundNumber',
    ...
    protected static $getters = [
        ...
        'external_inbound_number' => 'getExternalInboundNumber',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('external_inbound_number', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['purchase_order_number']) && (mb_strlen($this->container['purchase_order_number']) > 255)) {
            $invalidProperties[] = "invalid value for 'purchase_order_number', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['purchase_order_number']) && (mb_strlen($this->container['purchase_order_number']) < 0)) {
            $invalidProperties[] = "invalid value for 'purchase_order_number', the character length must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['external_inbound_number']) && (mb_strlen($this->container['external_inbound_number']) > 255)) {
            $invalidProperties[] = "invalid value for 'external_inbound_number', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['external_inbound_number']) && (mb_strlen($this->container['external_inbound_number']) < 0)) {
            $invalidProperties[] = "invalid value for 'external_inbound_number', the character length must be bigger than or equal to 0.";
        }
    ...
    public function setInboundId($inbound_id)
    {
        ...
        if ((mb_strlen($inbound_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $inbound_id when calling Inbound., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($inbound_id) < 7)) {
            throw new \InvalidArgumentException('invalid length for $inbound_id when calling Inbound., must be bigger than or equal to 7.');
        }
    ...
    public function setMerchantId($merchant_id)
    {
        ...
        if ((mb_strlen($merchant_id) > 4)) {
            throw new \InvalidArgumentException('invalid length for $merchant_id when calling Inbound., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($merchant_id) < 4)) {
            throw new \InvalidArgumentException('invalid length for $merchant_id when calling Inbound., must be bigger than or equal to 4.');
        }
     ...
     * Gets items
     *
     * @return \kruegge82\jtlffn\Model\InboundItem[]
     */
     ...
     * Sets items
     *
     * @param \kruegge82\jtlffn\Model\InboundItem[] $items One or more items that shall arrive at your warehouse
     *
     * @return self
     */
     ...
     * Gets status
     *
     * @return \kruegge82\jtlffn\Model\InboundStatus
     */
     ...
     * Sets status
     *
     * @param \kruegge82\jtlffn\Model\InboundStatus $status status
     *
     * @return self
     */
     ...
     *
     * @param string $merchant_inbound_number Merchant inbound number
     *
     * @return self
     */
    public function setMerchantInboundNumber($merchant_inbound_number)
    {
        ...
        if ((mb_strlen($merchant_inbound_number) > 255)) {
            throw new \InvalidArgumentException('invalid length for $merchant_inbound_number when calling Inbound., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($merchant_inbound_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $merchant_inbound_number when calling Inbound., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^.*$/", ObjectSerializer::toString($merchant_inbound_number)))) {
            throw new \InvalidArgumentException("invalid value for \$merchant_inbound_number when calling Inbound., must conform to the pattern /^.*$/.");
        }
    ...
    public function setWarehouseId($warehouse_id)
    {
        ...
        if ((mb_strlen($warehouse_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $warehouse_id when calling Inbound., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($warehouse_id) < 14)) {
            throw new \InvalidArgumentException('invalid length for $warehouse_id when calling Inbound., must be bigger than or equal to 14.');
        }
    ...
    public function setNote($note)
    {
        ...
        if (!is_null($note) && (mb_strlen($note) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $note when calling Inbound., must be smaller than or equal to 4096.');
        }
        if (!is_null($note) && (mb_strlen($note) < 0)) {
            throw new \InvalidArgumentException('invalid length for $note when calling Inbound., must be bigger than or equal to 0.');
        }
    ...
    public function setPurchaseOrderNumber($purchase_order_number)
    {
        ...
        if (!is_null($purchase_order_number) && (mb_strlen($purchase_order_number) > 255)) {
            throw new \InvalidArgumentException('invalid length for $purchase_order_number when calling Inbound., must be smaller than or equal to 255.');
        }
        if (!is_null($purchase_order_number) && (mb_strlen($purchase_order_number) < 0)) {
            throw new \InvalidArgumentException('invalid length for $purchase_order_number when calling Inbound., must be bigger than or equal to 0.');
        }
    ...
    /**
     * Gets external_inbound_number
     *
     * @return string|null
     */
    public function getExternalInboundNumber()
    {
        return $this->container['external_inbound_number'];
    }

    /**
     * Sets external_inbound_number
     *
     * @param string|null $external_inbound_number External inbound number
     *
     * @return self
     */
    public function setExternalInboundNumber($external_inbound_number)
    {
        if (is_null($external_inbound_number)) {
            array_push($this->openAPINullablesSetToNull, 'external_inbound_number');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('external_inbound_number', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($external_inbound_number) && (mb_strlen($external_inbound_number) > 255)) {
            throw new \InvalidArgumentException('invalid length for $external_inbound_number when calling Inbound., must be smaller than or equal to 255.');
        }
        if (!is_null($external_inbound_number) && (mb_strlen($external_inbound_number) < 0)) {
            throw new \InvalidArgumentException('invalid length for $external_inbound_number when calling Inbound., must be bigger than or equal to 0.');
        }

        $this->container['external_inbound_number'] = $external_inbound_number;
     ...
     * Sets attributes
     *
     * @param \kruegge82\jtlffn\Model\Attribute[] $attributes Attributes of the inbound. Attributes are flexible custom fields
     *
     * @return self
     */
     ...
     * Gets supplier
     *
     * @return \kruegge82\jtlffn\Model\InboundSupplier|null
     */
     ...
     * Sets supplier
     *
     * @param \kruegge82\jtlffn\Model\InboundSupplier|null $supplier supplier
     *
     * @return self
     */
