...
class CreateReturnRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'customer_address' => '\kruegge82\jtlffn\Model\CreateAddressRequest',
        'items' => '\kruegge82\jtlffn\Model\CreateReturnItemRequest[]',
        'contact' => 'string'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['fulfiller_return_number'] === null) {
            $invalidProperties[] = "'fulfiller_return_number' can't be null";
        }
     ...
     * Sets warehouse_id
     *
     * @param string $warehouse_id Warehouse must be from the fulfiller who delivered the outbound
     *
     * @return self
     */
    ...
    public function setInternalNote($internal_note)
    {
        ...
        if (!is_null($internal_note) && (mb_strlen($internal_note) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $internal_note when calling CreateReturnRequest., must be smaller than or equal to 4096.');
        }
        if (!is_null($internal_note) && (mb_strlen($internal_note) < 0)) {
            throw new \InvalidArgumentException('invalid length for $internal_note when calling CreateReturnRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setExternalNote($external_note)
    {
        ...
        if (!is_null($external_note) && (mb_strlen($external_note) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $external_note when calling CreateReturnRequest., must be smaller than or equal to 4096.');
        }
        if (!is_null($external_note) && (mb_strlen($external_note) < 0)) {
            throw new \InvalidArgumentException('invalid length for $external_note when calling CreateReturnRequest., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param string $fulfiller_return_number fulfiller_return_number
     *
     * @return self
     */
    public function setFulfillerReturnNumber($fulfiller_return_number)
    {
        if (is_null($fulfiller_return_number)) {
            throw new \InvalidArgumentException('non-nullable fulfiller_return_number cannot be null');
        }
     ...
     *
     * @return \kruegge82\jtlffn\Model\CreateAddressRequest
     */
     ...
     *
     * @param \kruegge82\jtlffn\Model\CreateAddressRequest $customer_address customer_address
     *
     * @return self
     */
     ...
     * Gets items
     *
     * @return \kruegge82\jtlffn\Model\CreateReturnItemRequest[]
     */
     ...
     * Sets items
     *
     * @param \kruegge82\jtlffn\Model\CreateReturnItemRequest[] $items items
     *
     * @return self
     */
