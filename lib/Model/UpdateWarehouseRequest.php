...
/**
 * UpdateWarehouseRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateWarehouseRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateWarehouseRequest';
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'address' => '\kruegge82\jtlffn\Model\UpdateAddressRequest'
    ];
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The new name of the warehouse
     *
     * @return self
     */
     ...
     * Sets address
     *
     * @param \kruegge82\jtlffn\Model\UpdateAddressRequest|null $address address
     *
     * @return self
     */
