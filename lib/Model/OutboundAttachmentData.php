...
/**
 * OutboundAttachmentData Class Doc Comment
 *
 * @category Class
 ...
 */
class OutboundAttachmentData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OutboundAttachmentData';
    ...
    protected static $openAPITypes = [
        ...
        'document_type' => '\kruegge82\jtlffn\Model\DocumentType'
    ];
    ...
    protected static $setters = [
        ...
        'merchant_document_id' => 'setMerchantDocumentId',
    ...
    protected static $getters = [
        ...
        'merchant_document_id' => 'getMerchantDocumentId',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('merchant_document_id', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['merchant_document_id'] === null) {
            $invalidProperties[] = "'merchant_document_id' can't be null";
        }
    ...
    /**
     * Gets merchant_document_id
     *
     * @return string
     */
    public function getMerchantDocumentId()
    {
        return $this->container['merchant_document_id'];
    }

    /**
     * Sets merchant_document_id
     *
     * @param string $merchant_document_id Merchant document identifier
     *
     * @return self
     */
    public function setMerchantDocumentId($merchant_document_id)
    {
        if (is_null($merchant_document_id)) {
            throw new \InvalidArgumentException('non-nullable merchant_document_id cannot be null');
        }


        $this->container['merchant_document_id'] = $merchant_document_id;
     ...
     * Gets document_type
     *
     * @return \kruegge82\jtlffn\Model\DocumentType
     */
     ...
     * Sets document_type
     *
     * @param \kruegge82\jtlffn\Model\DocumentType $document_type document_type
     *
     * @return self
     */
