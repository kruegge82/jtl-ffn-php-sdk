...
/**
 * StockInWarehouse Class Doc Comment
 *
 * @category Class
 ...
 */
class StockInWarehouse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StockInWarehouse';
    ...
    protected static $openAPITypes = [
        ...
        'stock_level_details' => '\kruegge82\jtlffn\Model\StockLevelDetail[]',
        'stock_reserved_details' => '\kruegge82\jtlffn\Model\StockReservedDetail[]',
        'stock_announced_details' => '\kruegge82\jtlffn\Model\StockAnnouncedDetail[]',
        'merchant_sku' => 'string',
    ...
    protected static $openAPIFormats = [
        ...
        'stock_level_details' => null,
        'stock_reserved_details' => null,
        'stock_announced_details' => null,
        'merchant_sku' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'stock_level_details' => false,
        'stock_reserved_details' => false,
        'stock_announced_details' => false,
        'merchant_sku' => false,
    ...
    protected static $attributeMap = [
        ...
        'stock_level_details' => 'stockLevelDetails',
        'stock_reserved_details' => 'stockReservedDetails',
        'stock_announced_details' => 'stockAnnouncedDetails',
    ...
    protected static $setters = [
        ...
        'stock_level_details' => 'setStockLevelDetails',
        'stock_reserved_details' => 'setStockReservedDetails',
        'stock_announced_details' => 'setStockAnnouncedDetails',
    ...
    protected static $getters = [
        ...
        'stock_level_details' => 'getStockLevelDetails',
        'stock_reserved_details' => 'getStockReservedDetails',
        'stock_announced_details' => 'getStockAnnouncedDetails',
    ...
    {
        $this->setIfExists('jfsku', $data ?? [], null);
        ...
        $this->setIfExists('stock_level_details', $data ?? [], null);
        $this->setIfExists('stock_reserved_details', $data ?? [], null);
        $this->setIfExists('stock_announced_details', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['jfsku'] === null) {
            $invalidProperties[] = "'jfsku' can't be null";
        }
        if ((mb_strlen($this->container['jfsku']) > 11)) {
            $invalidProperties[] = "invalid value for 'jfsku', the character length must be smaller than or equal to 11.";
        }

        if ((mb_strlen($this->container['jfsku']) < 11)) {
            $invalidProperties[] = "invalid value for 'jfsku', the character length must be bigger than or equal to 11.";
        }
        ...
        if ($this->container['stock_level_details'] === null) {
            $invalidProperties[] = "'stock_level_details' can't be null";
        }
        if ($this->container['stock_reserved_details'] === null) {
            $invalidProperties[] = "'stock_reserved_details' can't be null";
        }
        if ($this->container['stock_announced_details'] === null) {
            $invalidProperties[] = "'stock_announced_details' can't be null";
        }
     ...
     * @return string
     */
    public function getJfsku()
    {
        return $this->container['jfsku'];
    }

    /**
     * Sets jfsku
     *
     * @param string $jfsku Product identifer
     *
     * @return self
     */
    public function setJfsku($jfsku)
    {
        if (is_null($jfsku)) {
            throw new \InvalidArgumentException('non-nullable jfsku cannot be null');
        }
        if ((mb_strlen($jfsku) > 11)) {
            throw new \InvalidArgumentException('invalid length for $jfsku when calling StockInWarehouse., must be smaller than or equal to 11.');
        }
        if ((mb_strlen($jfsku) < 11)) {
            throw new \InvalidArgumentException('invalid length for $jfsku when calling StockInWarehouse., must be bigger than or equal to 11.');
        }

        $this->container['jfsku'] = $jfsku;
    ...
    public function setWarehouseId($warehouse_id)
    {
        ...
        if ((mb_strlen($warehouse_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $warehouse_id when calling StockInWarehouse., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($warehouse_id) < 14)) {
            throw new \InvalidArgumentException('invalid length for $warehouse_id when calling StockInWarehouse., must be bigger than or equal to 14.');
        }
    ...
    /**
     * Gets stock_level_details
     *
     * @return \kruegge82\jtlffn\Model\StockLevelDetail[]
     */
    public function getStockLevelDetails()
    {
        return $this->container['stock_level_details'];
    }

    /**
     * Sets stock_level_details
     *
     * @param \kruegge82\jtlffn\Model\StockLevelDetail[] $stock_level_details Stock level details itemized by batch and/or best before date
     *
     * @return self
     */
    public function setStockLevelDetails($stock_level_details)
    {
        if (is_null($stock_level_details)) {
            throw new \InvalidArgumentException('non-nullable stock_level_details cannot be null');
        }


        $this->container['stock_level_details'] = $stock_level_details;

        return $this;
    }

    /**
     * Gets stock_reserved_details
     *
     * @return \kruegge82\jtlffn\Model\StockReservedDetail[]
     */
    public function getStockReservedDetails()
    {
        return $this->container['stock_reserved_details'];
    }

    /**
     * Sets stock_reserved_details
     *
     * @param \kruegge82\jtlffn\Model\StockReservedDetail[] $stock_reserved_details Reserved stock level details
     *
     * @return self
     */
    public function setStockReservedDetails($stock_reserved_details)
    {
        if (is_null($stock_reserved_details)) {
            throw new \InvalidArgumentException('non-nullable stock_reserved_details cannot be null');
        }


        $this->container['stock_reserved_details'] = $stock_reserved_details;

        return $this;
    }

    /**
     * Gets stock_announced_details
     *
     * @return \kruegge82\jtlffn\Model\StockAnnouncedDetail[]
     */
    public function getStockAnnouncedDetails()
    {
        return $this->container['stock_announced_details'];
    }

    /**
     * Sets stock_announced_details
     *
     * @param \kruegge82\jtlffn\Model\StockAnnouncedDetail[] $stock_announced_details Announced stock level details
     *
     * @return self
     */
    public function setStockAnnouncedDetails($stock_announced_details)
    {
        if (is_null($stock_announced_details)) {
            throw new \InvalidArgumentException('non-nullable stock_announced_details cannot be null');
        }


        $this->container['stock_announced_details'] = $stock_announced_details;
    ...
    public function setMerchantSku($merchant_sku)
    {
        ...
        if ((mb_strlen($merchant_sku) > 255)) {
            throw new \InvalidArgumentException('invalid length for $merchant_sku when calling StockInWarehouse., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($merchant_sku) < 0)) {
            throw new \InvalidArgumentException('invalid length for $merchant_sku when calling StockInWarehouse., must be bigger than or equal to 0.');
        }
