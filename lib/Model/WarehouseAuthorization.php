...
/**
 * WarehouseAuthorization Class Doc Comment
 *
 * @category Class
 ...
 */
class WarehouseAuthorization implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WarehouseAuthorization';
    ...
    protected static $openAPITypes = [
        'warehouse_id' => 'string',
        'created_at' => '\DateTime',
        'shipping_methods' => '\kruegge82\jtlffn\Model\AuthorizedShippingMethod[]'
    ];
    ...
    */
    ...
    public function setWarehouseId($warehouse_id)
    {
        ...
        if ((mb_strlen($warehouse_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $warehouse_id when calling WarehouseAuthorization., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($warehouse_id) < 14)) {
            throw new \InvalidArgumentException('invalid length for $warehouse_id when calling WarehouseAuthorization., must be bigger than or equal to 14.');
        }
     ...
     *
     * @return \kruegge82\jtlffn\Model\AuthorizedShippingMethod[]
     */
     ...
     *
     * @param \kruegge82\jtlffn\Model\AuthorizedShippingMethod[] $shipping_methods List of shipping methods you provide your merchant in that warehouse
     *
     * @return self
     */
