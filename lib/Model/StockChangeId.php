...
/**
 * StockChangeId Class Doc Comment
 *
 * @category Class
 ...
 */
class StockChangeId implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StockChangeId';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('stock_version', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['stock_version'] === null) {
            $invalidProperties[] = "'stock_version' can't be null";
        }
    ...
    public function setWarehouseId($warehouse_id)
    {
        ...
        if ((mb_strlen($warehouse_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $warehouse_id when calling StockChangeId., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($warehouse_id) < 14)) {
            throw new \InvalidArgumentException('invalid length for $warehouse_id when calling StockChangeId., must be bigger than or equal to 14.');
        }
    ...
    public function setJfsku($jfsku)
    {
        ...
        if ((mb_strlen($jfsku) > 11)) {
            throw new \InvalidArgumentException('invalid length for $jfsku when calling StockChangeId., must be smaller than or equal to 11.');
        }
        if ((mb_strlen($jfsku) < 11)) {
            throw new \InvalidArgumentException('invalid length for $jfsku when calling StockChangeId., must be bigger than or equal to 11.');
        }
    ...
    {
        return $this->container['stock_version'];
    }

    /**
     * Sets stock_version
     *
     * @param int $stock_version An unique version number of the stock change. This number is ascending
     *
     * @return self
     */
    public function setStockVersion($stock_version)
    {
        if (is_null($stock_version)) {
            throw new \InvalidArgumentException('non-nullable stock_version cannot be null');
        }


        $this->container['stock_version'] = $stock_version;
