...
/**
 * InboundShippingPackage Class Doc Comment
 *
 * @category Class
 ...
 */
class InboundShippingPackage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InboundShippingPackage';
    ...
    protected static $openAPITypes = [
        ...
        'freight_option' => '\kruegge82\jtlffn\Model\FreightOptionType',
        'note' => 'string',
        'tracking_url' => 'string',
        'carrier_code' => 'string',
        'carrier_name' => 'string',
        'identifier' => '\kruegge82\jtlffn\Model\PackageIdentifier[]',
        'shipment_count' => 'int',
        'shipping_date' => '\DateTime',
        'dimensions' => '\kruegge82\jtlffn\Model\InboundShippingPackageDimensions',
        'weight' => 'float'
    ];
    ...
    protected static $setters = [
        ...
        'freight_option' => 'setFreightOption',
        'note' => 'setNote',
    ...
    protected static $getters = [
        ...
        'freight_option' => 'getFreightOption',
        'note' => 'getNote',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('freight_option', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['freight_option'] === null) {
            $invalidProperties[] = "'freight_option' can't be null";
        }
        ...
        if (!is_null($this->container['tracking_url']) && (mb_strlen($this->container['tracking_url']) > 255)) {
            $invalidProperties[] = "invalid value for 'tracking_url', the character length must be smaller than or equal to 255.";
        }
        ...
        if ($this->container['shipping_date'] === null) {
            $invalidProperties[] = "'shipping_date' can't be null";
        }
     ...
     *
     * @param \DateTime|null $estimated_delivery_date Estimated delivery date for that package
     *
     * @return self
     */
     ...
     * Gets freight_option
     *
     * @return \kruegge82\jtlffn\Model\FreightOptionType
     */
    public function getFreightOption()
    {
        return $this->container['freight_option'];
    }

    /**
     * Sets freight_option
     *
     * @param \kruegge82\jtlffn\Model\FreightOptionType $freight_option freight_option
     *
     * @return self
     */
    public function setFreightOption($freight_option)
    {
        if (is_null($freight_option)) {
            throw new \InvalidArgumentException('non-nullable freight_option cannot be null');
        }
        $this->container['freight_option'] = $freight_option;
     ...
     * Sets note
     *
     * @param string|null $note Note of that package
     *
     * @return self
     */
    public function setNote($note)
    {
        ...
        if (!is_null($note) && (mb_strlen($note) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $note when calling InboundShippingPackage., must be smaller than or equal to 4096.');
        }
        if (!is_null($note) && (mb_strlen($note) < 0)) {
            throw new \InvalidArgumentException('invalid length for $note when calling InboundShippingPackage., must be bigger than or equal to 0.');
        }
     ...
     * Sets tracking_url
     *
     * @param string|null $tracking_url Tracking URL for that package
     *
     * @return self
     */
    public function setTrackingUrl($tracking_url)
    {
        ...
        if (!is_null($tracking_url) && (mb_strlen($tracking_url) > 255)) {
            throw new \InvalidArgumentException('invalid length for $tracking_url when calling InboundShippingPackage., must be smaller than or equal to 255.');
        }
        if (!is_null($tracking_url) && (mb_strlen($tracking_url) < 0)) {
            throw new \InvalidArgumentException('invalid length for $tracking_url when calling InboundShippingPackage., must be bigger than or equal to 0.');
        }
     ...
     * Sets carrier_code
     *
     * @param string|null $carrier_code Carrier Code for that package
     *
     * @return self
     */
     ...
     * Sets carrier_name
     *
     * @param string|null $carrier_name Carrier Name for that package
     *
     * @return self
     */
    public function setCarrierName($carrier_name)
    {
        ...
        if (!is_null($carrier_name) && (mb_strlen($carrier_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $carrier_name when calling InboundShippingPackage., must be smaller than or equal to 255.');
        }
        if (!is_null($carrier_name) && (mb_strlen($carrier_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $carrier_name when calling InboundShippingPackage., must be bigger than or equal to 0.');
        }
     ...
     * Gets identifier
     *
     * @return \kruegge82\jtlffn\Model\PackageIdentifier[]
     */
     ...
     * Sets identifier
     *
     * @param \kruegge82\jtlffn\Model\PackageIdentifier[] $identifier Package identifier container
     *
     * @return self
     */
     ...
     * Sets shipment_count
     *
     * @param int|null $shipment_count Number of parcels / containers / etc. in that package
     *
     * @return self
     */
    public function setShipmentCount($shipment_count)
    {
        if (is_null($shipment_count)) {
            array_push($this->openAPINullablesSetToNull, 'shipment_count');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('shipment_count', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets shipping_date
     *
     * @param \DateTime $shipping_date Shipping date of the package
     *
     * @return self
     */
     ...
     * Gets dimensions
     *
     * @return \kruegge82\jtlffn\Model\InboundShippingPackageDimensions|null
     */
     ...
     * Sets dimensions
     *
     * @param \kruegge82\jtlffn\Model\InboundShippingPackageDimensions|null $dimensions dimensions
     *
     * @return self
     */
