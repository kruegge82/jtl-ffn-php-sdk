...
class PictureData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PictureData';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['hash']) && (mb_strlen($this->container['hash']) > 255)) {
            $invalidProperties[] = "invalid value for 'hash', the character length must be smaller than or equal to 255.";
        }
        ...
        if ((mb_strlen($this->container['mime_type']) > 255)) {
            $invalidProperties[] = "invalid value for 'mime_type', the character length must be smaller than or equal to 255.";
        }

        if ((mb_strlen($this->container['mime_type']) < 0)) {
            $invalidProperties[] = "invalid value for 'mime_type', the character length must be bigger than or equal to 0.";
        }
     ...
     * Sets hash
     *
     * @param string|null $hash Hash of that picture
     *
     * @return self
     */
    public function setHash($hash)
    {
        ...
        if (!is_null($hash) && (mb_strlen($hash) > 255)) {
            throw new \InvalidArgumentException('invalid length for $hash when calling PictureData., must be smaller than or equal to 255.');
        }
        if (!is_null($hash) && (mb_strlen($hash) < 0)) {
            throw new \InvalidArgumentException('invalid length for $hash when calling PictureData., must be bigger than or equal to 0.');
        }
    ...
    public function setMimeType($mime_type)
    {
        ...
        if ((mb_strlen($mime_type) > 255)) {
            throw new \InvalidArgumentException('invalid length for $mime_type when calling PictureData., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($mime_type) < 0)) {
            throw new \InvalidArgumentException('invalid length for $mime_type when calling PictureData., must be bigger than or equal to 0.');
        }
     ...
     * Sets number
     *
     * @param int $number Picture number
     *
     * @return self
     */
