 ...
 */
class PackageIdentifier implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PackageIdentifier';
    ...
    protected static $openAPITypes = [
        'value' => 'string',
        'identifier_type' => '\kruegge82\jtlffn\Model\IdentifierType',
        'name' => 'string'
    ];
    ...
    */
     ...
     * Sets value
     *
     * @param string $value The value of the package identifier
     *
     * @return self
     */
    public function setValue($value)
    {
        ...
        if ((mb_strlen($value) > 255)) {
            throw new \InvalidArgumentException('invalid length for $value when calling PackageIdentifier., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($value) < 0)) {
            throw new \InvalidArgumentException('invalid length for $value when calling PackageIdentifier., must be bigger than or equal to 0.');
        }
     ...
     *
     * @return \kruegge82\jtlffn\Model\IdentifierType
     */
     ...
     *
     * @param \kruegge82\jtlffn\Model\IdentifierType $identifier_type identifier_type
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Name of the identifier
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PackageIdentifier., must be smaller than or equal to 255.');
        }
        if (!is_null($name) && (mb_strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PackageIdentifier., must be bigger than or equal to 0.');
        }
