...
class Warehouse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'fulfiller_id' => 'string',
        'name' => 'string',
        'address' => '\kruegge82\jtlffn\Model\Address',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('fulfiller_id', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['fulfiller_id'] === null) {
            $invalidProperties[] = "'fulfiller_id' can't be null";
        }
        if ((mb_strlen($this->container['fulfiller_id']) > 4)) {
            $invalidProperties[] = "invalid value for 'fulfiller_id', the character length must be smaller than or equal to 4.";
        }

        if ((mb_strlen($this->container['fulfiller_id']) < 4)) {
            $invalidProperties[] = "invalid value for 'fulfiller_id', the character length must be bigger than or equal to 4.";
        }
    ...
    public function setWarehouseId($warehouse_id)
    {
        ...
        if ((mb_strlen($warehouse_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $warehouse_id when calling Warehouse., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($warehouse_id) < 14)) {
            throw new \InvalidArgumentException('invalid length for $warehouse_id when calling Warehouse., must be bigger than or equal to 14.');
        }
     ...
     * @return string
     */
    public function getFulfillerId()
    {
        return $this->container['fulfiller_id'];
    }

    /**
     * Sets fulfiller_id
     *
     * @param string $fulfiller_id Id of the fulfiller
     *
     * @return self
     */
    public function setFulfillerId($fulfiller_id)
    {
        if (is_null($fulfiller_id)) {
            throw new \InvalidArgumentException('non-nullable fulfiller_id cannot be null');
        }
        if ((mb_strlen($fulfiller_id) > 4)) {
            throw new \InvalidArgumentException('invalid length for $fulfiller_id when calling Warehouse., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($fulfiller_id) < 4)) {
            throw new \InvalidArgumentException('invalid length for $fulfiller_id when calling Warehouse., must be bigger than or equal to 4.');
        }

        $this->container['fulfiller_id'] = $fulfiller_id;
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Warehouse., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Warehouse., must be bigger than or equal to 0.');
        }
     ...
     * Sets address
     *
     * @param \kruegge82\jtlffn\Model\Address $address address
     *
     * @return self
     */
