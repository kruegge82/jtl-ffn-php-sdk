...
/**
 * AuthorizedShippingMethod Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\jtlffn
 * @author   OpenAPI Generator team
 ...
 */
class AuthorizedShippingMethod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuthorizedShippingMethod';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['shipping_method_id']) < 0)) {
            $invalidProperties[] = "invalid value for 'shipping_method_id', the character length must be bigger than or equal to 0.";
        }
    ...
    public function setShippingMethodId($shipping_method_id)
    {
        ...
        if ((mb_strlen($shipping_method_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $shipping_method_id when calling AuthorizedShippingMethod., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($shipping_method_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $shipping_method_id when calling AuthorizedShippingMethod., must be bigger than or equal to 0.');
        }
