...
class Identifier implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'mpn' => '\kruegge82\jtlffn\Model\Mpn',
        'ean' => 'string',
        'isbn' => 'string',
        'upc' => 'string',
        'asin' => 'string'
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['ean']) && (mb_strlen($this->container['ean']) > 255)) {
            $invalidProperties[] = "invalid value for 'ean', the character length must be smaller than or equal to 255.";
        }
        ...
        if (!is_null($this->container['isbn']) && (mb_strlen($this->container['isbn']) > 255)) {
            $invalidProperties[] = "invalid value for 'isbn', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['isbn']) && (mb_strlen($this->container['isbn']) < 0)) {
            $invalidProperties[] = "invalid value for 'isbn', the character length must be bigger than or equal to 0.";
        }
        ...
        if (!is_null($this->container['asin']) && (mb_strlen($this->container['asin']) > 255)) {
            $invalidProperties[] = "invalid value for 'asin', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['asin']) && (mb_strlen($this->container['asin']) < 0)) {
            $invalidProperties[] = "invalid value for 'asin', the character length must be bigger than or equal to 0.";
        }
     ...
     * Gets mpn
     *
     * @return \kruegge82\jtlffn\Model\Mpn|null
     */
     ...
     * Sets mpn
     *
     * @param \kruegge82\jtlffn\Model\Mpn|null $mpn mpn
     *
     * @return self
     */
    ...
    public function setEan($ean)
    {
        ...
        if (!is_null($ean) && (mb_strlen($ean) > 255)) {
            throw new \InvalidArgumentException('invalid length for $ean when calling Identifier., must be smaller than or equal to 255.');
        }
        if (!is_null($ean) && (mb_strlen($ean) < 0)) {
            throw new \InvalidArgumentException('invalid length for $ean when calling Identifier., must be bigger than or equal to 0.');
        }
    ...
    public function setIsbn($isbn)
    {
        ...
        if (!is_null($isbn) && (mb_strlen($isbn) > 255)) {
            throw new \InvalidArgumentException('invalid length for $isbn when calling Identifier., must be smaller than or equal to 255.');
        }
        if (!is_null($isbn) && (mb_strlen($isbn) < 0)) {
            throw new \InvalidArgumentException('invalid length for $isbn when calling Identifier., must be bigger than or equal to 0.');
        }
    ...
    public function setUpc($upc)
    {
        ...
        if (!is_null($upc) && (mb_strlen($upc) > 255)) {
            throw new \InvalidArgumentException('invalid length for $upc when calling Identifier., must be smaller than or equal to 255.');
        }
        if (!is_null($upc) && (mb_strlen($upc) < 0)) {
            throw new \InvalidArgumentException('invalid length for $upc when calling Identifier., must be bigger than or equal to 0.');
        }
    ...
    public function setAsin($asin)
    {
        ...
        if (!is_null($asin) && (mb_strlen($asin) > 255)) {
            throw new \InvalidArgumentException('invalid length for $asin when calling Identifier., must be smaller than or equal to 255.');
        }
        if (!is_null($asin) && (mb_strlen($asin) < 0)) {
            throw new \InvalidArgumentException('invalid length for $asin when calling Identifier., must be bigger than or equal to 0.');
        }
