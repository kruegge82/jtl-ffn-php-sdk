...
class ErrorResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'error_code' => '\kruegge82\jtlffn\Model\ErrorCode',
        'error_messages' => '\kruegge82\jtlffn\Model\ErrorMessages[]',
        'error_meta_data' => 'mixed'
    ];
    ...
    protected static $setters = [
        ...
        'error_meta_data' => 'setErrorMetaData'
    ];
    ...
    protected static $getters = [
        ...
        'error_meta_data' => 'getErrorMetaData'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('error_meta_data', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['error_meta_data'] === null) {
            $invalidProperties[] = "'error_meta_data' can't be null";
        }
     ...
     * Gets error_code
     *
     * @return \kruegge82\jtlffn\Model\ErrorCode
     */
     ...
     * Sets error_code
     *
     * @param \kruegge82\jtlffn\Model\ErrorCode $error_code error_code
     *
     * @return self
     */
     ...
     * Gets error_messages
     *
     * @return \kruegge82\jtlffn\Model\ErrorMessages[]
     */
     ...
     * Sets error_messages
     *
     * @param \kruegge82\jtlffn\Model\ErrorMessages[] $error_messages error_messages
     *
     * @return self
     */
    ...
    /**
     * Gets error_meta_data
     *
     * @return mixed
     */
    public function getErrorMetaData()
    {
        return $this->container['error_meta_data'];
    }

    /**
     * Sets error_meta_data
     *
     * @param mixed $error_meta_data error_meta_data
     *
     * @return self
     */
    public function setErrorMetaData($error_meta_data)
    {
        if (is_null($error_meta_data)) {
            array_push($this->openAPINullablesSetToNull, 'error_meta_data');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('error_meta_data', $nullablesSetToNull);
            if ($index !== FALSE) {
        ...
        $this->container['error_meta_data'] = $error_meta_data;
