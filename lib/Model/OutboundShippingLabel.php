...
/**
 * OutboundShippingLabel Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\jtlffn
 * @author   OpenAPI Generator team
 ...
 */
class OutboundShippingLabel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OutboundShippingLabel';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('shipping_label_id', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['shipping_label_id'] === null) {
            $invalidProperties[] = "'shipping_label_id' can't be null";
        }
        if ((mb_strlen($this->container['shipping_label_id']) > 255)) {
            $invalidProperties[] = "invalid value for 'shipping_label_id', the character length must be smaller than or equal to 255.";
        }

        if ((mb_strlen($this->container['shipping_label_id']) < 0)) {
            $invalidProperties[] = "invalid value for 'shipping_label_id', the character length must be bigger than or equal to 0.";
        }
        ...
        if (!is_null($this->container['tracking_id']) && (mb_strlen($this->container['tracking_id']) < 0)) {
            $invalidProperties[] = "invalid value for 'tracking_id', the character length must be bigger than or equal to 0.";
        }
     ...
     * Sets data
     *
     * @param string $data Data of the shipping label
     *
     * @return self
     */
     ...
     *
     * @param string $shipping_label_id Unique id of the shipping label
     *
     * @return self
     */
    public function setShippingLabelId($shipping_label_id)
    {
        if (is_null($shipping_label_id)) {
            throw new \InvalidArgumentException('non-nullable shipping_label_id cannot be null');
        }
        if ((mb_strlen($shipping_label_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $shipping_label_id when calling OutboundShippingLabel., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($shipping_label_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $shipping_label_id when calling OutboundShippingLabel., must be bigger than or equal to 0.');
        }
     ...
     * Sets size
     *
     * @param int $size Size of the attachment
     *
     * @return self
     */
     ...
     * Sets mime_type
     *
     * @param string $mime_type Mime Type of that attachment
     *
     * @return self
     */
     ...
     * Sets tracking_id
     *
     * @param string|null $tracking_id Tracking id of the shipping label
     *
     * @return self
     */
    public function setTrackingId($tracking_id)
    {
        ...
        if (!is_null($tracking_id) && (mb_strlen($tracking_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $tracking_id when calling OutboundShippingLabel., must be smaller than or equal to 255.');
        }
        if (!is_null($tracking_id) && (mb_strlen($tracking_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $tracking_id when calling OutboundShippingLabel., must be bigger than or equal to 0.');
        }
