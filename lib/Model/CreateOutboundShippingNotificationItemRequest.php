...
/**
 * CreateOutboundShippingNotificationItemRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateOutboundShippingNotificationItemRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateOutboundShippingNotificationItemRequest';
    ...
    */
     ...
     * Sets merchant_sku
     *
     * @param string|null $merchant_sku SKU (Stock Keeping Unit) of the merchant One of Jfsku or merchantSku must be given
     *
     * @return self
     */
    ...
    public function setJfsku($jfsku)
    {
        ...
        if (!is_null($jfsku) && (mb_strlen($jfsku) > 11)) {
            throw new \InvalidArgumentException('invalid length for $jfsku when calling CreateOutboundShippingNotificationItemRequest., must be smaller than or equal to 11.');
        }
        if (!is_null($jfsku) && (mb_strlen($jfsku) < 11)) {
            throw new \InvalidArgumentException('invalid length for $jfsku when calling CreateOutboundShippingNotificationItemRequest., must be bigger than or equal to 11.');
        }
     ...
     * Sets warehouse_id
     *
     * @param string|null $warehouse_id WarehouseId
     *
     * @return self
     */
    ...
    public function setNote($note)
    {
        ...
        if (!is_null($note) && (mb_strlen($note) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $note when calling CreateOutboundShippingNotificationItemRequest., must be smaller than or equal to 4096.');
        }
        if (!is_null($note) && (mb_strlen($note) < 0)) {
            throw new \InvalidArgumentException('invalid length for $note when calling CreateOutboundShippingNotificationItemRequest., must be bigger than or equal to 0.');
        }
     ...
     * Sets serialnumbers
     *
     * @param string[]|null $serialnumbers Serial numbers of the item within the outbound shipping notification
     *
     * @return self
     */
    public function setSerialnumbers($serialnumbers)
    {
        if (is_null($serialnumbers)) {
            array_push($this->openAPINullablesSetToNull, 'serialnumbers');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('serialnumbers', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
