...
/**
 * CreatePackageIdentifierRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class CreatePackageIdentifierRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePackageIdentifierRequest';
