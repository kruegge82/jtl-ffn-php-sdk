...
/**
 * OutboundItem Class Doc Comment
 *
 * @category Class
 ...
 */
class OutboundItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OutboundItem';
    ...
    protected static $openAPITypes = [
        ...
        'jfsku' => 'string',
        'item_type' => '\kruegge82\jtlffn\Model\ItemType',
        'quantity' => 'float',
        'quantity_open' => 'float',
        'name' => 'string',
        'merchant_sku' => 'string',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['outbound_item_id'] === null) {
            $invalidProperties[] = "'outbound_item_id' can't be null";
        }
        if ((mb_strlen($this->container['outbound_item_id']) > 255)) {
            $invalidProperties[] = "invalid value for 'outbound_item_id', the character length must be smaller than or equal to 255.";
        }

        if ((mb_strlen($this->container['outbound_item_id']) < 0)) {
        ...
        if ($this->container['quantity_open'] === null) {
            $invalidProperties[] = "'quantity_open' can't be null";
        }
        ...
        if (!is_null($this->container['merchant_sku']) && (mb_strlen($this->container['merchant_sku']) > 255)) {
            $invalidProperties[] = "invalid value for 'merchant_sku', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['merchant_sku']) && (mb_strlen($this->container['merchant_sku']) < 0)) {
        ...
        if (!is_null($this->container['bill_of_materials_id']) && (mb_strlen($this->container['bill_of_materials_id']) > 255)) {
            $invalidProperties[] = "invalid value for 'bill_of_materials_id', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['bill_of_materials_id']) && (mb_strlen($this->container['bill_of_materials_id']) < 0)) {
            $invalidProperties[] = "invalid value for 'bill_of_materials_id', the character length must be bigger than or equal to 0.";
        }
     ...
     *
     * @param string $outbound_item_id Outbound item identifier
     *
     * @return self
     */
    public function setOutboundItemId($outbound_item_id)
    {
        if (is_null($outbound_item_id)) {
            throw new \InvalidArgumentException('non-nullable outbound_item_id cannot be null');
        }
        if ((mb_strlen($outbound_item_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $outbound_item_id when calling OutboundItem., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($outbound_item_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $outbound_item_id when calling OutboundItem., must be bigger than or equal to 0.');
        }
    ...
    public function setJfsku($jfsku)
    {
        ...
        if (!is_null($jfsku) && (mb_strlen($jfsku) > 11)) {
            throw new \InvalidArgumentException('invalid length for $jfsku when calling OutboundItem., must be smaller than or equal to 11.');
        }
        if (!is_null($jfsku) && (mb_strlen($jfsku) < 11)) {
            throw new \InvalidArgumentException('invalid length for $jfsku when calling OutboundItem., must be bigger than or equal to 11.');
        }
     ...
     * Gets item_type
     *
     * @return \kruegge82\jtlffn\Model\ItemType
     */
     ...
     * Sets item_type
     *
     * @param \kruegge82\jtlffn\Model\ItemType $item_type item_type
     *
     * @return self
     */
     ...
     * Sets quantity
     *
     * @param float $quantity Quantity of that outbound item. This quantity of that item shall be shipped to the customer
     *
     * @return self
     */
    ...
    {
        return $this->container['quantity_open'];
    }

    /**
     * Sets quantity_open
     *
     * @param float $quantity_open Quantity of the outbound item which is not shipped yet
     *
     * @return self
     */
    public function setQuantityOpen($quantity_open)
    {
        if (is_null($quantity_open)) {
            throw new \InvalidArgumentException('non-nullable quantity_open cannot be null');
        }


        $this->container['quantity_open'] = $quantity_open;
     ...
     * Sets name
     *
     * @param string|null $name Name of the outbound item
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling OutboundItem., must be smaller than or equal to 255.');
        }
        if (!is_null($name) && (mb_strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling OutboundItem., must be bigger than or equal to 0.');
        }
     ...
     * Sets merchant_sku
     *
     * @param string|null $merchant_sku The SKU (stock keeping unit) of the merchant for that outbound item
     *
     * @return self
     */
    public function setMerchantSku($merchant_sku)
    {
        ...
        if (!is_null($merchant_sku) && (mb_strlen($merchant_sku) > 255)) {
            throw new \InvalidArgumentException('invalid length for $merchant_sku when calling OutboundItem., must be smaller than or equal to 255.');
        }
        if (!is_null($merchant_sku) && (mb_strlen($merchant_sku) < 0)) {
            throw new \InvalidArgumentException('invalid length for $merchant_sku when calling OutboundItem., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param string|null $external_number External number for that outbound item
     *
     * @return self
     */
    public function setExternalNumber($external_number)
    {
        ...
        if (!is_null($external_number) && (mb_strlen($external_number) > 255)) {
            throw new \InvalidArgumentException('invalid length for $external_number when calling OutboundItem., must be smaller than or equal to 255.');
        }
        if (!is_null($external_number) && (mb_strlen($external_number) < 0)) {
            throw new \InvalidArgumentException('invalid length for $external_number when calling OutboundItem., must be bigger than or equal to 0.');
        }
     ...
     * Sets price
     *
     * @param float|null $price Price of that outbound item. Is used for insurance and / or customs duty issues
     *
     * @return self
     */
     ...
     * Sets vat
     *
     * @param float|null $vat VAT of that outbound item
     *
     * @return self
     */
     ...
     *
     * @param string|null $bill_of_materials_id Id of the bill of materials product. Has to be filled if this item is a component of a bill of materials
     *
     * @return self
     */
    public function setBillOfMaterialsId($bill_of_materials_id)
    {
        if (is_null($bill_of_materials_id)) {
            array_push($this->openAPINullablesSetToNull, 'bill_of_materials_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('bill_of_materials_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($bill_of_materials_id) && (mb_strlen($bill_of_materials_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bill_of_materials_id when calling OutboundItem., must be smaller than or equal to 255.');
        }
        if (!is_null($bill_of_materials_id) && (mb_strlen($bill_of_materials_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bill_of_materials_id when calling OutboundItem., must be bigger than or equal to 0.');
        }
     ...
     * Sets note
     *
     * @param string|null $note Note of the outbound item
     *
     * @return self
     */
    public function setNote($note)
    {
        ...
        if (!is_null($note) && (mb_strlen($note) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $note when calling OutboundItem., must be smaller than or equal to 4096.');
        }
        if (!is_null($note) && (mb_strlen($note) < 0)) {
            throw new \InvalidArgumentException('invalid length for $note when calling OutboundItem., must be bigger than or equal to 0.');
        }
