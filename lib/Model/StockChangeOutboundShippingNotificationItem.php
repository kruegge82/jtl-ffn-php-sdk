...
/**
 * StockChangeOutboundShippingNotificationItem Class Doc Comment
 *
 * @category Class
 ...
 */
class StockChangeOutboundShippingNotificationItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StockChangeOutboundShippingNotificationItem';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['outbound_shipping_notification_id']) < 0)) {
            $invalidProperties[] = "invalid value for 'outbound_shipping_notification_id', the character length must be bigger than or equal to 0.";
        }
    ...
    public function setOutboundShippingNotificationId($outbound_shipping_notification_id)
    {
        ...
        if ((mb_strlen($outbound_shipping_notification_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $outbound_shipping_notification_id when calling StockChangeOutboundShippingNotificationItem., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($outbound_shipping_notification_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $outbound_shipping_notification_id when calling StockChangeOutboundShippingNotificationItem., must be bigger than or equal to 0.');
        }
    ...
    public function setOutboundShippingNotificationItemId($outbound_shipping_notification_item_id)
    {
        ...
        if ((mb_strlen($outbound_shipping_notification_item_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $outbound_shipping_notification_item_id when calling StockChangeOutboundShippingNotificationItem., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($outbound_shipping_notification_item_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $outbound_shipping_notification_item_id when calling StockChangeOutboundShippingNotificationItem., must be bigger than or equal to 0.');
        }
