...
/**
 * CreateAmazonSfpShippingLabelDataRequest Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\jtlffn
 * @author   OpenAPI Generator team
 ...
 */
class CreateAmazonSfpShippingLabelDataRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateAmazonSfpShippingLabelDataRequest';
    ...
    protected static $openAPITypes = [
        ...
        'insurance' => 'bool',
        'use_warehouse_address_for_sender_address' => 'bool',
        'delivery_experience' => '\kruegge82\jtlffn\Model\DeliveryExperienceType',
    ...
    protected static $openAPIFormats = [
        ...
        'insurance' => null,
        'use_warehouse_address_for_sender_address' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'insurance' => false,
        'use_warehouse_address_for_sender_address' => false,
    ...
    protected static $attributeMap = [
        ...
        'insurance' => 'insurance',
        'use_warehouse_address_for_sender_address' => 'useWarehouseAddressForSenderAddress',
    ...
    protected static $setters = [
        ...
        'use_warehouse_address_for_sender_address' => 'setUseWarehouseAddressForSenderAddress',
    ...
    protected static $getters = [
        ...
        'use_warehouse_address_for_sender_address' => 'getUseWarehouseAddressForSenderAddress',
    ...
    {
        $this->setIfExists('carrier_will_pick_up', $data ?? [], true);
        $this->setIfExists('insurance', $data ?? [], false);
        $this->setIfExists('use_warehouse_address_for_sender_address', $data ?? [], false);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['use_warehouse_address_for_sender_address'] === null) {
            $invalidProperties[] = "'use_warehouse_address_for_sender_address' can't be null";
        }
     ...
     *
     * @param bool $carrier_will_pick_up carrier_will_pick_up
     *
     * @return self
     */
    ...
    /**
     * Gets use_warehouse_address_for_sender_address
     *
     * @return bool
     */
    public function getUseWarehouseAddressForSenderAddress()
    {
        return $this->container['use_warehouse_address_for_sender_address'];
    }

    /**
     * Sets use_warehouse_address_for_sender_address
     *
     * @param bool $use_warehouse_address_for_sender_address use_warehouse_address_for_sender_address
     *
     * @return self
     */
    public function setUseWarehouseAddressForSenderAddress($use_warehouse_address_for_sender_address)
    {
        if (is_null($use_warehouse_address_for_sender_address)) {
            throw new \InvalidArgumentException('non-nullable use_warehouse_address_for_sender_address cannot be null');
        }


        $this->container['use_warehouse_address_for_sender_address'] = $use_warehouse_address_for_sender_address;
     ...
     *
     * @return \kruegge82\jtlffn\Model\DeliveryExperienceType
     */
     ...
     *
     * @param \kruegge82\jtlffn\Model\DeliveryExperienceType $delivery_experience delivery_experience
     *
     * @return self
     */
     ...
     * Gets dimensions
     *
     * @return \kruegge82\jtlffn\Model\CreateOutboundShippingPackageDimensionsRequest
     */
     ...
     * Sets dimensions
     *
     * @param \kruegge82\jtlffn\Model\CreateOutboundShippingPackageDimensionsRequest $dimensions dimensions
     *
     * @return self
     */
