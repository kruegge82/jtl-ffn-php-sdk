...
/**
 * CreateAuthorizedShippingMethodRequest Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\jtlffn
 * @author   OpenAPI Generator team
 ...
 */
class CreateAuthorizedShippingMethodRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateAuthorizedShippingMethodRequest';
    ...
    */
    ...
    public function setShippingMethodId($shipping_method_id)
    {
        ...
        if ((mb_strlen($shipping_method_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $shipping_method_id when calling CreateAuthorizedShippingMethodRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($shipping_method_id) < 4)) {
            throw new \InvalidArgumentException('invalid length for $shipping_method_id when calling CreateAuthorizedShippingMethodRequest., must be bigger than or equal to 4.');
        }
