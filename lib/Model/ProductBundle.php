...
/**
 * ProductBundle Class Doc Comment
 *
 * @category Class
 ...
 */
class ProductBundle implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductBundle';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ProductBundle., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ProductBundle., must be bigger than or equal to 0.');
        }
     ...
     * Sets quantity
     *
     * @param float $quantity Quantity of products in the bundle
     *
     * @return self
     */
    ...
    public function setEan($ean)
    {
        ...
        if (!is_null($ean) && (mb_strlen($ean) > 255)) {
            throw new \InvalidArgumentException('invalid length for $ean when calling ProductBundle., must be smaller than or equal to 255.');
        }
        if (!is_null($ean) && (mb_strlen($ean) < 0)) {
            throw new \InvalidArgumentException('invalid length for $ean when calling ProductBundle., must be bigger than or equal to 0.');
        }
    ...
    public function setUpc($upc)
    {
        ...
        if (!is_null($upc) && (mb_strlen($upc) > 255)) {
            throw new \InvalidArgumentException('invalid length for $upc when calling ProductBundle., must be smaller than or equal to 255.');
        }
        if (!is_null($upc) && (mb_strlen($upc) < 0)) {
            throw new \InvalidArgumentException('invalid length for $upc when calling ProductBundle., must be bigger than or equal to 0.');
        }
