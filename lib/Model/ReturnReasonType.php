...
/**
 * ReturnReasonType Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\jtlffn
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ReturnReasonType
{
    /**
     * Possible values of this enum
     */
    public const NO_REASON = 'NoReason';

    public const ORDERED_BY_MISTAKE = 'OrderedByMistake';

    public const FOUND_CHEAPER_PRICE = 'FoundCheaperPrice';

    public const INSUFFICIENT_PERFORMANCE_OR_QUALITY = 'InsufficientPerformanceOrQuality';

    public const INCOMPATIBLE_OR_NOT_APPROPRIATE_FOR_INTENDED_USE = 'IncompatibleOrNotAppropriateForIntendedUse';

    public const SHIPPING_PACKAGING_INTACT_ITEM_DAMAGED = 'ShippingPackagingIntactItemDamaged';

    public const ARRIVED_TOO_LATE = 'ArrivedTooLate';

    public const PARTS_ACCESSORIES_MISSING = 'PartsAccessoriesMissing';

    public const SHIPPING_PACKAGE_AND_ITEM_DAMAGED = 'ShippingPackageAndItemDamaged';

    public const WRONG_ITEM_SENT = 'WrongItemSent';

    public const DEFECTIVE_DOES_NOT_WORK_PERFECTLY = 'DefectiveDoesNotWorkPerfectly';

    public const EXCESS_DELIVERY = 'ExcessDelivery';

    public const DO_NOT_LIKE_ANYMORE = 'DoNotLikeAnymore';

    public const UNAUTHORISED_PURCHASE = 'UnauthorisedPurchase';

    public const DOES_NOT_MATCH_DESCRIPTION_ON_WEBSITE = 'DoesNotMatchDescriptionOnWebsite';

    public const RECIPIENT_COULD_NOT_BE_DETERMINED = 'RecipientCouldNotBeDetermined';

    public const PICK_UP_TIME_EXPIRED = 'PickUpTimeExpired';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            self::NO_REASON,
            self::ORDERED_BY_MISTAKE,
            self::FOUND_CHEAPER_PRICE,
            self::INSUFFICIENT_PERFORMANCE_OR_QUALITY,
            self::INCOMPATIBLE_OR_NOT_APPROPRIATE_FOR_INTENDED_USE,
            self::SHIPPING_PACKAGING_INTACT_ITEM_DAMAGED,
            self::ARRIVED_TOO_LATE,
            self::PARTS_ACCESSORIES_MISSING,
            self::SHIPPING_PACKAGE_AND_ITEM_DAMAGED,
            self::WRONG_ITEM_SENT,
            self::DEFECTIVE_DOES_NOT_WORK_PERFECTLY,
            self::EXCESS_DELIVERY,
            self::DO_NOT_LIKE_ANYMORE,
            self::UNAUTHORISED_PURCHASE,
            self::DOES_NOT_MATCH_DESCRIPTION_ON_WEBSITE,
            self::RECIPIENT_COULD_NOT_BE_DETERMINED,
            self::PICK_UP_TIME_EXPIRED
        ];
    }
}
