...
class ModelReturn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'merchant_id' => 'string',
        'warehouse_id' => 'string',
        'merchant_return_number' => 'string',
        'fulfiller_return_number' => 'string',
        'contact' => 'string',
        'internal_note' => 'string',
        'external_note' => 'string',
        'customer_address' => '\kruegge82\jtlffn\Model\Address',
        'state' => '\kruegge82\jtlffn\Model\ReturnType',
        'items' => '\kruegge82\jtlffn\Model\ReturnItem[]',
        'modification_info' => '\kruegge82\jtlffn\Model\ModificationInfo',
        'write_lock' => '\kruegge82\jtlffn\Model\LockStatus'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'merchant_id' => null,
        'warehouse_id' => null,
        'merchant_return_number' => null,
        'fulfiller_return_number' => null,
        'contact' => null,
        'internal_note' => null,
        'external_note' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'merchant_id' => false,
        'warehouse_id' => false,
        'merchant_return_number' => true,
        'fulfiller_return_number' => true,
        'contact' => true,
        'internal_note' => true,
        'external_note' => true,
    ...
    protected static $attributeMap = [
        ...
        'merchant_return_number' => 'merchantReturnNumber',
        'fulfiller_return_number' => 'fulfillerReturnNumber',
        'contact' => 'contact',
    ...
    protected static $setters = [
        ...
        'merchant_return_number' => 'setMerchantReturnNumber',
        'fulfiller_return_number' => 'setFulfillerReturnNumber',
        'contact' => 'setContact',
    ...
    protected static $getters = [
        ...
        'merchant_return_number' => 'getMerchantReturnNumber',
        'fulfiller_return_number' => 'getFulfillerReturnNumber',
        'contact' => 'getContact',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('merchant_return_number', $data ?? [], null);
        $this->setIfExists('fulfiller_return_number', $data ?? [], null);
        ...
        $this->setIfExists('write_lock', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['return_id']) > 255)) {
            $invalidProperties[] = "invalid value for 'return_id', the character length must be smaller than or equal to 255.";
        }

        if ((mb_strlen($this->container['return_id']) < 0)) {
            $invalidProperties[] = "invalid value for 'return_id', the character length must be bigger than or equal to 0.";
        }

        if ($this->container['merchant_id'] === null) {
            $invalidProperties[] = "'merchant_id' can't be null";
        }
        if ((mb_strlen($this->container['merchant_id']) > 255)) {
            $invalidProperties[] = "invalid value for 'merchant_id', the character length must be smaller than or equal to 255.";
        }

        if ((mb_strlen($this->container['merchant_id']) < 0)) {
            $invalidProperties[] = "invalid value for 'merchant_id', the character length must be bigger than or equal to 0.";
        }
        ...
        if ((mb_strlen($this->container['warehouse_id']) < 0)) {
            $invalidProperties[] = "invalid value for 'warehouse_id', the character length must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['merchant_return_number']) && (mb_strlen($this->container['merchant_return_number']) > 255)) {
            $invalidProperties[] = "invalid value for 'merchant_return_number', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['merchant_return_number']) && (mb_strlen($this->container['merchant_return_number']) < 0)) {
            $invalidProperties[] = "invalid value for 'merchant_return_number', the character length must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['fulfiller_return_number']) && (mb_strlen($this->container['fulfiller_return_number']) > 255)) {
            $invalidProperties[] = "invalid value for 'fulfiller_return_number', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['fulfiller_return_number']) && (mb_strlen($this->container['fulfiller_return_number']) < 0)) {
            $invalidProperties[] = "invalid value for 'fulfiller_return_number', the character length must be bigger than or equal to 0.";
        }
        ...
        if ($this->container['customer_address'] === null) {
            $invalidProperties[] = "'customer_address' can't be null";
        }
    ...
    public function setReturnId($return_id)
    {
        ...
        if ((mb_strlen($return_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $return_id when calling ModelReturn., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($return_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $return_id when calling ModelReturn., must be bigger than or equal to 0.');
        }
    ...
    public function setMerchantId($merchant_id)
    {
        ...
        if ((mb_strlen($merchant_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $merchant_id when calling ModelReturn., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($merchant_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $merchant_id when calling ModelReturn., must be bigger than or equal to 0.');
        }
     ...
     * Sets warehouse_id
     *
     * @param string $warehouse_id Warehouse must be from the fulfiller who received the return
     *
     * @return self
     */
    public function setWarehouseId($warehouse_id)
    {
        ...
        if ((mb_strlen($warehouse_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $warehouse_id when calling ModelReturn., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($warehouse_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $warehouse_id when calling ModelReturn., must be bigger than or equal to 0.');
        }
    ...
    /**
     * Gets merchant_return_number
     *
     * @return string|null
     */
    public function getMerchantReturnNumber()
    {
        return $this->container['merchant_return_number'];
    }

    /**
     * Sets merchant_return_number
     *
     * @param string|null $merchant_return_number merchant_return_number
     *
     * @return self
     */
    public function setMerchantReturnNumber($merchant_return_number)
    {
        if (is_null($merchant_return_number)) {
            array_push($this->openAPINullablesSetToNull, 'merchant_return_number');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('merchant_return_number', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($merchant_return_number) && (mb_strlen($merchant_return_number) > 255)) {
            throw new \InvalidArgumentException('invalid length for $merchant_return_number when calling ModelReturn., must be smaller than or equal to 255.');
        }
        if (!is_null($merchant_return_number) && (mb_strlen($merchant_return_number) < 0)) {
            throw new \InvalidArgumentException('invalid length for $merchant_return_number when calling ModelReturn., must be bigger than or equal to 0.');
        }

        $this->container['merchant_return_number'] = $merchant_return_number;

        return $this;
    }

    /**
     * Gets fulfiller_return_number
     *
     * @return string|null
     */
    public function getFulfillerReturnNumber()
    {
        return $this->container['fulfiller_return_number'];
    }

    /**
     * Sets fulfiller_return_number
     *
     * @param string|null $fulfiller_return_number fulfiller_return_number
     *
     * @return self
     */
    public function setFulfillerReturnNumber($fulfiller_return_number)
    {
        if (is_null($fulfiller_return_number)) {
            array_push($this->openAPINullablesSetToNull, 'fulfiller_return_number');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('fulfiller_return_number', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($fulfiller_return_number) && (mb_strlen($fulfiller_return_number) > 255)) {
            throw new \InvalidArgumentException('invalid length for $fulfiller_return_number when calling ModelReturn., must be smaller than or equal to 255.');
        }
        if (!is_null($fulfiller_return_number) && (mb_strlen($fulfiller_return_number) < 0)) {
            throw new \InvalidArgumentException('invalid length for $fulfiller_return_number when calling ModelReturn., must be bigger than or equal to 0.');
        }

        $this->container['fulfiller_return_number'] = $fulfiller_return_number;
    ...
    public function setContact($contact)
    {
        ...
        if (!is_null($contact) && (mb_strlen($contact) > 255)) {
            throw new \InvalidArgumentException('invalid length for $contact when calling ModelReturn., must be smaller than or equal to 255.');
        }
        if (!is_null($contact) && (mb_strlen($contact) < 0)) {
            throw new \InvalidArgumentException('invalid length for $contact when calling ModelReturn., must be bigger than or equal to 0.');
        }
     ...
     * Sets internal_note
     *
     * @param string|null $internal_note Internal note of the return.
     *
     * @return self
     */
    public function setInternalNote($internal_note)
    {
        ...
        if (!is_null($internal_note) && (mb_strlen($internal_note) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $internal_note when calling ModelReturn., must be smaller than or equal to 4096.');
        }
        if (!is_null($internal_note) && (mb_strlen($internal_note) < 0)) {
            throw new \InvalidArgumentException('invalid length for $internal_note when calling ModelReturn., must be bigger than or equal to 0.');
        }
     ...
     * Sets external_note
     *
     * @param string|null $external_note External note of the return.
     *
     * @return self
     */
    public function setExternalNote($external_note)
    {
        ...
        if (!is_null($external_note) && (mb_strlen($external_note) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $external_note when calling ModelReturn., must be smaller than or equal to 4096.');
        }
        if (!is_null($external_note) && (mb_strlen($external_note) < 0)) {
            throw new \InvalidArgumentException('invalid length for $external_note when calling ModelReturn., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param \kruegge82\jtlffn\Model\Address $customer_address customer_address
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \kruegge82\jtlffn\Model\ReturnType
     */
     ...
     * Sets state
     *
     * @param \kruegge82\jtlffn\Model\ReturnType $state state
     *
     * @return self
     */
     ...
     * Gets items
     *
     * @return \kruegge82\jtlffn\Model\ReturnItem[]
     */
     ...
     * Sets items
     *
     * @param \kruegge82\jtlffn\Model\ReturnItem[] $items items
     *
     * @return self
     */
     ...
     * Gets write_lock
     *
     * @return \kruegge82\jtlffn\Model\LockStatus|null
     */
    public function getWriteLock()
    {
        return $this->container['write_lock'];
    }

    /**
     * Sets write_lock
     *
     * @param \kruegge82\jtlffn\Model\LockStatus|null $write_lock write_lock
     *
     * @return self
     */
    public function setWriteLock($write_lock)
    {
        if (is_null($write_lock)) {
            array_push($this->openAPINullablesSetToNull, 'write_lock');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('write_lock', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['write_lock'] = $write_lock;
