...
/**
 * CreateReturnItemRequest Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\jtlffn
 * @author   OpenAPI Generator team
 ...
 */
class CreateReturnItemRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateReturnItemRequest';
    ...
    */
     ...
     * Sets return_item_id
     *
     * @param string|null $return_item_id The SKU (stock keeping unit) of the merchant for that outbound item
     *
     * @return self
     */
    ...
    public function setJfsku($jfsku)
    {
        ...
        if ((mb_strlen($jfsku) > 11)) {
            throw new \InvalidArgumentException('invalid length for $jfsku when calling CreateReturnItemRequest., must be smaller than or equal to 11.');
        }
        if ((mb_strlen($jfsku) < 11)) {
            throw new \InvalidArgumentException('invalid length for $jfsku when calling CreateReturnItemRequest., must be bigger than or equal to 11.');
        }
     ...
     * Sets outbound_id
     *
     * @param string|null $outbound_id outbound_id
     *
     * @return self
     */
     ...
     * Gets reason
     *
     * @return \kruegge82\jtlffn\Model\ReturnReasonType|null
     */
     ...
     * Sets reason
     *
     * @param \kruegge82\jtlffn\Model\ReturnReasonType|null $reason reason
     *
     * @return self
     */
    ...
    public function setReasonNote($reason_note)
    {
        ...
        if (!is_null($reason_note) && (mb_strlen($reason_note) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $reason_note when calling CreateReturnItemRequest., must be smaller than or equal to 4096.');
        }
        if (!is_null($reason_note) && (mb_strlen($reason_note) < 0)) {
            throw new \InvalidArgumentException('invalid length for $reason_note when calling CreateReturnItemRequest., must be bigger than or equal to 0.');
        }
