...
/**
 * ShippingMethodAuthorizationRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class ShippingMethodAuthorizationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShippingMethodAuthorizationRequest';
    ...
    */
     ...
     *
     * @param string $shipping_method_id List of shipping methods you want to provide
     *
     * @return self
     */
    public function setShippingMethodId($shipping_method_id)
    {
        ...
        if ((mb_strlen($shipping_method_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $shipping_method_id when calling ShippingMethodAuthorizationRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($shipping_method_id) < 4)) {
            throw new \InvalidArgumentException('invalid length for $shipping_method_id when calling ShippingMethodAuthorizationRequest., must be bigger than or equal to 4.');
        }
