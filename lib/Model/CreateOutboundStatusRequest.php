...
/**
 * CreateOutboundStatusRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateOutboundStatusRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateOutboundStatusRequest';
    ...
    public const STATUS_PARTIALLY_CANCELED = 'PartiallyCanceled';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('cancel_reason_code', $data ?? [], 'None');
    ...
    */
    ...
    public function setOutboundId($outbound_id)
    {
        ...
        if ((mb_strlen($outbound_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $outbound_id when calling CreateOutboundStatusRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($outbound_id) < 7)) {
            throw new \InvalidArgumentException('invalid length for $outbound_id when calling CreateOutboundStatusRequest., must be bigger than or equal to 7.');
        }
     ...
     *
     * @param string|null $cancel_reason_code Set the cancel reason code. Only allowed, when the outbound is set to \"Canceled\" When no code is given the cancel reason code is set to None.
     *
     * @return self
     */
    public function setCancelReasonCode($cancel_reason_code)
    {
        if (is_null($cancel_reason_code)) {
            throw new \InvalidArgumentException('non-nullable cancel_reason_code cannot be null');
        }
     ...
     * Sets cancel_reason
     *
     * @param string|null $cancel_reason Custom cancel reason string
     *
     * @return self
     */
     ...
     * Sets object_version
     *
     * @param \DateTime|null $object_version Last known modification date of this outbound.
     *
     * @return self
     */
