...
class ShippingMethod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPIFormats = [
        ...
        'name' => null,
        'shipping_type' => null,
        'tracking_url_schema' => null,
        'carrier_code' => null,
        'carrier_name' => null,
        'cutoff_time' => 'date-span',
        'note' => null,
        'fulfiller_shipping_method_number' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'name' => false,
        'shipping_type' => false,
        'tracking_url_schema' => true,
        'carrier_code' => true,
        'carrier_name' => true,
        'cutoff_time' => true,
        'note' => true,
        'fulfiller_shipping_method_number' => false,
    ...
    protected static $attributeMap = [
        ...
        'tracking_url_schema' => 'trackingUrlSchema',
        'carrier_code' => 'carrierCode',
        'carrier_name' => 'carrierName',
        'cutoff_time' => 'cutoffTime',
        'note' => 'note',
        'fulfiller_shipping_method_number' => 'fulfillerShippingMethodNumber',
    ...
    protected static $setters = [
        ...
        'tracking_url_schema' => 'setTrackingUrlSchema',
        'carrier_code' => 'setCarrierCode',
        'carrier_name' => 'setCarrierName',
        'cutoff_time' => 'setCutoffTime',
        'note' => 'setNote',
        'fulfiller_shipping_method_number' => 'setFulfillerShippingMethodNumber',
    ...
    protected static $getters = [
        ...
        'tracking_url_schema' => 'getTrackingUrlSchema',
        'carrier_code' => 'getCarrierCode',
        'carrier_name' => 'getCarrierName',
        'cutoff_time' => 'getCutoffTime',
        'note' => 'getNote',
        'fulfiller_shipping_method_number' => 'getFulfillerShippingMethodNumber',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('tracking_url_schema', $data ?? [], null);
        ...
        $this->setIfExists('fulfiller_shipping_method_number', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['tracking_url_schema']) && (mb_strlen($this->container['tracking_url_schema']) > 255)) {
            $invalidProperties[] = "invalid value for 'tracking_url_schema', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['tracking_url_schema']) && (mb_strlen($this->container['tracking_url_schema']) < 0)) {
            $invalidProperties[] = "invalid value for 'tracking_url_schema', the character length must be bigger than or equal to 0.";
        }
        ...
        if (!is_null($this->container['carrier_name']) && (mb_strlen($this->container['carrier_name']) < 0)) {
            $invalidProperties[] = "invalid value for 'carrier_name', the character length must be bigger than or equal to 0.";
        }
        ...
        if ($this->container['fulfiller_shipping_method_number'] === null) {
            $invalidProperties[] = "'fulfiller_shipping_method_number' can't be null";
        }
        if ((mb_strlen($this->container['fulfiller_shipping_method_number']) > 255)) {
            $invalidProperties[] = "invalid value for 'fulfiller_shipping_method_number', the character length must be smaller than or equal to 255.";
        }

        if ((mb_strlen($this->container['fulfiller_shipping_method_number']) < 0)) {
            $invalidProperties[] = "invalid value for 'fulfiller_shipping_method_number', the character length must be bigger than or equal to 0.";
        }
     ...
     *
     * @param string $shipping_method_id Shipping methos identifier
     *
     * @return self
     */
    public function setShippingMethodId($shipping_method_id)
    {
        ...
        if ((mb_strlen($shipping_method_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $shipping_method_id when calling ShippingMethod., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($shipping_method_id) < 4)) {
            throw new \InvalidArgumentException('invalid length for $shipping_method_id when calling ShippingMethod., must be bigger than or equal to 4.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ShippingMethod., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ShippingMethod., must be bigger than or equal to 0.');
        }
     ...
     * Gets shipping_type
     *
     * @return \kruegge82\jtlffn\Model\ShippingType
     */
     ...
     * Sets shipping_type
     *
     * @param \kruegge82\jtlffn\Model\ShippingType $shipping_type shipping_type
     *
     * @return self
     */
    ...
    /**
     * Gets tracking_url_schema
     *
     * @return string|null
     */
    public function getTrackingUrlSchema()
    {
        return $this->container['tracking_url_schema'];
    }

    /**
     * Sets tracking_url_schema
     *
     * @param string|null $tracking_url_schema Tracking URL schema for dynamic tracking URL creation
     *
     * @return self
     */
    public function setTrackingUrlSchema($tracking_url_schema)
    {
        if (is_null($tracking_url_schema)) {
            array_push($this->openAPINullablesSetToNull, 'tracking_url_schema');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('tracking_url_schema', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($tracking_url_schema) && (mb_strlen($tracking_url_schema) > 255)) {
            throw new \InvalidArgumentException('invalid length for $tracking_url_schema when calling ShippingMethod., must be smaller than or equal to 255.');
        }
        if (!is_null($tracking_url_schema) && (mb_strlen($tracking_url_schema) < 0)) {
            throw new \InvalidArgumentException('invalid length for $tracking_url_schema when calling ShippingMethod., must be bigger than or equal to 0.');
        }

        $this->container['tracking_url_schema'] = $tracking_url_schema;
     ...
     * Sets carrier_code
     *
     * @param string|null $carrier_code Carrier Code of the shipping method
     *
     * @return self
     */
     ...
     * Sets carrier_name
     *
     * @param string|null $carrier_name Carrier name of the shipping method
     *
     * @return self
     */
    public function setCarrierName($carrier_name)
    {
        ...
        if (!is_null($carrier_name) && (mb_strlen($carrier_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $carrier_name when calling ShippingMethod., must be smaller than or equal to 255.');
        }
        if (!is_null($carrier_name) && (mb_strlen($carrier_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $carrier_name when calling ShippingMethod., must be bigger than or equal to 0.');
        }
     ...
     * Sets cutoff_time
     *
     * @param string|null $cutoff_time Cut off time of the shipping method. The cut off time is the lastest time an outbound can arrive at JTL-Fulfillment network so that the outbound will be shipped and handed over to the carrier
     *
     * @return self
     */
    public function setCutoffTime($cutoff_time)
    {
        if (is_null($cutoff_time)) {
            array_push($this->openAPINullablesSetToNull, 'cutoff_time');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('cutoff_time', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets note
     *
     * @param string|null $note Note of the shipping method
     *
     * @return self
     */
    public function setNote($note)
    {
        ...
        if (!is_null($note) && (mb_strlen($note) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $note when calling ShippingMethod., must be smaller than or equal to 4096.');
        }
        if (!is_null($note) && (mb_strlen($note) < 0)) {
            throw new \InvalidArgumentException('invalid length for $note when calling ShippingMethod., must be bigger than or equal to 0.');
        }
    ...
    /**
     * Gets fulfiller_shipping_method_number
     *
     * @return string
     */
    public function getFulfillerShippingMethodNumber()
    {
        return $this->container['fulfiller_shipping_method_number'];
    }

    /**
     * Sets fulfiller_shipping_method_number
     *
     * @param string $fulfiller_shipping_method_number fulfiller_shipping_method_number
     *
     * @return self
     */
    public function setFulfillerShippingMethodNumber($fulfiller_shipping_method_number)
    {
        if (is_null($fulfiller_shipping_method_number)) {
            throw new \InvalidArgumentException('non-nullable fulfiller_shipping_method_number cannot be null');
        }
        if ((mb_strlen($fulfiller_shipping_method_number) > 255)) {
            throw new \InvalidArgumentException('invalid length for $fulfiller_shipping_method_number when calling ShippingMethod., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($fulfiller_shipping_method_number) < 0)) {
            throw new \InvalidArgumentException('invalid length for $fulfiller_shipping_method_number when calling ShippingMethod., must be bigger than or equal to 0.');
        }

        $this->container['fulfiller_shipping_method_number'] = $fulfiller_shipping_method_number;
