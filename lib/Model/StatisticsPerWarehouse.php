...
/**
 * StatisticsPerWarehouse Class Doc Comment
 *
 * @category Class
 * @package  kruegge82\jtlffn
 * @author   OpenAPI Generator team
 ...
 */
class StatisticsPerWarehouse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StatisticsPerWarehouse';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['warehouse_id']) && (mb_strlen($this->container['warehouse_id']) > 255)) {
            $invalidProperties[] = "invalid value for 'warehouse_id', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['warehouse_id']) && (mb_strlen($this->container['warehouse_id']) < 0)) {
    ...
    public function setWarehouseId($warehouse_id)
    {
        ...
        if (!is_null($warehouse_id) && (mb_strlen($warehouse_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $warehouse_id when calling StatisticsPerWarehouse., must be smaller than or equal to 255.');
        }
        if (!is_null($warehouse_id) && (mb_strlen($warehouse_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $warehouse_id when calling StatisticsPerWarehouse., must be bigger than or equal to 0.');
        }
