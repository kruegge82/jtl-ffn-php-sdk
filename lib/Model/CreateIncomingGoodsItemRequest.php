...
/**
 * CreateIncomingGoodsItemRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateIncomingGoodsItemRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateIncomingGoodsItemRequest';
    ...
    protected static $openAPITypes = [
        ...
        'note' => 'string',
        'batch' => 'string',
        'best_before' => '\kruegge82\jtlffn\Model\CreateBestBeforeRequest',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['fulfiller_timestamp'] === null) {
            $invalidProperties[] = "'fulfiller_timestamp' can't be null";
        }
    ...
    public function setJfsku($jfsku)
    {
        ...
        if ((mb_strlen($jfsku) > 11)) {
            throw new \InvalidArgumentException('invalid length for $jfsku when calling CreateIncomingGoodsItemRequest., must be smaller than or equal to 11.');
        }
        if ((mb_strlen($jfsku) < 11)) {
            throw new \InvalidArgumentException('invalid length for $jfsku when calling CreateIncomingGoodsItemRequest., must be bigger than or equal to 11.');
        }
    ...
    public function setWarehouseId($warehouse_id)
    {
        ...
        if ((mb_strlen($warehouse_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $warehouse_id when calling CreateIncomingGoodsItemRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($warehouse_id) < 14)) {
            throw new \InvalidArgumentException('invalid length for $warehouse_id when calling CreateIncomingGoodsItemRequest., must be bigger than or equal to 14.');
        }
     ...
     *
     * @param float|null $quantity_blocked This quantity exists in the warehouse but is not available for shipment yet
     *
     * @return self
     */
    public function setQuantityBlocked($quantity_blocked)
    {
        if (is_null($quantity_blocked)) {
            array_push($this->openAPINullablesSetToNull, 'quantity_blocked');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('quantity_blocked', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets quantity
     *
     * @param float|null $quantity This quantity is available for shipment
     *
     * @return self
     */
    ...
    public function setNote($note)
    {
        ...
        if (!is_null($note) && (mb_strlen($note) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $note when calling CreateIncomingGoodsItemRequest., must be smaller than or equal to 4096.');
        }
        if (!is_null($note) && (mb_strlen($note) < 0)) {
            throw new \InvalidArgumentException('invalid length for $note when calling CreateIncomingGoodsItemRequest., must be bigger than or equal to 0.');
        }
     ...
     * Sets batch
     *
     * @param string|null $batch The product batch of the stock adjustment
     *
     * @return self
     */
     ...
     * Gets best_before
     *
     * @return \kruegge82\jtlffn\Model\CreateBestBeforeRequest|null
     */
     ...
     * Sets best_before
     *
     * @param \kruegge82\jtlffn\Model\CreateBestBeforeRequest|null $best_before best_before
     *
     * @return self
     */
     ...
     *
     * @param \DateTime $fulfiller_timestamp Internal timestamp of the fulfiller when he has performed that stock adjustment
     *
     * @return self
     */
    public function setFulfillerTimestamp($fulfiller_timestamp)
    {
        if (is_null($fulfiller_timestamp)) {
            throw new \InvalidArgumentException('non-nullable fulfiller_timestamp cannot be null');
        }
