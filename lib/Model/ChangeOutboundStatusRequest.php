...
/**
 * ChangeOutboundStatusRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class ChangeOutboundStatusRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChangeOutboundStatusRequest';
    ...
    protected static $openAPITypes = [
        'items' => '\kruegge82\jtlffn\Model\CreateOutboundStatusRequest[]'
    ];
    ...
    */
     ...
     * Gets items
     *
     * @return \kruegge82\jtlffn\Model\CreateOutboundStatusRequest[]
     */
     ...
     * Sets items
     *
     * @param \kruegge82\jtlffn\Model\CreateOutboundStatusRequest[] $items items
     *
     * @return self
     */
